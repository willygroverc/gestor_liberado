  ...
  <table width="90%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#006699"  background="images/fondo.jpg" bgcolor="#EAEAEA">
	...
	<tr> 
      <td ><table width="100%" border="2" align="center" cellpadding="2" cellspacing="0" background="images/fondo.jpg">
        <tr>
          <th colspan="9" bgcolor="#006699"><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif"> ACCIONES POR TEMA</font></th>
        </tr>
        <tr>
		...
		while($row=mysql_fetch_array($result)) 
  		{
		?>
        <tr align="center"> <?php echo "<td><a href=\"acciones_last.php?id_minuta=$id_minuta&id_tema=".$row['id_tema']."\">".$row['id_tema']."</a></td>";
        ...
        <tr>
          <td width="36" nowrap height="7"><div align="center"><strong>
            <?php if (isset($id_tema)) echo $id_tema; ?>
          </strong></div></td>
