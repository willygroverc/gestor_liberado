...
//	$id=$id+1;
	...
	//$sql="INSERT INTO ".
	//"telkey (idtelkey,Responsable,Cuenta,Tipo,Sistema,Fechaen,Fechare,Reemplazo) ".
	//"VALUES ('$id','$Responsable','$Cuenta','$Tipo','$Sistema','$Fechaentrada','$Fecharetiro','$Reemplazo')";
	$sql="UPDATE telkey SET Responsable='$Responsable',Cuenta='$Cuenta',Tipo='$Tipo',Sistema='$Sistema',".
	"Fechaen='$Fechaentrada',Fechare='$Fecharetiro',Observaciones='$Observ' WHERE Idtelkey='$Idtelkey'";
	mysql_db_query($db,$sql,$link);
	//$var1=$id+1;
	$aux=1;
	header("location: telkey_last.php?Idtelkey=$Idtelkey");
}
else {
include("top.php");
echo "<p>";
...
-->
  ...
  <input name="Idtelkey" type="hidden" value="<?php echo $Idtelkey;?>">
  ...
  <table width="95%" border="1" align="center" background="images/fondo.jpg" bgcolor="#EAEAEA">
    ...
    <tr align="center" bgcolor="#006699"> 
          ...
          <?php
	$sql = "SELECT * FROM telkey WHERE Idtelkey='$Idtelkey' ORDER BY Idtelkey ASC";
  ...
  <table width="95%" border="1" align="center" background="images/fondo.jpg">
		  ...
		  ?>
            <td><div align="center">
              <input name="Responsable"  type="text" value="<?php echo $row[Responsable];?>" size="25" maxlength="40" />
            </div></td>
            <td><div align="center">
              <input name="Cuenta"  type="text" value="<?php echo $row[Cuenta];?>" size="25" maxlength="40" />
            </div></td>
            <td><div align="center">
              <input name="Tipo"  type="text" value="<?php echo $row[Tipo];?>" size="25" maxlength="40" />
            </div></td>
            <td><div align="center">
              <select name="Sistema" id="select" title="<?php $row[Sistema];?>">
                <?php 
			  $sql7 = "SELECT * FROM sistemas";
			  $result7 = mysql_db_query($db,$sql7,$link);
			  while ($row7 = mysql_fetch_array($result7)) 
				{if ($row[Sistema]==$row7[Descripcion])
...
{	 $fsistema=date("Y-m-d");
	...
	$d1=substr($fsistema,8,2);}
            ...
            <a href="javascript:call.popup();"><img src="images/cal.gif" width="16" height="16" border="0" alt="Haga click para seleccionar una fcha" /></a>
            <div align="center"></div></td>
            <td><div align="center">
            <input name="Reemplazo" type="text" value="<?php echo $row[Reemplazo];?>" size="25" maxlength="40" /></td>
			<?php }
			?>
          </tr>
          <tr>
          ...
          <tr>
            <td>&nbsp;</td>
            <td align="center"><textarea name="Observ" cols="20"> <?php echo $row[Observaciones] ;?> </textarea></td>
            <td>&nbsp;</td>
          </tr>
          <tr> 
