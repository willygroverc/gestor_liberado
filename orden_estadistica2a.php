...
<tr><td background="images/main-button-tileR1.jpg" height="20" align="center"><font color="#FFFFFF" size="2" face="Arial, Helvetica"><b>IMPRESION</b></font></td></tr>
<tr><td align="center"><br>
	<input type="radio" name="opcion" value="G" onClick="cambio(this.value)" <?php if (isset($_REQUEST['op']) == 'G') print "checked"; else print "checked"; ?>>
	<font face="Arial, Helvetica, sans-serif" size="2"><B>GENERAL</B></font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  
	<input type="radio" name="opcion" value="F" onClick="cambio(this.value)" <?php if (isset($_REQUEST['op']) == 'F') print "checked";  ?>>
          ...
          <td width="34" height="40"></td>
			...
			<tr>
        	   ...
        	   <a href="javascript:cal1.popup();"><img src="images/cal.gif" width="16" height="16" border="0" alt="Haga click para seleccionar una fecha"></a>
				...
				&nbsp;&nbsp;&nbsp;&nbsp;
				 <input type="submit" value="    VER    " name="enviar2" id="enviar2"  onClick="OpenPrint7()">				</td>
			</tr>
...
temp.options[0].selected=true
	...
	function OpenPrint () {
		var form=document.form2;
		if (form.menu.value=="GENERAL") 
		window.open ("report_ordenesg.php?menu=" + form.menu.value + "&nombre=" + form.nombre.value + "&gen=1");
		else 
		window.open ("report_ordenesg.php?menu=" + form.menu.value + "&nombre=" + form.nombre.value + "&gen=0");
		close();		
		return false;	
	}
