...
{   include("conexion.php");
		$sql1 = "SELECT MAX(IdGrupoProy) AS idgrupo FROM solicproygrupoproy WHERE Codigo='$_REQUEST[var]'";
	...
	header("location: solicproyecto2.php?Codigo=$_REQUEST[var]");
  ...
  <table width="90%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#006699"  background="images/fondo.jpg" bgcolor="#EAEAEA">
	...
	<tr> 
      <td> 
		...
		$sql = "SELECT * FROM solicproygrupoproy WHERE Codigo='$_REQUEST[Codigo]' ORDER BY IdGrupoProy ASC";
