...
// PHP Report Maker 1.0 - Table level configuration (Lista de Proveedores)
// Table Level Constants

define("EW_TABLE_VAR", "Lista_de_Proveedores", TRUE);
define("EW_TABLE_GROUP_PER_PAGE", "grpperpage", TRUE);
define("EW_TABLE_SESSION_GROUP_PER_PAGE", "Lista_de_Proveedores_grpperpage", TRUE);
define("EW_TABLE_START_GROUP", "start", TRUE);
define("EW_TABLE_SESSION_START_GROUP", "Lista_de_Proveedores_start", TRUE);
define("EW_TABLE_SESSION_SEARCH", "Lista_de_Proveedores_search", TRUE);
define("EW_TABLE_CHILD_USER_ID", "childuserid", TRUE);
define("EW_TABLE_SESSION_CHILD_USER_ID", "Lista_de_Proveedores_childuserid", TRUE);

// Table Level SQL
define("EW_TABLE_SQL_FROM", "proveedor", TRUE);
$EW_TABLE_SQL_SELECT = "SELECT proveedor.IdProv, proveedor.NombProv, proveedor.DirecProv, proveedor.Fono1Prov, proveedor.EmailProv, proveedor.EncProv, proveedor.ObsProv FROM " . EW_TABLE_SQL_FROM;
$EW_TABLE_SQL_WHERE = "";
...
$af_IdProv = NULL; // Advanced filter for IdProv
$af_NombProv = NULL; // Advanced filter for NombProv
$af_DirecProv = NULL; // Advanced filter for DirecProv
$af_Fono1Prov = NULL; // Advanced filter for Fono1Prov
$af_EmailProv = NULL; // Advanced filter for EmailProv
$af_EncProv = NULL; // Advanced filter for EncProv
$af_ObsProv = NULL; // Advanced filter for ObsProv
?>
<?php
...
// Detail variables
$x_IdProv = NULL; $ox_IdProv = NULL; $tx_IdProv = NULL; $ftx_IdProv = 3; $rf_IdProv = NULL; $rt_IdProv = NULL;
$x_NombProv = NULL; $ox_NombProv = NULL; $tx_NombProv = NULL; $ftx_NombProv = 200; $rf_NombProv = NULL; $rt_NombProv = NULL;
$x_DirecProv = NULL; $ox_DirecProv = NULL; $tx_DirecProv = NULL; $ftx_DirecProv = 200; $rf_DirecProv = NULL; $rt_DirecProv = NULL;
$x_Fono1Prov = NULL; $ox_Fono1Prov = NULL; $tx_Fono1Prov = NULL; $ftx_Fono1Prov = 200; $rf_Fono1Prov = NULL; $rt_Fono1Prov = NULL;
$x_EmailProv = NULL; $ox_EmailProv = NULL; $tx_EmailProv = NULL; $ftx_EmailProv = 200; $rf_EmailProv = NULL; $rt_EmailProv = NULL;
$x_EncProv = NULL; $ox_EncProv = NULL; $tx_EncProv = NULL; $ftx_EncProv = 200; $rf_EncProv = NULL; $rt_EncProv = NULL;
$x_ObsProv = NULL; $ox_ObsProv = NULL; $tx_ObsProv = NULL; $ftx_ObsProv = 201; $rf_ObsProv = NULL; $rt_ObsProv = NULL;
?>
<?php
...
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="Lista_de_Proveedoressmry.php?export=html">Imprimir</a>
&nbsp;&nbsp;<a href="Lista_de_Proveedoressmry.php?export=excel">Exportar a Excel</a>
&nbsp;&nbsp;<a href="Lista_de_Proveedoressmry.php?export=word">Exportar a Word</a>
<?php } ?>
<br><br>
<?php if (@$sExport == "") { ?>
</div></td></tr>
...
<?php if (@$sExport == "") { ?>
<form action="Lista_de_Proveedoressmry.php" name="ewpagerform" id="ewpagerform">
...
<!--first page button-->
	...
	<?php } else { ?>
	<td><a href="Lista_de_Proveedoressmry.php?start=1"><img src="rptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($PrevStart == $nStartGrp) { ?>
	<td><img src="rptimages/prevdisab.gif" alt="Previous" width="16" height="16" border="0"></td>
	<?php } else { ?>
	<td><a href="Lista_de_Proveedoressmry.php?start=<?php echo $PrevStart; ?>"><img src="rptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } ?>
<!--current page number-->
...
<!--next page button-->
	...
	<?php } else { ?>
	<td><a href="Lista_de_Proveedoressmry.php?start=<?php echo $NextStart; ?>"><img src="rptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>
	<?php  } ?>
<!--last page button-->
	<?php if ($LastStart == $nStartGrp) { ?>
	<td><img src="rptimages/lastdisab.gif" alt="Last" width="16" height="16" border="0"></td>
	<?php } else { ?>
	<td><a href="Lista_de_Proveedoressmry.php?start=<?php echo $LastStart; ?>"><img src="rptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>
	<?php } ?>
...
<?php echo $x_NombProv ?>
		...
		<td class="ewRptDtlField">
<?php echo $x_DirecProv ?>
</td>
		<td class="ewRptDtlField">
<?php echo $x_Fono1Prov ?>
</td>
		<td class="ewRptDtlField">
<?php echo $x_EmailProv ?>
</td>
		<td class="ewRptDtlField">
<?php echo $x_EncProv ?>
</td>
		<td class="ewRptDtlField">
<?php echo str_replace(chr(10), "<br>", $x_ObsProv); ?>
</td>
	</tr>
<?php
...
function GetRow($opt) {
	...
	while ($row) {
		if (ValidRow($row)) {
			$GLOBALS["x_IdProv"] = $row["IdProv"];
			$val[1] = $GLOBALS["x_IdProv"];
			$GLOBALS["x_NombProv"] = $row["NombProv"];
			$val[2] = $GLOBALS["x_NombProv"];
			$GLOBALS["x_DirecProv"] = $row["DirecProv"];
			$val[3] = $GLOBALS["x_DirecProv"];
			$GLOBALS["x_Fono1Prov"] = $row["Fono1Prov"];
			$val[4] = $GLOBALS["x_Fono1Prov"];
			$GLOBALS["x_EmailProv"] = $row["EmailProv"];
			$val[5] = $GLOBALS["x_EmailProv"];
			$GLOBALS["x_EncProv"] = $row["EncProv"];
			$val[6] = $GLOBALS["x_EncProv"];
			$GLOBALS["x_ObsProv"] = $row["ObsProv"];
			$val[7] = $GLOBALS["x_ObsProv"];
			break;
		} else {
			$rsidx++;
			$row = ($rsidx < $rscnt) ? $rs[$rsidx] : FALSE;
