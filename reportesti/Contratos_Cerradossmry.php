...
// PHP Report Maker 1.0 - Table level configuration (Contratos Cerrados)
// Table Level Constants

define("EW_TABLE_VAR", "Contratos_Cerrados", TRUE);
define("EW_TABLE_GROUP_PER_PAGE", "grpperpage", TRUE);
define("EW_TABLE_SESSION_GROUP_PER_PAGE", "Contratos_Cerrados_grpperpage", TRUE);
define("EW_TABLE_START_GROUP", "start", TRUE);
define("EW_TABLE_SESSION_START_GROUP", "Contratos_Cerrados_start", TRUE);
define("EW_TABLE_SESSION_SEARCH", "Contratos_Cerrados_search", TRUE);
define("EW_TABLE_CHILD_USER_ID", "childuserid", TRUE);
define("EW_TABLE_SESSION_CHILD_USER_ID", "Contratos_Cerrados_childuserid", TRUE);

// Table Level SQL
define("EW_TABLE_SQL_FROM", "contratodatos", TRUE);
$EW_TABLE_SQL_SELECT = "SELECT count(*) AS total, count(contratodatos.IdContra) / count(contratodatos.IdContra) AS aux, contratodatos.TipoContra, contratodatos.CodLegalContra, contratodatos.EmpContra, contratodatos.FechDe, contratodatos.FechAl, contratodatos.motivo_cierre FROM " . EW_TABLE_SQL_FROM;
$EW_TABLE_SQL_WHERE = "(contratodatos.cierre = 1)";
define("EW_TABLE_SQL_GROUPBY", "contratodatos.TipoContra, contratodatos.CodLegalContra, contratodatos.EmpContra, contratodatos.FechDe, contratodatos.FechAl, contratodatos.motivo_cierre", TRUE);
...
$af_motivo_cierre = NULL; // Advanced filter for motivo_cierre
?>
<?php
...
$x_motivo_cierre = NULL; $ox_motivo_cierre = NULL; $tx_motivo_cierre = NULL; $ftx_motivo_cierre = 201; $rf_motivo_cierre = NULL; $rt_motivo_cierre = NULL;
?>
<?php

// Chart configuration parameters
$Contratos_Cerrados_cht_parms = NULL; // Store all chart parameters

// Chart data
$Contratos_Cerrados_cht_index = NULL;
$Contratos_Cerrados_cht_id = NULL;
$Contratos_Cerrados_cht_smry = NULL;
$Contratos_Cerrados_cht_XFld = NULL;
$Contratos_Cerrados_cht_YFld = NULL;
$Contratos_Cerrados_cht_YFldBase = NULL;
$Contratos_Cerrados_cht_XFld = "aux";
$Contratos_Cerrados_cht_YFld = "total";
$Contratos_Cerrados_cht_XDateFld = "";
?>
<?php
...
Contratos Cerrados
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="Contratos_Cerradossmry.php?export=html">Imprimir</a>
&nbsp;&nbsp;<a href="Contratos_Cerradossmry.php?export=excel">Exportar a Excel</a>
&nbsp;&nbsp;<a href="Contratos_Cerradossmry.php?export=word">Exportar a Word</a>
<?php } ?>
<br><br>
<?php if (@$sExport == "") { ?>
</div></td></tr>
...
<?php if (@$sExport == "") { ?>
<form action="Contratos_Cerradossmry.php" name="ewpagerform" id="ewpagerform">
...
<!--first page button-->
	...
	<?php } else { ?>
	<td><a href="Contratos_Cerradossmry.php?start=1"><img src="rptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($PrevStart == $nStartGrp) { ?>
	<td><img src="rptimages/prevdisab.gif" alt="Previous" width="16" height="16" border="0"></td>
	<?php } else { ?>
	<td><a href="Contratos_Cerradossmry.php?start=<?php echo $PrevStart; ?>"><img src="rptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } ?>
<!--current page number-->
...
<!--next page button-->
	...
	<?php } else { ?>
	<td><a href="Contratos_Cerradossmry.php?start=<?php echo $NextStart; ?>"><img src="rptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>
	<?php  } ?>
<!--last page button-->
	<?php if ($LastStart == $nStartGrp) { ?>
	<td><img src="rptimages/lastdisab.gif" alt="Last" width="16" height="16" border="0"></td>
	<?php } else { ?>
	<td><a href="Contratos_Cerradossmry.php?start=<?php echo $LastStart; ?>"><img src="rptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>
	<?php } ?>
...
<?php echo ew_FormatDateTime($x_FechAl,5) ?>
		...
		<td class="ewRptDtlField">
<?php echo str_replace(chr(10), "<br>", $x_motivo_cierre); ?>
</td>
	</tr>
<?php
...
<tr><td colspan="3" class="ewPadding"><div id="ewBottom" class="phpreportmaker">
	<!-- Bottom slot -->
<a name="cht_Contratos_Cerrados"></a>
<div id="div_Contratos_Cerrados">
<?php

// Initialize chart data
$Contratos_Cerrados_cht_id = "Contratos_Cerrados_Contratos_Cerrados"; // Chart ID
$Contratos_Cerrados_cht_parms .= "type=1,"; // Chart type
$Contratos_Cerrados_cht_parms .= "bgcolor=#FCFCFC,"; // Background color
$Contratos_Cerrados_cht_parms .= "caption=" . ew_Encode("Contratos Cerrados") . ","; // Chart caption
$Contratos_Cerrados_cht_parms .= "borderleftcolor=#808080,"; // Border left color
$Contratos_Cerrados_cht_parms .= "bordertopcolor=#808080,"; // Border top color
$Contratos_Cerrados_cht_parms .= "borderbottomcolor=#808080,"; // Border bottom color
$Contratos_Cerrados_cht_parms .= "borderrightcolor=#808080,"; // Border right color
$Contratos_Cerrados_cht_parms .= "chartbgcolor=#EEEEEE,"; // Chart background color
$Contratos_Cerrados_cht_parms .= "chartbordercolor=#A9A9A9,"; // Chart border color
$Contratos_Cerrados_cht_parms .= "numgridlines=3,"; // Number of grid lines
$Contratos_Cerrados_cht_parms .= "gridlinecolor=#DCDCDC,"; // Grid line color
$Contratos_Cerrados_cht_parms .= "xaxisname=" . ew_Encode("Contratos Cerrados") . ","; // X axis name
$Contratos_Cerrados_cht_parms .= "xaxisnamerotated=0,"; // X axis name rotated
$Contratos_Cerrados_cht_parms .= "xaxisvaluemaxchar=20,"; // X axis value max char
$Contratos_Cerrados_cht_parms .= "yaxisname=" . ew_Encode("Total") . ","; // Y axis name
$Contratos_Cerrados_cht_parms .= "yaxisnamerotated=1,"; // Y axis name rotated
$Contratos_Cerrados_cht_parms .= "shownames=0,"; // Show names
$Contratos_Cerrados_cht_parms .= "showvalues=1,"; // Show values
$Contratos_Cerrados_cht_parms .= "showhover=1,"; // Show hover
$Contratos_Cerrados_cht_parms .= "alpha=50,"; // Chart alpha
$Contratos_Cerrados_cht_parms .= "colorpalette=#FF0000|#FF0080|#FF00FF|#8000FF|#FF8000|#FF3D3D|#7AFFFF|#0000FF|#FFFF00|#FF7A7A|#3DFFFF|#0080FF|#80FF00|#00FF00|#00FF80|#00FFFF,"; // Chart color palette
$Contratos_Cerrados_cht_parms .= "cssurl=rptcss/ewchart.css"; // Chart css
ew_SortChartData($Contratos_Cerrados_cht_smry, 0);
echo ew_ShowChart($Contratos_Cerrados_cht_id, $Contratos_Cerrados_cht_parms, $Contratos_Cerrados_cht_smry, 550, 440, "");
?>
</div>
<a href="#top">Top</a>
<br><br>
...
function GetRow($opt) {
	...
	while ($row) {
		if (ValidRow($row)) {
			...
			$val[1] = $GLOBALS["x_TipoContra"];
			$GLOBALS["x_CodLegalContra"] = $row["CodLegalContra"];
			$val[2] = $GLOBALS["x_CodLegalContra"];
			$GLOBALS["x_EmpContra"] = $row["EmpContra"];
			$val[3] = $GLOBALS["x_EmpContra"];
			$GLOBALS["x_FechDe"] = $row["FechDe"];
			$val[4] = $GLOBALS["x_FechDe"];
			$GLOBALS["x_FechAl"] = $row["FechAl"];
			$val[5] = $GLOBALS["x_FechAl"];
			$GLOBALS["x_motivo_cierre"] = $row["motivo_cierre"];
			$val[6] = $GLOBALS["x_motivo_cierre"];
			break;
		} else {
			$rsidx++;
			$row = ($rsidx < $rscnt) ? $rs[$rsidx] : FALSE;
...
function ProcessChartData(&$rs) {
	AccumulateChartSummary($rs, $GLOBALS["Contratos_Cerrados_cht_smry"], $GLOBALS["Contratos_Cerrados_cht_XFld"], "", $GLOBALS["Contratos_Cerrados_cht_YFld"], 0, "", "SUM");
}
?>
<?php
