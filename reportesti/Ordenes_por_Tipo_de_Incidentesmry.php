...
// PHP Report Maker 1.0 - Table level configuration (Ordenes por Tipo de Incidente)
// Table Level Constants

define("EW_TABLE_VAR", "Ordenes_por_Tipo_de_Incidente", TRUE);
define("EW_TABLE_GROUP_PER_PAGE", "grpperpage", TRUE);
define("EW_TABLE_SESSION_GROUP_PER_PAGE", "Ordenes_por_Tipo_de_Incidente_grpperpage", TRUE);
define("EW_TABLE_START_GROUP", "start", TRUE);
define("EW_TABLE_SESSION_START_GROUP", "Ordenes_por_Tipo_de_Incidente_start", TRUE);
define("EW_TABLE_SESSION_SEARCH", "Ordenes_por_Tipo_de_Incidente_search", TRUE);
define("EW_TABLE_CHILD_USER_ID", "childuserid", TRUE);
define("EW_TABLE_SESSION_CHILD_USER_ID", "Ordenes_por_Tipo_de_Incidente_childuserid", TRUE);

// Table Level SQL
define("EW_TABLE_SQL_FROM", "asignacion RIGHT OUTER JOIN ordenes ON (asignacion.id_asig = ordenes.id_orden)", TRUE);
$EW_TABLE_SQL_SELECT = "SELECT count(*) AS total, ordenes.id_orden, ordenes.fecha, ordenes.`time`, ordenes.cod_usr, ordenes.desc_inc, asignacion.`area` FROM " . EW_TABLE_SQL_FROM;
$EW_TABLE_SQL_WHERE = "";
define("EW_TABLE_SQL_GROUPBY", "ordenes.id_orden, ordenes.fecha, ordenes.`time`, ordenes.cod_usr, ordenes.desc_inc, asignacion.`area`", TRUE);
define("EW_TABLE_SQL_HAVING", "", TRUE);
define("EW_TABLE_SQL_ORDERBY", "asignacion.`area` ASC", TRUE);
...
// Group variables
$x_area = NULL; $ox_area = NULL; $gx_area = NULL; $dgx_area = NULL; $tx_area = NULL; $ftx_area = 200; $gfx_area = $ftx_area; $gbx_area = ""; $gix_area = "0"; $rf_area = NULL; $rt_area = NULL;
...
$Area_de_Incidente_cht_parms = NULL; // Store all chart parameters

// Chart data
$Area_de_Incidente_cht_index = NULL;
$Area_de_Incidente_cht_id = NULL;
$Area_de_Incidente_cht_smry = NULL;
$Area_de_Incidente_cht_XFld = NULL;
$Area_de_Incidente_cht_YFld = NULL;
$Area_de_Incidente_cht_YFldBase = NULL;
$Area_de_Incidente_cht_XFld = "area";
$Area_de_Incidente_cht_YFld = "total";
$Area_de_Incidente_cht_XDateFld = "";
?>
<?php
...
<a name="top"></a>
<?php } ?>
Ordenes por Tipo de Incidente
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="Ordenes_por_Tipo_de_Incidentesmry.php?export=html">Imprimir</a>
&nbsp;&nbsp;<a href="Ordenes_por_Tipo_de_Incidentesmry.php?export=excel">Exportar a Excel</a>
&nbsp;&nbsp;<a href="Ordenes_por_Tipo_de_Incidentesmry.php?export=word">Exportar a Word</a>
<?php } ?>
<br><br>
<?php if (@$sExport == "") { ?>
</div></td></tr>
...
<?php if (@$sExport == "") { ?>
<form action="Ordenes_por_Tipo_de_Incidentesmry.php" name="ewpagerform" id="ewpagerform">
...
<!--first page button-->
	...
	<?php } else { ?>
	<td><a href="Ordenes_por_Tipo_de_Incidentesmry.php?start=1"><img src="rptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($PrevStart == $nStartGrp) { ?>
	<td><img src="rptimages/prevdisab.gif" alt="Previous" width="16" height="16" border="0"></td>
	<?php } else { ?>
	<td><a href="Ordenes_por_Tipo_de_Incidentesmry.php?start=<?php echo $PrevStart; ?>"><img src="rptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } ?>
<!--current page number-->
...
<!--next page button-->
	...
	<?php } else { ?>
	<td><a href="Ordenes_por_Tipo_de_Incidentesmry.php?start=<?php echo $NextStart; ?>"><img src="rptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>
	<?php  } ?>
<!--last page button-->
	<?php if ($LastStart == $nStartGrp) { ?>
	<td><img src="rptimages/lastdisab.gif" alt="Last" width="16" height="16" border="0"></td>
	<?php } else { ?>
	<td><a href="Ordenes_por_Tipo_de_Incidentesmry.php?start=<?php echo $LastStart; ?>"><img src="rptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>
	<?php } ?>
...
<?php
	...
	if (intval($nGrpCount) >= intval($nStartGrp) && $nGrpCount <= $nStopGrp) {
		...
		// Show group values
		$dgx_area = $x_area;
		if (($x_area == NULL && $ox_area == NULL) ||
			(($x_area <> "" && $ox_area == $dgx_area) && !ChkLvlBreak(1))) {
			$dgx_area = "";
		} elseif ($x_area == NULL) {
			$dgx_area = EW_NULL_LABEL;
		} elseif ($x_area == "") {
			$dgx_area = EW_EMPTY_LABEL;
		}
?>
	<tr<?php echo $sItemRowClass; ?>>
		<td class="ewRptGrpField1">
		<?php $tx_area = $x_area; $x_area = $dgx_area; ?>
<?php echo $x_area ?>
		<?php $x_area = $tx_area; ?></td>
...
<?php if ($nTotalGrps > 0) { ?>
	...
	<tr class="ewRptGrandSummary"><td colspan="6">Grand Total (<?php echo ew_FormatNumber($cnt[0][0],0,-2,-2,-2); ?> Detail Records)</td></tr>
	<!--tr><td colspan="6"><span class="phpreportmaker">&nbsp;<br></span></td></tr-->
<?php } ?>
</table>
<!-- </form> -->
...
<tr><td colspan="3" class="ewPadding"><div id="ewBottom" class="phpreportmaker">
	<!-- Bottom slot -->
<a name="cht_Area_de_Incidente"></a>
<div id="div_Area_de_Incidente">
<?php

// Initialize chart data
$Area_de_Incidente_cht_id = "Ordenes_por_Tipo_de_Incidente_Area_de_Incidente"; // Chart ID
$Area_de_Incidente_cht_parms .= "type=1,"; // Chart type
$Area_de_Incidente_cht_parms .= "bgcolor=#FCFCFC,"; // Background color
$Area_de_Incidente_cht_parms .= "caption=" . ew_Encode("Area de Incidente") . ","; // Chart caption
$Area_de_Incidente_cht_parms .= "borderleftcolor=#808080,"; // Border left color
$Area_de_Incidente_cht_parms .= "bordertopcolor=#808080,"; // Border top color
$Area_de_Incidente_cht_parms .= "borderbottomcolor=#808080,"; // Border bottom color
$Area_de_Incidente_cht_parms .= "borderrightcolor=#808080,"; // Border right color
$Area_de_Incidente_cht_parms .= "chartbgcolor=#EEEEEE,"; // Chart background color
$Area_de_Incidente_cht_parms .= "chartbordercolor=#A9A9A9,"; // Chart border color
$Area_de_Incidente_cht_parms .= "numgridlines=3,"; // Number of grid lines
$Area_de_Incidente_cht_parms .= "gridlinecolor=#DCDCDC,"; // Grid line color
$Area_de_Incidente_cht_parms .= "xaxisname=" . ew_Encode("Area de Incidente") . ","; // X axis name
$Area_de_Incidente_cht_parms .= "xaxisnamerotated=0,"; // X axis name rotated
$Area_de_Incidente_cht_parms .= "xaxisvaluemaxchar=20,"; // X axis value max char
$Area_de_Incidente_cht_parms .= "yaxisname=" . ew_Encode("Total") . ","; // Y axis name
$Area_de_Incidente_cht_parms .= "yaxisnamerotated=1,"; // Y axis name rotated
$Area_de_Incidente_cht_parms .= "shownames=1,"; // Show names
$Area_de_Incidente_cht_parms .= "showvalues=1,"; // Show values
$Area_de_Incidente_cht_parms .= "showhover=1,"; // Show hover
$Area_de_Incidente_cht_parms .= "alpha=50,"; // Chart alpha
$Area_de_Incidente_cht_parms .= "colorpalette=#FF0000|#FFCC33|#003366|#3399FF|#00CC66|#663300|#7AFFFF|#0000FF|#FFFF00|#FF7A7A|#3DFFFF|#0080FF|#80FF00|#00FF00|#00FF80|#00FFFF,"; // Chart color palette
$Area_de_Incidente_cht_parms .= "cssurl=rptcss/ewchart.css"; // Chart css
ew_SortChartData($Area_de_Incidente_cht_smry, 0);
echo ew_ShowChart($Area_de_Incidente_cht_id, $Area_de_Incidente_cht_parms, $Area_de_Incidente_cht_smry, 550, 440, "");
?>
</div>
<a href="#top">Top</a>
<br><br>
...
function ChkLvlBreak($lvl) {
	switch ($lvl) {
		case 1:
			return ($GLOBALS["x_area"] == NULL && $GLOBALS["ox_area"] != NULL) ||
				($GLOBALS["x_area"] !== NULL && $GLOBALS["ox_area"] == NULL) ||
				($GLOBALS["x_area"] <> $GLOBALS["ox_area"]);
	}
}
...
function ProcessChartData(&$rs) {
	AccumulateChartSummary($rs, $GLOBALS["Area_de_Incidente_cht_smry"], $GLOBALS["Area_de_Incidente_cht_XFld"], "", $GLOBALS["Area_de_Incidente_cht_YFld"], 0, "", "SUM");
}
?>
<?php
