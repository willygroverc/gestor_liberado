...
// PHP Report Maker 1.0 - Table level configuration (Incidentes por Area)
// Table Level Constants

define("EW_TABLE_VAR", "Incidentes_por_Area", TRUE);
define("EW_TABLE_GROUP_PER_PAGE", "grpperpage", TRUE);
define("EW_TABLE_SESSION_GROUP_PER_PAGE", "Incidentes_por_Area_grpperpage", TRUE);
define("EW_TABLE_START_GROUP", "start", TRUE);
define("EW_TABLE_SESSION_START_GROUP", "Incidentes_por_Area_start", TRUE);
define("EW_TABLE_SESSION_SEARCH", "Incidentes_por_Area_search", TRUE);
define("EW_TABLE_CHILD_USER_ID", "childuserid", TRUE);
define("EW_TABLE_SESSION_CHILD_USER_ID", "Incidentes_por_Area_childuserid", TRUE);

// Table Level SQL
define("EW_TABLE_SQL_FROM", "`area` RIGHT OUTER JOIN ordenes ON (`area`.area_cod = ordenes.`area`)", TRUE);
$EW_TABLE_SQL_SELECT = "SELECT count(*) AS total, ordenes.id_orden, ordenes.fecha, ordenes.`time`, ordenes.cod_usr, ordenes.desc_inc, `area`.area_nombre FROM " . EW_TABLE_SQL_FROM;
$EW_TABLE_SQL_WHERE = "";
define("EW_TABLE_SQL_GROUPBY", "ordenes.id_orden, ordenes.fecha, ordenes.`time`, ordenes.cod_usr, ordenes.desc_inc, `area`.area_nombre", TRUE);
define("EW_TABLE_SQL_HAVING", "", TRUE);
define("EW_TABLE_SQL_ORDERBY", "`area`.area_nombre ASC", TRUE);
...
$Incidentes_por_Area_cht_parms = NULL; // Store all chart parameters

// Chart data
$Incidentes_por_Area_cht_index = NULL;
$Incidentes_por_Area_cht_id = NULL;
$Incidentes_por_Area_cht_smry = NULL;
$Incidentes_por_Area_cht_XFld = NULL;
$Incidentes_por_Area_cht_YFld = NULL;
$Incidentes_por_Area_cht_YFldBase = NULL;
$Incidentes_por_Area_cht_XFld = "area_nombre";
$Incidentes_por_Area_cht_YFld = "total";
$Incidentes_por_Area_cht_XDateFld = "";
?>
<?php
...
Incidentes por Area
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="Incidentes_por_Areasmry.php?export=html">Area</a>
&nbsp;&nbsp;<a href="Incidentes_por_Areasmry.php?export=excel">Exportar a Excel</a>
&nbsp;&nbsp;<a href="Incidentes_por_Areasmry.php?export=word">Exportar a Word</a>
<?php } ?>
<br><br>
<?php if (@$sExport == "") { ?>
</div></td></tr>
...
<?php if (@$sExport == "") { ?>
<form action="Incidentes_por_Areasmry.php" name="ewpagerform" id="ewpagerform">
...
<!--first page button-->
	...
	<?php } else { ?>
	<td><a href="Incidentes_por_Areasmry.php?start=1"><img src="rptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($PrevStart == $nStartGrp) { ?>
	<td><img src="rptimages/prevdisab.gif" alt="Previous" width="16" height="16" border="0"></td>
	<?php } else { ?>
	<td><a href="Incidentes_por_Areasmry.php?start=<?php echo $PrevStart; ?>"><img src="rptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } ?>
<!--current page number-->
...
<!--next page button-->
	...
	<?php } else { ?>
	<td><a href="Incidentes_por_Areasmry.php?start=<?php echo $NextStart; ?>"><img src="rptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>
	<?php  } ?>
<!--last page button-->
	<?php if ($LastStart == $nStartGrp) { ?>
	<td><img src="rptimages/lastdisab.gif" alt="Last" width="16" height="16" border="0"></td>
	<?php } else { ?>
	<td><a href="Incidentes_por_Areasmry.php?start=<?php echo $LastStart; ?>"><img src="rptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>
	<?php } ?>
...
<tr><td colspan="3" class="ewPadding"><div id="ewBottom" class="phpreportmaker">
	<!-- Bottom slot -->
<a name="cht_Incidentes_por_Area"></a>
<div id="div_Incidentes_por_Area">
<?php

// Initialize chart data
$Incidentes_por_Area_cht_id = "Incidentes_por_Area_Incidentes_por_Area"; // Chart ID
$Incidentes_por_Area_cht_parms .= "type=1,"; // Chart type
$Incidentes_por_Area_cht_parms .= "bgcolor=#FCFCFC,"; // Background color
$Incidentes_por_Area_cht_parms .= "caption=" . ew_Encode("Incidentes por Area") . ","; // Chart caption
$Incidentes_por_Area_cht_parms .= "borderleftcolor=#808080,"; // Border left color
$Incidentes_por_Area_cht_parms .= "bordertopcolor=#808080,"; // Border top color
$Incidentes_por_Area_cht_parms .= "borderbottomcolor=#808080,"; // Border bottom color
$Incidentes_por_Area_cht_parms .= "borderrightcolor=#808080,"; // Border right color
$Incidentes_por_Area_cht_parms .= "chartbgcolor=#EEEEEE,"; // Chart background color
$Incidentes_por_Area_cht_parms .= "chartbordercolor=#A9A9A9,"; // Chart border color
$Incidentes_por_Area_cht_parms .= "numgridlines=3,"; // Number of grid lines
$Incidentes_por_Area_cht_parms .= "gridlinecolor=#DCDCDC,"; // Grid line color
$Incidentes_por_Area_cht_parms .= "xaxisname=" . ew_Encode("Area") . ","; // X axis name
$Incidentes_por_Area_cht_parms .= "xaxisnamerotated=0,"; // X axis name rotated
$Incidentes_por_Area_cht_parms .= "xaxisvaluemaxchar=20,"; // X axis value max char
$Incidentes_por_Area_cht_parms .= "yaxisname=" . ew_Encode("Total") . ","; // Y axis name
$Incidentes_por_Area_cht_parms .= "yaxisnamerotated=1,"; // Y axis name rotated
$Incidentes_por_Area_cht_parms .= "shownames=1,"; // Show names
$Incidentes_por_Area_cht_parms .= "showvalues=1,"; // Show values
$Incidentes_por_Area_cht_parms .= "showhover=1,"; // Show hover
$Incidentes_por_Area_cht_parms .= "alpha=50,"; // Chart alpha
$Incidentes_por_Area_cht_parms .= "colorpalette=#FF0000|#FF0080|#FF00FF|#8000FF|#FF8000|#FF3D3D|#7AFFFF|#0000FF|#FFFF00|#FF7A7A|#3DFFFF|#0080FF|#80FF00|#00FF00|#00FF80|#00FFFF,"; // Chart color palette
$Incidentes_por_Area_cht_parms .= "cssurl=rptcss/ewchart.css"; // Chart css
ew_SortChartData($Incidentes_por_Area_cht_smry, 0);
echo ew_ShowChart($Incidentes_por_Area_cht_id, $Incidentes_por_Area_cht_parms, $Incidentes_por_Area_cht_smry, 550, 440, "");
?>
</div>
<a href="#top">Top</a>
<br><br>
...
function ProcessChartData(&$rs) {
	AccumulateChartSummary($rs, $GLOBALS["Incidentes_por_Area_cht_smry"], $GLOBALS["Incidentes_por_Area_cht_XFld"], "", $GLOBALS["Incidentes_por_Area_cht_YFld"], 0, "", "SUM");
}
?>
<?php
