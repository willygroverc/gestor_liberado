...
// PHP Report Maker 1.0 - Table level configuration (Contratos Vigentes)
// Table Level Constants

define("EW_TABLE_VAR", "Contratos_Vigentes", TRUE);
define("EW_TABLE_GROUP_PER_PAGE", "grpperpage", TRUE);
define("EW_TABLE_SESSION_GROUP_PER_PAGE", "Contratos_Vigentes_grpperpage", TRUE);
define("EW_TABLE_START_GROUP", "start", TRUE);
define("EW_TABLE_SESSION_START_GROUP", "Contratos_Vigentes_start", TRUE);
define("EW_TABLE_SESSION_SEARCH", "Contratos_Vigentes_search", TRUE);
define("EW_TABLE_CHILD_USER_ID", "childuserid", TRUE);
define("EW_TABLE_SESSION_CHILD_USER_ID", "Contratos_Vigentes_childuserid", TRUE);

// Table Level SQL
define("EW_TABLE_SQL_FROM", "contratodatos", TRUE);
$EW_TABLE_SQL_SELECT = "SELECT count(*) AS total, count(contratodatos.IdContra)/count(contratodatos.IdContra) as aux, contratodatos.IdContra, contratodatos.TipoContra, contratodatos.CodLegalContra, contratodatos.EmpContra, contratodatos.PartCont, contratodatos.FechDe, contratodatos.FechAl FROM " . EW_TABLE_SQL_FROM;
$EW_TABLE_SQL_WHERE = "(contratodatos.FechAl > NOW())";
define("EW_TABLE_SQL_GROUPBY", "contratodatos.IdContra, contratodatos.TipoContra, contratodatos.CodLegalContra, contratodatos.EmpContra, contratodatos.PartCont, contratodatos.FechDe, contratodatos.FechAl", TRUE);
...
$Contratos_Vigentes_cht_parms = NULL; // Store all chart parameters

// Chart data
$Contratos_Vigentes_cht_index = NULL;
$Contratos_Vigentes_cht_id = NULL;
$Contratos_Vigentes_cht_smry = NULL;
$Contratos_Vigentes_cht_XFld = NULL;
$Contratos_Vigentes_cht_YFld = NULL;
$Contratos_Vigentes_cht_YFldBase = NULL;
$Contratos_Vigentes_cht_XFld = "aux";
$Contratos_Vigentes_cht_YFld = "total";
$Contratos_Vigentes_cht_XDateFld = "";
?>
<?php
...
Contratos Vigentes
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="Contratos_Vigentessmry.php?export=html">Imprimir</a>
&nbsp;&nbsp;<a href="Contratos_Vigentessmry.php?export=excel">Exportar a Excel</a>
&nbsp;&nbsp;<a href="Contratos_Vigentessmry.php?export=word">Exportar a Word</a>
<?php } ?>
<br><br>
<?php if (@$sExport == "") { ?>
</div></td></tr>
...
<?php if (@$sExport == "") { ?>
<form action="Contratos_Vigentessmry.php" name="ewpagerform" id="ewpagerform">
...
<!--first page button-->
	...
	<?php } else { ?>
	<td><a href="Contratos_Vigentessmry.php?start=1"><img src="rptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($PrevStart == $nStartGrp) { ?>
	<td><img src="rptimages/prevdisab.gif" alt="Previous" width="16" height="16" border="0"></td>
	<?php } else { ?>
	<td><a href="Contratos_Vigentessmry.php?start=<?php echo $PrevStart; ?>"><img src="rptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } ?>
<!--current page number-->
...
<!--next page button-->
	...
	<?php } else { ?>
	<td><a href="Contratos_Vigentessmry.php?start=<?php echo $NextStart; ?>"><img src="rptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>
	<?php  } ?>
<!--last page button-->
	<?php if ($LastStart == $nStartGrp) { ?>
	<td><img src="rptimages/lastdisab.gif" alt="Last" width="16" height="16" border="0"></td>
	<?php } else { ?>
	<td><a href="Contratos_Vigentessmry.php?start=<?php echo $LastStart; ?>"><img src="rptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>
	<?php } ?>
...
<tr><td colspan="3" class="ewPadding"><div id="ewBottom" class="phpreportmaker">
	<!-- Bottom slot -->
<a name="cht_Contratos_Vigentes"></a>
<div id="div_Contratos_Vigentes">
<?php

// Initialize chart data
$Contratos_Vigentes_cht_id = "Contratos_Vigentes_Contratos_Vigentes"; // Chart ID
$Contratos_Vigentes_cht_parms .= "type=1,"; // Chart type
$Contratos_Vigentes_cht_parms .= "bgcolor=#FCFCFC,"; // Background color
$Contratos_Vigentes_cht_parms .= "caption=" . ew_Encode("Contratos Vigentes") . ","; // Chart caption
$Contratos_Vigentes_cht_parms .= "borderleftcolor=#808080,"; // Border left color
$Contratos_Vigentes_cht_parms .= "bordertopcolor=#808080,"; // Border top color
$Contratos_Vigentes_cht_parms .= "borderbottomcolor=#808080,"; // Border bottom color
$Contratos_Vigentes_cht_parms .= "borderrightcolor=#808080,"; // Border right color
$Contratos_Vigentes_cht_parms .= "chartbgcolor=#EEEEEE,"; // Chart background color
$Contratos_Vigentes_cht_parms .= "chartbordercolor=#A9A9A9,"; // Chart border color
$Contratos_Vigentes_cht_parms .= "numgridlines=3,"; // Number of grid lines
$Contratos_Vigentes_cht_parms .= "gridlinecolor=#DCDCDC,"; // Grid line color
$Contratos_Vigentes_cht_parms .= "xaxisname=" . ew_Encode("Contratos Vigentes") . ","; // X axis name
$Contratos_Vigentes_cht_parms .= "xaxisnamerotated=0,"; // X axis name rotated
$Contratos_Vigentes_cht_parms .= "xaxisvaluemaxchar=20,"; // X axis value max char
$Contratos_Vigentes_cht_parms .= "yaxisname=" . ew_Encode("Total") . ","; // Y axis name
$Contratos_Vigentes_cht_parms .= "yaxisnamerotated=1,"; // Y axis name rotated
$Contratos_Vigentes_cht_parms .= "shownames=0,"; // Show names
$Contratos_Vigentes_cht_parms .= "showvalues=1,"; // Show values
$Contratos_Vigentes_cht_parms .= "showhover=1,"; // Show hover
$Contratos_Vigentes_cht_parms .= "alpha=50,"; // Chart alpha
$Contratos_Vigentes_cht_parms .= "colorpalette=#FF0000|#FF0080|#FF00FF|#8000FF|#FF8000|#FF3D3D|#7AFFFF|#0000FF|#FFFF00|#FF7A7A|#3DFFFF|#0080FF|#80FF00|#00FF00|#00FF80|#00FFFF,"; // Chart color palette
$Contratos_Vigentes_cht_parms .= "cssurl=rptcss/ewchart.css"; // Chart css
ew_SortChartData($Contratos_Vigentes_cht_smry, 0);
echo ew_ShowChart($Contratos_Vigentes_cht_id, $Contratos_Vigentes_cht_parms, $Contratos_Vigentes_cht_smry, 550, 440, "");
?>
</div>
<a href="#top">Top</a>
<br><br>
...
function ProcessChartData(&$rs) {
	AccumulateChartSummary($rs, $GLOBALS["Contratos_Vigentes_cht_smry"], $GLOBALS["Contratos_Vigentes_cht_XFld"], "", $GLOBALS["Contratos_Vigentes_cht_YFld"], 0, "", "SUM");
}
?>
<?php
