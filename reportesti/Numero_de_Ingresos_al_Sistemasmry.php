...
// PHP Report Maker 1.0 - Table level configuration (Numero de Ingresos al Sistema)
// Table Level Constants

define("EW_TABLE_VAR", "Numero_de_Ingresos_al_Sistema", TRUE);
define("EW_TABLE_GROUP_PER_PAGE", "grpperpage", TRUE);
define("EW_TABLE_SESSION_GROUP_PER_PAGE", "Numero_de_Ingresos_al_Sistema_grpperpage", TRUE);
define("EW_TABLE_START_GROUP", "start", TRUE);
define("EW_TABLE_SESSION_START_GROUP", "Numero_de_Ingresos_al_Sistema_start", TRUE);
define("EW_TABLE_SESSION_SEARCH", "Numero_de_Ingresos_al_Sistema_search", TRUE);
define("EW_TABLE_CHILD_USER_ID", "childuserid", TRUE);
define("EW_TABLE_SESSION_CHILD_USER_ID", "Numero_de_Ingresos_al_Sistema_childuserid", TRUE);

// Table Level SQL
define("EW_TABLE_SQL_FROM", "users RIGHT OUTER JOIN registro ON (users.login_usr = registro.login_usr)", TRUE);
$EW_TABLE_SQL_SELECT = "SELECT COUNT(*) AS total, registro.login_usr, registro.tipo_d, registro.fecha, users.tipo2_usr FROM " . EW_TABLE_SQL_FROM;
$EW_TABLE_SQL_WHERE = "";
define("EW_TABLE_SQL_GROUPBY", "registro.login_usr, registro.tipo_d, registro.fecha, users.tipo2_usr", TRUE);
define("EW_TABLE_SQL_HAVING", "", TRUE);
define("EW_TABLE_SQL_ORDERBY", "registro.login_usr ASC", TRUE);
define("EW_TABLE_SQL_USERID_FILTER", "", TRUE);
$af_login_usr = NULL; // Advanced filter for login_usr
$af_tipo_d = NULL; // Advanced filter for tipo_d
$af_fecha = NULL; // Advanced filter for fecha
$af_tipo2_usr = NULL; // Advanced filter for tipo2_usr
?>
<?php
...
// Detail variables
$x_tipo_d = NULL; $ox_tipo_d = NULL; $tx_tipo_d = NULL; $ftx_tipo_d = 200; $rf_tipo_d = NULL; $rt_tipo_d = NULL;
$x_fecha = NULL; $ox_fecha = NULL; $tx_fecha = NULL; $ftx_fecha = 135; $rf_fecha = NULL; $rt_fecha = NULL;
$x_tipo2_usr = NULL; $ox_tipo2_usr = NULL; $tx_tipo2_usr = NULL; $ftx_tipo2_usr = 200; $rf_tipo2_usr = NULL; $rt_tipo2_usr = NULL;
?>
<?php
...
<a name="top"></a>
<?php } ?>
Numero de Ingresos al Sistema
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="Numero_de_Ingresos_al_Sistemasmry.php?export=html">Imprimir</a>
&nbsp;&nbsp;<a href="Numero_de_Ingresos_al_Sistemasmry.php?export=excel">Exportar a Excel</a>
&nbsp;&nbsp;<a href="Numero_de_Ingresos_al_Sistemasmry.php?export=word">Exportar a Word</a>
<?php } ?>
<br><br>
<?php if (@$sExport == "") { ?>
</div></td></tr>
...
<?php if (@$sExport == "") { ?>
<form action="Numero_de_Ingresos_al_Sistemasmry.php" name="ewpagerform" id="ewpagerform">
...
<!--first page button-->
	...
	<?php } else { ?>
	<td><a href="Numero_de_Ingresos_al_Sistemasmry.php?start=1"><img src="rptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($PrevStart == $nStartGrp) { ?>
	<td><img src="rptimages/prevdisab.gif" alt="Previous" width="16" height="16" border="0"></td>
	<?php } else { ?>
	<td><a href="Numero_de_Ingresos_al_Sistemasmry.php?start=<?php echo $PrevStart; ?>"><img src="rptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } ?>
<!--current page number-->
...
<!--next page button-->
	...
	<?php } else { ?>
	<td><a href="Numero_de_Ingresos_al_Sistemasmry.php?start=<?php echo $NextStart; ?>"><img src="rptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>
	<?php  } ?>
<!--last page button-->
	<?php if ($LastStart == $nStartGrp) { ?>
	<td><img src="rptimages/lastdisab.gif" alt="Last" width="16" height="16" border="0"></td>
	<?php } else { ?>
	<td><a href="Numero_de_Ingresos_al_Sistemasmry.php?start=<?php echo $LastStart; ?>"><img src="rptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>
	<?php } ?>
...
function GetRow($opt) {
	...
	while ($row) {
		if (ValidRow($row)) {
			...
			$GLOBALS["x_tipo_d"] = $row["tipo_d"];
			$val[1] = $GLOBALS["x_tipo_d"];
			$GLOBALS["x_fecha"] = $row["fecha"];
			$val[2] = $GLOBALS["x_fecha"];
			$GLOBALS["x_tipo2_usr"] = $row["tipo2_usr"];
			$val[3] = $GLOBALS["x_tipo2_usr"];
			break;
		} else {
			$rsidx++;
			$row = ($rsidx < $rscnt) ? $rs[$rsidx] : FALSE;
