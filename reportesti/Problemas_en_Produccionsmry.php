...
// PHP Report Maker 1.0 - Table level configuration (Problemas en Produccion)
// Table Level Constants

define("EW_TABLE_VAR", "Problemas_en_Produccion", TRUE);
define("EW_TABLE_GROUP_PER_PAGE", "grpperpage", TRUE);
define("EW_TABLE_SESSION_GROUP_PER_PAGE", "Problemas_en_Produccion_grpperpage", TRUE);
define("EW_TABLE_START_GROUP", "start", TRUE);
define("EW_TABLE_SESSION_START_GROUP", "Problemas_en_Produccion_start", TRUE);
define("EW_TABLE_SESSION_SEARCH", "Problemas_en_Produccion_search", TRUE);
define("EW_TABLE_CHILD_USER_ID", "childuserid", TRUE);
define("EW_TABLE_SESSION_CHILD_USER_ID", "Problemas_en_Produccion_childuserid", TRUE);

// Table Level SQL
define("EW_TABLE_SQL_FROM", "detaller LEFT OUTER JOIN ordenes ON (detaller.id_orden = ordenes.id_orden) LEFT OUTER JOIN revision ON (detaller.id_orden = revision.id_orden)", TRUE);
$EW_TABLE_SQL_SELECT = "SELECT ordenes.id_orden, ordenes.fecha, ordenes.`time`, ordenes.desc_inc, detaller.Fecha_ini, detaller.Fecha_fin, revision.nomb_rrevision, revision.fecha_rr, revision.nomb_rauditoria, revision.fecha_ra, revision.observaciones FROM " . EW_TABLE_SQL_FROM;
$EW_TABLE_SQL_WHERE = "";
...
$af_Fecha_ini = NULL; // Advanced filter for Fecha_ini
$af_Fecha_fin = NULL; // Advanced filter for Fecha_fin
$af_nomb_rrevision = NULL; // Advanced filter for nomb_rrevision
$af_fecha_rr = NULL; // Advanced filter for fecha_rr
$af_nomb_rauditoria = NULL; // Advanced filter for nomb_rauditoria
$af_fecha_ra = NULL; // Advanced filter for fecha_ra
...
$x_Fecha_ini = NULL; $ox_Fecha_ini = NULL; $tx_Fecha_ini = NULL; $ftx_Fecha_ini = 133; $rf_Fecha_ini = NULL; $rt_Fecha_ini = NULL;
$x_Fecha_fin = NULL; $ox_Fecha_fin = NULL; $tx_Fecha_fin = NULL; $ftx_Fecha_fin = 133; $rf_Fecha_fin = NULL; $rt_Fecha_fin = NULL;
$x_nomb_rrevision = NULL; $ox_nomb_rrevision = NULL; $tx_nomb_rrevision = NULL; $ftx_nomb_rrevision = 200; $rf_nomb_rrevision = NULL; $rt_nomb_rrevision = NULL;
$x_fecha_rr = NULL; $ox_fecha_rr = NULL; $tx_fecha_rr = NULL; $ftx_fecha_rr = 133; $rf_fecha_rr = NULL; $rt_fecha_rr = NULL;
$x_nomb_rauditoria = NULL; $ox_nomb_rauditoria = NULL; $tx_nomb_rauditoria = NULL; $ftx_nomb_rauditoria = 200; $rf_nomb_rauditoria = NULL; $rt_nomb_rauditoria = NULL;
$x_fecha_ra = NULL; $ox_fecha_ra = NULL; $tx_fecha_ra = NULL; $ftx_fecha_ra = 133; $rf_fecha_ra = NULL; $rt_fecha_ra = NULL;
...
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="Problemas_en_Produccionsmry.php?export=html">Imprimir</a>
&nbsp;&nbsp;<a href="Problemas_en_Produccionsmry.php?export=excel">Exportar a Excel</a>
&nbsp;&nbsp;<a href="Problemas_en_Produccionsmry.php?export=word">Exportar a Word</a>
<?php } ?>
<br><br>
<?php if (@$sExport == "") { ?>
</div></td></tr>
...
<?php if (@$sExport == "") { ?>
<form action="Problemas_en_Produccionsmry.php" name="ewpagerform" id="ewpagerform">
...
<!--first page button-->
	...
	<?php } else { ?>
	<td><a href="Problemas_en_Produccionsmry.php?start=1"><img src="rptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($PrevStart == $nStartGrp) { ?>
	<td><img src="rptimages/prevdisab.gif" alt="Previous" width="16" height="16" border="0"></td>
	<?php } else { ?>
	<td><a href="Problemas_en_Produccionsmry.php?start=<?php echo $PrevStart; ?>"><img src="rptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } ?>
<!--current page number-->
...
<!--next page button-->
	...
	<?php } else { ?>
	<td><a href="Problemas_en_Produccionsmry.php?start=<?php echo $NextStart; ?>"><img src="rptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>
	<?php  } ?>
<!--last page button-->
	<?php if ($LastStart == $nStartGrp) { ?>
	<td><img src="rptimages/lastdisab.gif" alt="Last" width="16" height="16" border="0"></td>
	<?php } else { ?>
	<td><a href="Problemas_en_Produccionsmry.php?start=<?php echo $LastStart; ?>"><img src="rptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>
	<?php } ?>
...
<?php echo str_replace(chr(10), "<br>", $x_desc_inc); ?>
		...
		<td class="ewRptDtlField">
<?php echo ew_FormatDateTime($x_Fecha_ini,5) ?>
</td>
		<td class="ewRptDtlField">
<?php echo ew_FormatDateTime($x_Fecha_fin,5) ?>
</td>
		<td class="ewRptDtlField">
<?php echo $x_nomb_rrevision ?>
</td>
		<td class="ewRptDtlField">
<?php echo ew_FormatDateTime($x_fecha_rr,5) ?>
</td>
		<td class="ewRptDtlField">
<?php echo $x_nomb_rauditoria ?>
</td>
		<td class="ewRptDtlField">
<?php echo ew_FormatDateTime($x_fecha_ra,5) ?>
</td>
		<td class="ewRptDtlField">
...
<?php if ($nTotalGrps > 0) { ?>
	...
	<tr class="ewRptGrandSummary"><td colspan="11">Total Registros (<?php echo ew_FormatNumber($cnt[0][0],0,-2,-2,-2); ?> Registros Detallados)</td></tr>
	<!--tr><td colspan="11"><span class="phpreportmaker">&nbsp;<br></span></td></tr-->
<?php } ?>
</table>
<!-- </form> -->
...
function GetRow($opt) {
	...
	while ($row) {
		if (ValidRow($row)) {
			...
			$GLOBALS["x_Fecha_ini"] = $row["Fecha_ini"];
			$val[5] = $GLOBALS["x_Fecha_ini"];
			$GLOBALS["x_Fecha_fin"] = $row["Fecha_fin"];
			$val[6] = $GLOBALS["x_Fecha_fin"];
			$GLOBALS["x_nomb_rrevision"] = $row["nomb_rrevision"];
			$val[7] = $GLOBALS["x_nomb_rrevision"];
			$GLOBALS["x_fecha_rr"] = $row["fecha_rr"];
			$val[8] = $GLOBALS["x_fecha_rr"];
			$GLOBALS["x_nomb_rauditoria"] = $row["nomb_rauditoria"];
			$val[9] = $GLOBALS["x_nomb_rauditoria"];
			$GLOBALS["x_fecha_ra"] = $row["fecha_ra"];
			$val[10] = $GLOBALS["x_fecha_ra"];
			$GLOBALS["x_observaciones"] = $row["observaciones"];
			$val[11] = $GLOBALS["x_observaciones"];
			break;
		} else {
			$rsidx++;
			$row = ($rsidx < $rscnt) ? $rs[$rsidx] : FALSE;
	...
	if (!$row) {
		...
		$GLOBALS["x_Fecha_ini"] = "";
		$GLOBALS["x_Fecha_fin"] = "";
		$GLOBALS["x_nomb_rrevision"] = "";
		$GLOBALS["x_fecha_rr"] = "";
		$GLOBALS["x_nomb_rauditoria"] = "";
		$GLOBALS["x_fecha_ra"] = "";
