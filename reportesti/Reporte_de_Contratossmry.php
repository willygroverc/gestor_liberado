...
// PHP Report Maker 1.0 - Table level configuration (Reporte de Contratos)
// Table Level Constants

define("EW_TABLE_VAR", "Reporte_de_Contratos", TRUE);
define("EW_TABLE_GROUP_PER_PAGE", "grpperpage", TRUE);
define("EW_TABLE_SESSION_GROUP_PER_PAGE", "Reporte_de_Contratos_grpperpage", TRUE);
define("EW_TABLE_START_GROUP", "start", TRUE);
define("EW_TABLE_SESSION_START_GROUP", "Reporte_de_Contratos_start", TRUE);
define("EW_TABLE_SESSION_SEARCH", "Reporte_de_Contratos_search", TRUE);
define("EW_TABLE_CHILD_USER_ID", "childuserid", TRUE);
define("EW_TABLE_SESSION_CHILD_USER_ID", "Reporte_de_Contratos_childuserid", TRUE);

// Table Level SQL
define("EW_TABLE_SQL_FROM", "contratodatos", TRUE);
$EW_TABLE_SQL_SELECT = "SELECT contratodatos.TipoContra, contratodatos.CodLegalContra, contratodatos.EmpContra, contratodatos.FechAl FROM " . EW_TABLE_SQL_FROM;
$EW_TABLE_SQL_WHERE = "(IdContra = ALL(SELECT contratodatos.IdContra FROM contratodatos WHERE (FechAl < NOW())))";
...
<!-- </form> -->
<form action="Reporte_de_Contratossmry.php" name="ewpagerform" id="ewpagerform">
...
<!--first page button-->
	...
	<?php } else { ?>
	<td><a href="Reporte_de_Contratossmry.php?start=1"><img src="rptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($PrevStart == $nStartGrp) { ?>
	<td><img src="rptimages/prevdisab.gif" alt="Previous" width="16" height="16" border="0"></td>
	<?php } else { ?>
	<td><a href="Reporte_de_Contratossmry.php?start=<?php echo $PrevStart; ?>"><img src="rptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } ?>
<!--current page number-->
...
<!--next page button-->
	...
	<?php } else { ?>
	<td><a href="Reporte_de_Contratossmry.php?start=<?php echo $NextStart; ?>"><img src="rptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>
	<?php  } ?>
<!--last page button-->
	<?php if ($LastStart == $nStartGrp) { ?>
	<td><img src="rptimages/lastdisab.gif" alt="Last" width="16" height="16" border="0"></td>
	<?php } else { ?>
	<td><a href="Reporte_de_Contratossmry.php?start=<?php echo $LastStart; ?>"><img src="rptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>
	<?php } ?>
