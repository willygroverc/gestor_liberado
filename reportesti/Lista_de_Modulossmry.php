...
// PHP Report Maker 1.0 - Table level configuration (Lista de Modulos)
// Table Level Constants

define("EW_TABLE_VAR", "Lista_de_Modulos", TRUE);
define("EW_TABLE_GROUP_PER_PAGE", "grpperpage", TRUE);
define("EW_TABLE_SESSION_GROUP_PER_PAGE", "Lista_de_Modulos_grpperpage", TRUE);
define("EW_TABLE_START_GROUP", "start", TRUE);
define("EW_TABLE_SESSION_START_GROUP", "Lista_de_Modulos_start", TRUE);
define("EW_TABLE_SESSION_SEARCH", "Lista_de_Modulos_search", TRUE);
define("EW_TABLE_CHILD_USER_ID", "childuserid", TRUE);
define("EW_TABLE_SESSION_CHILD_USER_ID", "Lista_de_Modulos_childuserid", TRUE);

// Table Level SQL
define("EW_TABLE_SQL_FROM", "modulo", TRUE);
...
$af_id_mod = NULL; // Advanced filter for id_mod
$af_nombre_mod = NULL; // Advanced filter for nombre_mod
$af_desc_mod = NULL; // Advanced filter for desc_mod
$af_fecha_creacion = NULL; // Advanced filter for fecha_creacion
$af_fecha_baja = NULL; // Advanced filter for fecha_baja
$af_estado = NULL; // Advanced filter for estado
$af_login_creador = NULL; // Advanced filter for login_creador
?>
<?php
...
// Detail variables
$x_id_mod = NULL; $ox_id_mod = NULL; $tx_id_mod = NULL; $ftx_id_mod = 3; $rf_id_mod = NULL; $rt_id_mod = NULL;
...
$x_fecha_creacion = NULL; $ox_fecha_creacion = NULL; $tx_fecha_creacion = NULL; $ftx_fecha_creacion = 133; $rf_fecha_creacion = NULL; $rt_fecha_creacion = NULL;
$x_fecha_baja = NULL; $ox_fecha_baja = NULL; $tx_fecha_baja = NULL; $ftx_fecha_baja = 133; $rf_fecha_baja = NULL; $rt_fecha_baja = NULL;
$x_estado = NULL; $ox_estado = NULL; $tx_estado = NULL; $ftx_estado = 3; $rf_estado = NULL; $rt_estado = NULL;
$x_login_creador = NULL; $ox_login_creador = NULL; $tx_login_creador = NULL; $ftx_login_creador = 200; $rf_login_creador = NULL; $rt_login_creador = NULL;
?>
<?php
...
Lista de Modulos
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="Lista_de_Modulossmry.php?export=html">Imprimir</a>
&nbsp;&nbsp;<a href="Lista_de_Modulossmry.php?export=excel">Exportar a Excel</a>
&nbsp;&nbsp;<a href="Lista_de_Modulossmry.php?export=word">Exportar a Word</a>
<?php } ?>
<br><br>
<?php if (@$sExport == "") { ?>
</div></td></tr>
...
<?php if (@$sExport == "") { ?>
<form action="Lista_de_Modulossmry.php" name="ewpagerform" id="ewpagerform">
...
<!--first page button-->
	...
	<?php } else { ?>
	<td><a href="Lista_de_Modulossmry.php?start=1"><img src="rptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($PrevStart == $nStartGrp) { ?>
	<td><img src="rptimages/prevdisab.gif" alt="Previous" width="16" height="16" border="0"></td>
	<?php } else { ?>
	<td><a href="Lista_de_Modulossmry.php?start=<?php echo $PrevStart; ?>"><img src="rptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } ?>
<!--current page number-->
...
<!--next page button-->
	...
	<?php } else { ?>
	<td><a href="Lista_de_Modulossmry.php?start=<?php echo $NextStart; ?>"><img src="rptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>
	<?php  } ?>
<!--last page button-->
	<?php if ($LastStart == $nStartGrp) { ?>
	<td><img src="rptimages/lastdisab.gif" alt="Last" width="16" height="16" border="0"></td>
	<?php } else { ?>
	<td><a href="Lista_de_Modulossmry.php?start=<?php echo $LastStart; ?>"><img src="rptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>
	<?php } ?>
...
<?php echo $x_id_mod ?>
		...
		<td class="ewRptDtlField">
<?php echo str_replace(chr(10), "<br>", $x_nombre_mod); ?>
</td>
		<td class="ewRptDtlField">
<?php echo str_replace(chr(10), "<br>", $x_desc_mod); ?>
</td>
		<td class="ewRptDtlField">
<?php echo ew_FormatDateTime($x_fecha_creacion,5) ?>
</td>
		<td class="ewRptDtlField">
<?php echo ew_FormatDateTime($x_fecha_baja,5) ?>
</td>
		<td class="ewRptDtlField">
<?php echo $x_estado ?>
</td>
		<td class="ewRptDtlField">
<?php echo $x_login_creador ?>
</td>
	</tr>
<?php
...
function GetRow($opt) {
	...
	while ($row) {
		if (ValidRow($row)) {
			$GLOBALS["x_id_mod"] = $row["id_mod"];
			$val[1] = $GLOBALS["x_id_mod"];
			$GLOBALS["x_nombre_mod"] = $row["nombre_mod"];
			$val[2] = $GLOBALS["x_nombre_mod"];
			$GLOBALS["x_desc_mod"] = $row["desc_mod"];
			$val[3] = $GLOBALS["x_desc_mod"];
			$GLOBALS["x_fecha_creacion"] = $row["fecha_creacion"];
			$val[4] = $GLOBALS["x_fecha_creacion"];
			$GLOBALS["x_fecha_baja"] = $row["fecha_baja"];
			$val[5] = $GLOBALS["x_fecha_baja"];
			$GLOBALS["x_estado"] = $row["estado"];
			$val[6] = $GLOBALS["x_estado"];
			$GLOBALS["x_login_creador"] = $row["login_creador"];
			$val[7] = $GLOBALS["x_login_creador"];
			break;
		} else {
			$rsidx++;
			$row = ($rsidx < $rscnt) ? $rs[$rsidx] : FALSE;
	...
	if (!$row) {
		...
		$GLOBALS["x_desc_mod"] = "";
		$GLOBALS["x_fecha_creacion"] = "";
		$GLOBALS["x_fecha_baja"] = "";
		$GLOBALS["x_estado"] = "";
		$GLOBALS["x_login_creador"] = "";
	}
}
