...
// PHP Report Maker 1.0 - Table level configuration (Lista de Tareas Semanales)
// Table Level Constants

define("EW_TABLE_VAR", "Lista_de_Tareas_Semanales", TRUE);
define("EW_TABLE_GROUP_PER_PAGE", "grpperpage", TRUE);
define("EW_TABLE_SESSION_GROUP_PER_PAGE", "Lista_de_Tareas_Semanales_grpperpage", TRUE);
define("EW_TABLE_START_GROUP", "start", TRUE);
define("EW_TABLE_SESSION_START_GROUP", "Lista_de_Tareas_Semanales_start", TRUE);
define("EW_TABLE_SESSION_SEARCH", "Lista_de_Tareas_Semanales_search", TRUE);
define("EW_TABLE_CHILD_USER_ID", "childuserid", TRUE);
define("EW_TABLE_SESSION_CHILD_USER_ID", "Lista_de_Tareas_Semanales_childuserid", TRUE);

// Table Level SQL
define("EW_TABLE_SQL_FROM", "progtareassemanal", TRUE);
$EW_TABLE_SQL_SELECT = "SELECT progtareassemanal.IdProgTarea, progtareassemanal.HoraDe, progtareassemanal.HoraA, progtareassemanal.Actividad, progtareassemanal.Dia, progtareassemanal.FechaDe, progtareassemanal.Observaciones FROM " . EW_TABLE_SQL_FROM;
$EW_TABLE_SQL_WHERE = "";
...
$af_IdProgTarea = NULL; // Advanced filter for IdProgTarea
$af_HoraDe = NULL; // Advanced filter for HoraDe
$af_HoraA = NULL; // Advanced filter for HoraA
$af_Actividad = NULL; // Advanced filter for Actividad
$af_Dia = NULL; // Advanced filter for Dia
$af_FechaDe = NULL; // Advanced filter for FechaDe
...
// Detail variables
$x_IdProgTarea = NULL; $ox_IdProgTarea = NULL; $tx_IdProgTarea = NULL; $ftx_IdProgTarea = 19; $rf_IdProgTarea = NULL; $rt_IdProgTarea = NULL;
$x_HoraDe = NULL; $ox_HoraDe = NULL; $tx_HoraDe = NULL; $ftx_HoraDe = 134; $rf_HoraDe = NULL; $rt_HoraDe = NULL;
$x_HoraA = NULL; $ox_HoraA = NULL; $tx_HoraA = NULL; $ftx_HoraA = 134; $rf_HoraA = NULL; $rt_HoraA = NULL;
$x_Actividad = NULL; $ox_Actividad = NULL; $tx_Actividad = NULL; $ftx_Actividad = 201; $rf_Actividad = NULL; $rt_Actividad = NULL;
$x_Dia = NULL; $ox_Dia = NULL; $tx_Dia = NULL; $ftx_Dia = 200; $rf_Dia = NULL; $rt_Dia = NULL;
$x_FechaDe = NULL; $ox_FechaDe = NULL; $tx_FechaDe = NULL; $ftx_FechaDe = 133; $rf_FechaDe = NULL; $rt_FechaDe = NULL;
...
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="Lista_de_Tareas_Semanalessmry.php?export=html">Imprimir</a>
&nbsp;&nbsp;<a href="Lista_de_Tareas_Semanalessmry.php?export=excel">Exportar a Excel</a>
&nbsp;&nbsp;<a href="Lista_de_Tareas_Semanalessmry.php?export=word">Exportar a Word</a>
<?php } ?>
<br><br>
<?php if (@$sExport == "") { ?>
</div></td></tr>
...
<?php if (@$sExport == "") { ?>
<form action="Lista_de_Tareas_Semanalessmry.php" name="ewpagerform" id="ewpagerform">
...
<!--first page button-->
	...
	<?php } else { ?>
	<td><a href="Lista_de_Tareas_Semanalessmry.php?start=1"><img src="rptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($PrevStart == $nStartGrp) { ?>
	<td><img src="rptimages/prevdisab.gif" alt="Previous" width="16" height="16" border="0"></td>
	<?php } else { ?>
	<td><a href="Lista_de_Tareas_Semanalessmry.php?start=<?php echo $PrevStart; ?>"><img src="rptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } ?>
<!--current page number-->
...
<!--next page button-->
	...
	<?php } else { ?>
	<td><a href="Lista_de_Tareas_Semanalessmry.php?start=<?php echo $NextStart; ?>"><img src="rptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>
	<?php  } ?>
<!--last page button-->
	<?php if ($LastStart == $nStartGrp) { ?>
	<td><img src="rptimages/lastdisab.gif" alt="Last" width="16" height="16" border="0"></td>
	<?php } else { ?>
	<td><a href="Lista_de_Tareas_Semanalessmry.php?start=<?php echo $LastStart; ?>"><img src="rptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>
	<?php } ?>
...
<?php echo $x_HoraA ?>
		...
		<td class="ewRptDtlField">
<?php echo str_replace(chr(10), "<br>", $x_Actividad); ?>
</td>
		<td class="ewRptDtlField">
<?php echo $x_Dia ?>
</td>
		<td class="ewRptDtlField">
<?php echo ew_FormatDateTime($x_FechaDe,5) ?>
</td>
		<td class="ewRptDtlField">
...
function GetRow($opt) {
	...
	while ($row) {
		if (ValidRow($row)) {
			$GLOBALS["x_IdProgTarea"] = $row["IdProgTarea"];
			$val[1] = $GLOBALS["x_IdProgTarea"];
			$GLOBALS["x_HoraDe"] = $row["HoraDe"];
			$val[2] = $GLOBALS["x_HoraDe"];
			$GLOBALS["x_HoraA"] = $row["HoraA"];
			$val[3] = $GLOBALS["x_HoraA"];
			$GLOBALS["x_Actividad"] = $row["Actividad"];
			$val[4] = $GLOBALS["x_Actividad"];
			$GLOBALS["x_Dia"] = $row["Dia"];
			$val[5] = $GLOBALS["x_Dia"];
			$GLOBALS["x_FechaDe"] = $row["FechaDe"];
			$val[6] = $GLOBALS["x_FechaDe"];
			$GLOBALS["x_Observaciones"] = $row["Observaciones"];
			$val[7] = $GLOBALS["x_Observaciones"];
			break;
		} else {
			$rsidx++;
			$row = ($rsidx < $rscnt) ? $rs[$rsidx] : FALSE;
