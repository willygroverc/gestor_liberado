...
// PHP Report Maker 1.0 - Table level configuration (Lista de Tareas Diarias)
// Table Level Constants

define("EW_TABLE_VAR", "Lista_de_Tareas_Diarias", TRUE);
define("EW_TABLE_GROUP_PER_PAGE", "grpperpage", TRUE);
define("EW_TABLE_SESSION_GROUP_PER_PAGE", "Lista_de_Tareas_Diarias_grpperpage", TRUE);
define("EW_TABLE_START_GROUP", "start", TRUE);
define("EW_TABLE_SESSION_START_GROUP", "Lista_de_Tareas_Diarias_start", TRUE);
define("EW_TABLE_SESSION_SEARCH", "Lista_de_Tareas_Diarias_search", TRUE);
define("EW_TABLE_CHILD_USER_ID", "childuserid", TRUE);
define("EW_TABLE_SESSION_CHILD_USER_ID", "Lista_de_Tareas_Diarias_childuserid", TRUE);

// Table Level SQL
define("EW_TABLE_SQL_FROM", "progtareasdiaria", TRUE);
$EW_TABLE_SQL_SELECT = "SELECT progtareasdiaria.IdProgTarea, progtareasdiaria.HoraDe, progtareasdiaria.HoraA, progtareasdiaria.Actividad, progtareasdiaria.FechaDe, progtareasdiaria.Observaciones FROM " . EW_TABLE_SQL_FROM;
$EW_TABLE_SQL_WHERE = "";
...
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="Lista_de_Tareas_Diariassmry.php?export=html">Imprimir</a>
&nbsp;&nbsp;<a href="Lista_de_Tareas_Diariassmry.php?export=excel">Exportar a Excel</a>
&nbsp;&nbsp;<a href="Lista_de_Tareas_Diariassmry.php?export=word">Exportar a Word</a>
<?php } ?>
<br><br>
<?php if (@$sExport == "") { ?>
</div></td></tr>
...
<?php if (@$sExport == "") { ?>
<form action="Lista_de_Tareas_Diariassmry.php" name="ewpagerform" id="ewpagerform">
...
<!--first page button-->
	...
	<?php } else { ?>
	<td><a href="Lista_de_Tareas_Diariassmry.php?start=1"><img src="rptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($PrevStart == $nStartGrp) { ?>
	<td><img src="rptimages/prevdisab.gif" alt="Previous" width="16" height="16" border="0"></td>
	<?php } else { ?>
	<td><a href="Lista_de_Tareas_Diariassmry.php?start=<?php echo $PrevStart; ?>"><img src="rptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } ?>
<!--current page number-->
...
<!--next page button-->
	...
	<?php } else { ?>
	<td><a href="Lista_de_Tareas_Diariassmry.php?start=<?php echo $NextStart; ?>"><img src="rptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>
	<?php  } ?>
<!--last page button-->
	<?php if ($LastStart == $nStartGrp) { ?>
	<td><img src="rptimages/lastdisab.gif" alt="Last" width="16" height="16" border="0"></td>
	<?php } else { ?>
	<td><a href="Lista_de_Tareas_Diariassmry.php?start=<?php echo $LastStart; ?>"><img src="rptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>
	<?php } ?>
...
function GetRow($opt) {
	...
	while ($row) {
		if (ValidRow($row)) {
			...
			$val[5] = $GLOBALS["x_FechaDe"];
			$GLOBALS["x_Observaciones"] = $row["Observaciones"];
			$val[6] = $GLOBALS["x_Observaciones"];
			break;
		} else {
			$rsidx++;
			$row = ($rsidx < $rscnt) ? $rs[$rsidx] : FALSE;
