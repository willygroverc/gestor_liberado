...
// PHP Report Maker 1.0 - Table level configuration (Problemas Produccion - Revision del dia Siguiente)
// Table Level Constants

define("EW_TABLE_VAR", "Problemas_Produccion_2D_Revision_del_dia_Siguiente", TRUE);
define("EW_TABLE_GROUP_PER_PAGE", "grpperpage", TRUE);
define("EW_TABLE_SESSION_GROUP_PER_PAGE", "Problemas_Produccion_2D_Revision_del_dia_Siguiente_grpperpage", TRUE);
define("EW_TABLE_START_GROUP", "start", TRUE);
define("EW_TABLE_SESSION_START_GROUP", "Problemas_Produccion_2D_Revision_del_dia_Siguiente_start", TRUE);
define("EW_TABLE_SESSION_SEARCH", "Problemas_Produccion_2D_Revision_del_dia_Siguiente_search", TRUE);
define("EW_TABLE_CHILD_USER_ID", "childuserid", TRUE);
define("EW_TABLE_SESSION_CHILD_USER_ID", "Problemas_Produccion_2D_Revision_del_dia_Siguiente_childuserid", TRUE);

// Table Level SQL
define("EW_TABLE_SQL_FROM", "ordenes RIGHT OUTER JOIN asignacion ON (ordenes.id_orden = asignacion.id_orden)", TRUE);
$EW_TABLE_SQL_SELECT = "SELECT ordenes.id_orden, ordenes.fecha, ordenes.`time`, ordenes.desc_inc FROM " . EW_TABLE_SQL_FROM;
$EW_TABLE_SQL_WHERE = "asignacion.area = 'Problemas'";
...
<a name="top"></a>
<?php } ?>
Problemas Produccion Revision del dia Siguiente
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="Problemas_Produccion_2D_Revision_del_dia_Siguientesmry.php?export=html">Imprimir</a>
&nbsp;&nbsp;<a href="Problemas_Produccion_2D_Revision_del_dia_Siguientesmry.php?export=excel">Exportar a Excel</a>
&nbsp;&nbsp;<a href="Problemas_Produccion_2D_Revision_del_dia_Siguientesmry.php?export=word">Exportar a Word</a>
<?php } ?>
<br><br>
<?php if (@$sExport == "") { ?>
</div></td></tr>
...
<?php if (@$sExport == "") { ?>
<form action="Problemas_Produccion_2D_Revision_del_dia_Siguientesmry.php" name="ewpagerform" id="ewpagerform">
...
<!--first page button-->
	...
	<?php } else { ?>
	<td><a href="Problemas_Produccion_2D_Revision_del_dia_Siguientesmry.php?start=1"><img src="rptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($PrevStart == $nStartGrp) { ?>
	<td><img src="rptimages/prevdisab.gif" alt="Previous" width="16" height="16" border="0"></td>
	<?php } else { ?>
	<td><a href="Problemas_Produccion_2D_Revision_del_dia_Siguientesmry.php?start=<?php echo $PrevStart; ?>"><img src="rptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } ?>
<!--current page number-->
...
<!--next page button-->
	...
	<?php } else { ?>
	<td><a href="Problemas_Produccion_2D_Revision_del_dia_Siguientesmry.php?start=<?php echo $NextStart; ?>"><img src="rptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>
	<?php  } ?>
<!--last page button-->
	<?php if ($LastStart == $nStartGrp) { ?>
	<td><img src="rptimages/lastdisab.gif" alt="Last" width="16" height="16" border="0"></td>
	<?php } else { ?>
	<td><a href="Problemas_Produccion_2D_Revision_del_dia_Siguientesmry.php?start=<?php echo $LastStart; ?>"><img src="rptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>
	<?php } ?>
...
<?php if ($nTotalGrps > 0) { ?>
	...
	<tr class="ewRptGrandSummary"><td colspan="4">Total Registros (<?php echo ew_FormatNumber($cnt[0][0],0,-2,-2,-2); ?> Registros Detallados)</td></tr>
	<!--tr><td colspan="4"><span class="phpreportmaker">&nbsp;<br></span></td></tr-->
<?php } ?>
</table>
<!-- </form> -->
