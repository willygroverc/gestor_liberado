...
// PHP Report Maker 1.0 - Table level configuration (Ordenes 2004)
// Table Level Constants

define("EW_TABLE_VAR", "Ordenes_2004", TRUE);
define("EW_TABLE_GROUP_PER_PAGE", "grpperpage", TRUE);
define("EW_TABLE_SESSION_GROUP_PER_PAGE", "Ordenes_2004_grpperpage", TRUE);
define("EW_TABLE_START_GROUP", "start", TRUE);
define("EW_TABLE_SESSION_START_GROUP", "Ordenes_2004_start", TRUE);
define("EW_TABLE_SESSION_SEARCH", "Ordenes_2004_search", TRUE);
define("EW_TABLE_CHILD_USER_ID", "childuserid", TRUE);
define("EW_TABLE_SESSION_CHILD_USER_ID", "Ordenes_2004_childuserid", TRUE);
...
$EW_TABLE_SQL_WHERE = "(ordenes.fecha BETWEEN '2004/01/01' AND '2004/12/31')";
...
$Ordenes_por_Mes_Gestion_2004_cht_parms = NULL; // Store all chart parameters

// Chart data
$Ordenes_por_Mes_Gestion_2004_cht_index = NULL;
$Ordenes_por_Mes_Gestion_2004_cht_id = NULL;
$Ordenes_por_Mes_Gestion_2004_cht_smry = NULL;
$Ordenes_por_Mes_Gestion_2004_cht_XFld = NULL;
$Ordenes_por_Mes_Gestion_2004_cht_YFld = NULL;
$Ordenes_por_Mes_Gestion_2004_cht_YFldBase = NULL;
$Ordenes_por_Mes_Gestion_2004_cht_XFld = "mes";
$Ordenes_por_Mes_Gestion_2004_cht_YFld = "aux";
$Ordenes_por_Mes_Gestion_2004_cht_XDateFld = "";
?>
<?php
...
<!-- top slot -->
<a name="top"></a>
Ordenes de Trabajo  Mensuales de 2004
<br><br>
</div></td></tr>
<!-- Top Container (End) -->
<tr>
...
<?php if ($nTotalGrps > 0) { ?>
	...
	<tr class="ewRptGrandSummary"><td colspan="11">Total Registros (<?php echo ew_FormatNumber($cnt[0][0],0,-2,-2,-2); ?> Registros Detalldos)</td></tr>
	<!--tr><td colspan="11"><span class="phpreportmaker">&nbsp;<br></span></td></tr-->
<?php } ?>
</table>
<!-- </form> -->
<form action="Ordenes_2004smry.php" name="ewpagerform" id="ewpagerform">
...
<!--first page button-->
	...
	<?php } else { ?>
	<td><a href="Ordenes_2004smry.php?start=1"><img src="rptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($PrevStart == $nStartGrp) { ?>
	<td><img src="rptimages/prevdisab.gif" alt="Previous" width="16" height="16" border="0"></td>
	<?php } else { ?>
	<td><a href="Ordenes_2004smry.php?start=<?php echo $PrevStart; ?>"><img src="rptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } ?>
<!--current page number-->
...
<!--next page button-->
	...
	<?php } else { ?>
	<td><a href="Ordenes_2004smry.php?start=<?php echo $NextStart; ?>"><img src="rptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>
	<?php  } ?>
<!--last page button-->
	<?php if ($LastStart == $nStartGrp) { ?>
	<td><img src="rptimages/lastdisab.gif" alt="Last" width="16" height="16" border="0"></td>
	<?php } else { ?>
	<td><a href="Ordenes_2004smry.php?start=<?php echo $LastStart; ?>"><img src="rptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>
	<?php } ?>
...
<tr><td colspan="3" class="ewPadding"><div id="ewBottom" class="phpreportmaker">
	<!-- Bottom slot -->
<a name="cht_Ordenes_por_Mes_Gestion_2004"></a>
<div id="div_Ordenes_por_Mes_Gestion_2004">
<?php

// Initialize chart data
$Ordenes_por_Mes_Gestion_2004_cht_id = "Ordenes_2004_Ordenes_por_Mes_Gestion_2004"; // Chart ID
$Ordenes_por_Mes_Gestion_2004_cht_parms .= "type=1,"; // Chart type
$Ordenes_por_Mes_Gestion_2004_cht_parms .= "bgcolor=#FCFCFC,"; // Background color
$Ordenes_por_Mes_Gestion_2004_cht_parms .= "caption=" . ew_Encode("Ordenes por Mes Gestion 2004") . ","; // Chart caption
$Ordenes_por_Mes_Gestion_2004_cht_parms .= "borderleftcolor=#808080,"; // Border left color
$Ordenes_por_Mes_Gestion_2004_cht_parms .= "bordertopcolor=#808080,"; // Border top color
$Ordenes_por_Mes_Gestion_2004_cht_parms .= "borderbottomcolor=#808080,"; // Border bottom color
$Ordenes_por_Mes_Gestion_2004_cht_parms .= "borderrightcolor=#808080,"; // Border right color
$Ordenes_por_Mes_Gestion_2004_cht_parms .= "chartbgcolor=#EEEEEE,"; // Chart background color
$Ordenes_por_Mes_Gestion_2004_cht_parms .= "chartbordercolor=#A9A9A9,"; // Chart border color
$Ordenes_por_Mes_Gestion_2004_cht_parms .= "numgridlines=3,"; // Number of grid lines
$Ordenes_por_Mes_Gestion_2004_cht_parms .= "gridlinecolor=#DCDCDC,"; // Grid line color
$Ordenes_por_Mes_Gestion_2004_cht_parms .= "xaxisname=" . ew_Encode("Mes") . ","; // X axis name
$Ordenes_por_Mes_Gestion_2004_cht_parms .= "xaxisnamerotated=0,"; // X axis name rotated
$Ordenes_por_Mes_Gestion_2004_cht_parms .= "xaxisvaluemaxchar=20,"; // X axis value max char
$Ordenes_por_Mes_Gestion_2004_cht_parms .= "yaxisname=" . ew_Encode("Ordenes de Trabajo") . ","; // Y axis name
$Ordenes_por_Mes_Gestion_2004_cht_parms .= "yaxisnamerotated=1,"; // Y axis name rotated
$Ordenes_por_Mes_Gestion_2004_cht_parms .= "shownames=1,"; // Show names
$Ordenes_por_Mes_Gestion_2004_cht_parms .= "showvalues=1,"; // Show values
$Ordenes_por_Mes_Gestion_2004_cht_parms .= "showhover=1,"; // Show hover
$Ordenes_por_Mes_Gestion_2004_cht_parms .= "alpha=50,"; // Chart alpha
$Ordenes_por_Mes_Gestion_2004_cht_parms .= "colorpalette=#FF0000|#FF0080|#FF00FF|#8000FF|#FF8000|#FF3D3D|#7AFFFF|#0000FF|#FFFF00|#FF7A7A|#3DFFFF|#0080FF|#80FF00|#00FF00|#00FF80|#00FFFF,"; // Chart color palette
$Ordenes_por_Mes_Gestion_2004_cht_parms .= "cssurl=rptcss/ewchart.css"; // Chart css
ew_SortChartData($Ordenes_por_Mes_Gestion_2004_cht_smry, 0);
echo ew_ShowChart($Ordenes_por_Mes_Gestion_2004_cht_id, $Ordenes_por_Mes_Gestion_2004_cht_parms, $Ordenes_por_Mes_Gestion_2004_cht_smry, 550, 440, "");
?>
</div>
<a href="#top">Top</a>
<br><br>
...
function ProcessChartData(&$rs) {
	AccumulateChartSummary($rs, $GLOBALS["Ordenes_por_Mes_Gestion_2004_cht_smry"], $GLOBALS["Ordenes_por_Mes_Gestion_2004_cht_XFld"], "", $GLOBALS["Ordenes_por_Mes_Gestion_2004_cht_YFld"], 0, "", "SUM");
}
?>
<?php
