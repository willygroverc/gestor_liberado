...
// PHP Report Maker 1.0 - Table level configuration (Clasificacion de la Informacion)
// Table Level Constants

define("EW_TABLE_VAR", "Clasificacion_de_la_Informacion", TRUE);
define("EW_TABLE_GROUP_PER_PAGE", "grpperpage", TRUE);
define("EW_TABLE_SESSION_GROUP_PER_PAGE", "Clasificacion_de_la_Informacion_grpperpage", TRUE);
define("EW_TABLE_START_GROUP", "start", TRUE);
define("EW_TABLE_SESSION_START_GROUP", "Clasificacion_de_la_Informacion_start", TRUE);
define("EW_TABLE_SESSION_SEARCH", "Clasificacion_de_la_Informacion_search", TRUE);
define("EW_TABLE_CHILD_USER_ID", "childuserid", TRUE);
define("EW_TABLE_SESSION_CHILD_USER_ID", "Clasificacion_de_la_Informacion_childuserid", TRUE);

// Table Level SQL
define("EW_TABLE_SQL_FROM", "informacionast", TRUE);
$EW_TABLE_SQL_SELECT = "SELECT count(*) AS total, informacionast.id_infAST, informacionast.tecnico, informacionast.des_infAST, informacionast.clasifi, informacionast.tiempo_ret, informacionast.control FROM " . EW_TABLE_SQL_FROM;
$EW_TABLE_SQL_WHERE = "";
define("EW_TABLE_SQL_GROUPBY", "informacionast.id_infAST, informacionast.tecnico, informacionast.des_infAST, informacionast.clasifi, informacionast.tiempo_ret, informacionast.control", TRUE);
define("EW_TABLE_SQL_HAVING", "", TRUE);
define("EW_TABLE_SQL_ORDERBY", "informacionast.tecnico ASC", TRUE);
define("EW_TABLE_SQL_USERID_FILTER", "", TRUE);
$af_id_infAST = NULL; // Advanced filter for id_infAST
$af_tecnico = NULL; // Advanced filter for tecnico
$af_des_infAST = NULL; // Advanced filter for des_infAST
$af_tiempo_ret = NULL; // Advanced filter for tiempo_ret
$af_control = NULL; // Advanced filter for control
?>
<?php
...
// Group variables
$x_tecnico = NULL; $ox_tecnico = NULL; $gx_tecnico = NULL; $dgx_tecnico = NULL; $tx_tecnico = NULL; $ftx_tecnico = 200; $gfx_tecnico = $ftx_tecnico; $gbx_tecnico = ""; $gix_tecnico = "0"; $rf_tecnico = NULL; $rt_tecnico = NULL;

// Detail variables
$x_id_infAST = NULL; $ox_id_infAST = NULL; $tx_id_infAST = NULL; $ftx_id_infAST = 3; $rf_id_infAST = NULL; $rt_id_infAST = NULL;
$x_des_infAST = NULL; $ox_des_infAST = NULL; $tx_des_infAST = NULL; $ftx_des_infAST = 201; $rf_des_infAST = NULL; $rt_des_infAST = NULL;
$x_tiempo_ret = NULL; $ox_tiempo_ret = NULL; $tx_tiempo_ret = NULL; $ftx_tiempo_ret = 200; $rf_tiempo_ret = NULL; $rt_tiempo_ret = NULL;
$x_control = NULL; $ox_control = NULL; $tx_control = NULL; $ftx_control = 200; $rf_control = NULL; $rt_control = NULL;
?>
<?php

// Chart configuration parameters
$Clasificacion_de_la_Informacion_cht_parms = NULL; // Store all chart parameters

// Chart data
$Clasificacion_de_la_Informacion_cht_index = NULL;
$Clasificacion_de_la_Informacion_cht_id = NULL;
$Clasificacion_de_la_Informacion_cht_smry = NULL;
$Clasificacion_de_la_Informacion_cht_XFld = NULL;
$Clasificacion_de_la_Informacion_cht_YFld = NULL;
$Clasificacion_de_la_Informacion_cht_YFldBase = NULL;
$Clasificacion_de_la_Informacion_cht_XFld = "clasifi";
$Clasificacion_de_la_Informacion_cht_YFld = "total";
$Clasificacion_de_la_Informacion_cht_XDateFld = "";
?>
<?php
...
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="Clasificacion_de_la_Informacionsmry.php?export=html">Imprimir</a>
&nbsp;&nbsp;<a href="Clasificacion_de_la_Informacionsmry.php?export=excel">Exportar a Excel</a>
&nbsp;&nbsp;<a href="Clasificacion_de_la_Informacionsmry.php?export=word">Exportar a Word</a>
<?php } ?>
<br><br>
<?php if (@$sExport == "") { ?>
</div></td></tr>
...
<?php if (@$sExport == "") { ?>
<form action="Clasificacion_de_la_Informacionsmry.php" name="ewpagerform" id="ewpagerform">
...
<!--first page button-->
	...
	<?php } else { ?>
	<td><a href="Clasificacion_de_la_Informacionsmry.php?start=1"><img src="rptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($PrevStart == $nStartGrp) { ?>
	<td><img src="rptimages/prevdisab.gif" alt="Previous" width="16" height="16" border="0"></td>
	<?php } else { ?>
	<td><a href="Clasificacion_de_la_Informacionsmry.php?start=<?php echo $PrevStart; ?>"><img src="rptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } ?>
<!--current page number-->
...
<!--next page button-->
	...
	<?php } else { ?>
	<td><a href="Clasificacion_de_la_Informacionsmry.php?start=<?php echo $NextStart; ?>"><img src="rptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>
	<?php  } ?>
<!--last page button-->
	<?php if ($LastStart == $nStartGrp) { ?>
	<td><img src="rptimages/lastdisab.gif" alt="Last" width="16" height="16" border="0"></td>
	<?php } else { ?>
	<td><a href="Clasificacion_de_la_Informacionsmry.php?start=<?php echo $LastStart; ?>"><img src="rptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>
	<?php } ?>
...
<?php
	...
	if (intval($nGrpCount) >= intval($nStartGrp) && $nGrpCount <= $nStopGrp) {
		...
		// Show group values
		$dgx_tecnico = $x_tecnico;
		if (($x_tecnico == NULL && $ox_tecnico == NULL) ||
			(($x_tecnico <> "" && $ox_tecnico == $dgx_tecnico) && !ChkLvlBreak(1))) {
			$dgx_tecnico = "";
		} elseif ($x_tecnico == NULL) {
			$dgx_tecnico = EW_NULL_LABEL;
		} elseif ($x_tecnico == "") {
			$dgx_tecnico = EW_EMPTY_LABEL;
		}
?>
	<tr<?php echo $sItemRowClass; ?>>
		<td class="ewRptGrpField1">
		<?php $tx_tecnico = $x_tecnico; $x_tecnico = $dgx_tecnico; ?>
<?php echo $x_tecnico ?>
		<?php $x_tecnico = $tx_tecnico; ?></td>
		<td class="ewRptDtlField">
<?php echo $x_id_infAST ?>
</td>
		<td class="ewRptDtlField">
<?php echo str_replace(chr(10), "<br>", $x_des_infAST); ?>
</td>
		<td class="ewRptDtlField">
<?php echo $x_tiempo_ret ?>
</td>
		<td class="ewRptDtlField">
<?php echo $x_control ?>
</td>
...
<?php if ($nTotalGrps > 0) { ?>
	...
	<tr class="ewRptGrandSummary"><td colspan="5">Total Registros (<?php echo ew_FormatNumber($cnt[0][0],0,-2,-2,-2); ?> Registros Detallados)</td></tr>
	<!--tr><td colspan="5"><span class="phpreportmaker">&nbsp;<br></span></td></tr-->
<?php } ?>
</table>
<!-- </form> -->
...
<tr><td colspan="3" class="ewPadding"><div id="ewBottom" class="phpreportmaker">
	<!-- Bottom slot -->
<a name="cht_Clasificacion_de_la_Informacion"></a>
<div id="div_Clasificacion_de_la_Informacion">
<?php

// Initialize chart data
$Clasificacion_de_la_Informacion_cht_id = "Clasificacion_de_la_Informacion_Clasificacion_de_la_Informacion"; // Chart ID
$Clasificacion_de_la_Informacion_cht_parms .= "type=1,"; // Chart type
$Clasificacion_de_la_Informacion_cht_parms .= "bgcolor=#FCFCFC,"; // Background color
$Clasificacion_de_la_Informacion_cht_parms .= "caption=" . ew_Encode("Clasificacion de la Informacion") . ","; // Chart caption
$Clasificacion_de_la_Informacion_cht_parms .= "borderleftcolor=#808080,"; // Border left color
$Clasificacion_de_la_Informacion_cht_parms .= "bordertopcolor=#808080,"; // Border top color
$Clasificacion_de_la_Informacion_cht_parms .= "borderbottomcolor=#808080,"; // Border bottom color
$Clasificacion_de_la_Informacion_cht_parms .= "borderrightcolor=#808080,"; // Border right color
$Clasificacion_de_la_Informacion_cht_parms .= "chartbgcolor=#EEEEEE,"; // Chart background color
$Clasificacion_de_la_Informacion_cht_parms .= "chartbordercolor=#A9A9A9,"; // Chart border color
$Clasificacion_de_la_Informacion_cht_parms .= "numgridlines=3,"; // Number of grid lines
$Clasificacion_de_la_Informacion_cht_parms .= "gridlinecolor=#DCDCDC,"; // Grid line color
$Clasificacion_de_la_Informacion_cht_parms .= "xaxisname=" . ew_Encode("Clasificacion") . ","; // X axis name
$Clasificacion_de_la_Informacion_cht_parms .= "xaxisnamerotated=0,"; // X axis name rotated
$Clasificacion_de_la_Informacion_cht_parms .= "xaxisvaluemaxchar=20,"; // X axis value max char
$Clasificacion_de_la_Informacion_cht_parms .= "yaxisname=" . ew_Encode("Total") . ","; // Y axis name
$Clasificacion_de_la_Informacion_cht_parms .= "yaxisnamerotated=1,"; // Y axis name rotated
$Clasificacion_de_la_Informacion_cht_parms .= "shownames=1,"; // Show names
$Clasificacion_de_la_Informacion_cht_parms .= "showvalues=1,"; // Show values
$Clasificacion_de_la_Informacion_cht_parms .= "showhover=1,"; // Show hover
$Clasificacion_de_la_Informacion_cht_parms .= "alpha=50,"; // Chart alpha
$Clasificacion_de_la_Informacion_cht_parms .= "colorpalette=#FF0000|#FF0080|#FF00FF|#8000FF|#FF8000|#FF3D3D|#7AFFFF|#0000FF|#FFFF00|#FF7A7A|#3DFFFF|#0080FF|#80FF00|#00FF00|#00FF80|#00FFFF,"; // Chart color palette
$Clasificacion_de_la_Informacion_cht_parms .= "cssurl=rptcss/ewchart.css"; // Chart css
ew_SortChartData($Clasificacion_de_la_Informacion_cht_smry, 0);
echo ew_ShowChart($Clasificacion_de_la_Informacion_cht_id, $Clasificacion_de_la_Informacion_cht_parms, $Clasificacion_de_la_Informacion_cht_smry, 550, 440, "");
?>
</div>
<a href="#top">Top</a>
<br><br>
...
function ChkLvlBreak($lvl) {
	switch ($lvl) {
		case 1:
			return ($GLOBALS["x_tecnico"] == NULL && $GLOBALS["ox_tecnico"] != NULL) ||
				($GLOBALS["x_tecnico"] !== NULL && $GLOBALS["ox_tecnico"] == NULL) ||
				($GLOBALS["x_tecnico"] <> $GLOBALS["ox_tecnico"]);
	}
}
...
function GetRow($opt) {
	...
	while ($row) {
		if (ValidRow($row)) {
			$GLOBALS["x_tecnico"] = $row["tecnico"];
			$GLOBALS["x_id_infAST"] = $row["id_infAST"];
			$val[1] = $GLOBALS["x_id_infAST"];
			$GLOBALS["x_des_infAST"] = $row["des_infAST"];
			$val[2] = $GLOBALS["x_des_infAST"];
			$GLOBALS["x_tiempo_ret"] = $row["tiempo_ret"];
			$val[3] = $GLOBALS["x_tiempo_ret"];
			$GLOBALS["x_control"] = $row["control"];
			$val[4] = $GLOBALS["x_control"];
			break;
		} else {
			$rsidx++;
			$row = ($rsidx < $rscnt) ? $rs[$rsidx] : FALSE;
	...
	if (!$row) {
		$GLOBALS["x_tecnico"] = "";
		$GLOBALS["x_id_infAST"] = "";
		$GLOBALS["x_des_infAST"] = "";
		$GLOBALS["x_tiempo_ret"] = "";
		$GLOBALS["x_control"] = "";
	}
}
...
function InitReportData(&$rs) {
	...
	foreach ($rs as $row) {
		...
		// Update group count
		if ($bValidRow) {
			$x_tecnico = $row["tecnico"];
			$gx_tecnico = $x_tecnico;
			$bNewGroup = ($grpcnt == 0) ||
				($grpvalue == NULL && $x_tecnico != NULL) ||
				($grpvalue != NULL && $x_tecnico == NULL) ||
				(@$grpvalue <> $gx_tecnico);
			if ($bNewGroup) {
				$grpvalue = $gx_tecnico;
...
function ProcessChartData(&$rs) {
	AccumulateChartSummary($rs, $GLOBALS["Clasificacion_de_la_Informacion_cht_smry"], $GLOBALS["Clasificacion_de_la_Informacion_cht_XFld"], "", $GLOBALS["Clasificacion_de_la_Informacion_cht_YFld"], 0, "", "SUM");
}
?>
<?php
