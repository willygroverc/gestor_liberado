...
// PHP Report Maker 1.0 - Table level configuration (Solucion Anticipada)
// Table Level Constants

define("EW_TABLE_VAR", "Solucion_Anticipada", TRUE);
define("EW_TABLE_GROUP_PER_PAGE", "grpperpage", TRUE);
define("EW_TABLE_SESSION_GROUP_PER_PAGE", "Solucion_Anticipada_grpperpage", TRUE);
define("EW_TABLE_START_GROUP", "start", TRUE);
define("EW_TABLE_SESSION_START_GROUP", "Solucion_Anticipada_start", TRUE);
define("EW_TABLE_SESSION_SEARCH", "Solucion_Anticipada_search", TRUE);
define("EW_TABLE_CHILD_USER_ID", "childuserid", TRUE);
define("EW_TABLE_SESSION_CHILD_USER_ID", "Solucion_Anticipada_childuserid", TRUE);

// Table Level SQL
define("EW_TABLE_SQL_FROM", "solucion RIGHT OUTER JOIN asignacion ON (solucion.id_orden = asignacion.id_orden) LEFT OUTER JOIN ordenes ON (asignacion.id_orden = ordenes.id_orden)", TRUE);
$EW_TABLE_SQL_SELECT = "SELECT count(*) AS total, count(ordenes.id_orden) / count(ordenes.id_orden) AS aux, ordenes.id_orden, ordenes.desc_inc, asignacion.asig, asignacion.fecha_asig, asignacion.fechaestsol_asig, solucion.fecha_sol FROM " . EW_TABLE_SQL_FROM;
...
$Solucion_Anticipada_cht_parms = NULL; // Store all chart parameters

// Chart data
$Solucion_Anticipada_cht_index = NULL;
$Solucion_Anticipada_cht_id = NULL;
$Solucion_Anticipada_cht_smry = NULL;
$Solucion_Anticipada_cht_XFld = NULL;
$Solucion_Anticipada_cht_YFld = NULL;
$Solucion_Anticipada_cht_YFldBase = NULL;
$Solucion_Anticipada_cht_XFld = "aux";
$Solucion_Anticipada_cht_YFld = "total";
$Solucion_Anticipada_cht_XDateFld = "";
?>
<?php
...
Solucion Anticipada
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="Solucion_Anticipadasmry.php?export=html">Imprimir</a>
&nbsp;&nbsp;<a href="Solucion_Anticipadasmry.php?export=excel">Exportar a Excel</a>
&nbsp;&nbsp;<a href="Solucion_Anticipadasmry.php?export=word">Exportar a Word</a>
<?php } ?>
<br><br>
<?php if (@$sExport == "") { ?>
</div></td></tr>
...
<?php if (@$sExport == "") { ?>
<form action="Solucion_Anticipadasmry.php" name="ewpagerform" id="ewpagerform">
...
<!--first page button-->
	...
	<?php } else { ?>
	<td><a href="Solucion_Anticipadasmry.php?start=1"><img src="rptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($PrevStart == $nStartGrp) { ?>
	<td><img src="rptimages/prevdisab.gif" alt="Previous" width="16" height="16" border="0"></td>
	<?php } else { ?>
	<td><a href="Solucion_Anticipadasmry.php?start=<?php echo $PrevStart; ?>"><img src="rptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } ?>
<!--current page number-->
...
<!--next page button-->
	...
	<?php } else { ?>
	<td><a href="Solucion_Anticipadasmry.php?start=<?php echo $NextStart; ?>"><img src="rptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>
	<?php  } ?>
<!--last page button-->
	<?php if ($LastStart == $nStartGrp) { ?>
	<td><img src="rptimages/lastdisab.gif" alt="Last" width="16" height="16" border="0"></td>
	<?php } else { ?>
	<td><a href="Solucion_Anticipadasmry.php?start=<?php echo $LastStart; ?>"><img src="rptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>
	<?php } ?>
...
<tr><td colspan="3" class="ewPadding"><div id="ewBottom" class="phpreportmaker">
	<!-- Bottom slot -->
<a name="cht_Solucion_Anticipada"></a>
<div id="div_Solucion_Anticipada">
<?php

// Initialize chart data
$Solucion_Anticipada_cht_id = "Solucion_Anticipada_Solucion_Anticipada"; // Chart ID
$Solucion_Anticipada_cht_parms .= "type=1,"; // Chart type
$Solucion_Anticipada_cht_parms .= "bgcolor=#FCFCFC,"; // Background color
$Solucion_Anticipada_cht_parms .= "caption=" . ew_Encode("Solucion Anticipada") . ","; // Chart caption
$Solucion_Anticipada_cht_parms .= "borderleftcolor=#808080,"; // Border left color
$Solucion_Anticipada_cht_parms .= "bordertopcolor=#808080,"; // Border top color
$Solucion_Anticipada_cht_parms .= "borderbottomcolor=#808080,"; // Border bottom color
$Solucion_Anticipada_cht_parms .= "borderrightcolor=#808080,"; // Border right color
$Solucion_Anticipada_cht_parms .= "chartbgcolor=#EEEEEE,"; // Chart background color
$Solucion_Anticipada_cht_parms .= "chartbordercolor=#A9A9A9,"; // Chart border color
$Solucion_Anticipada_cht_parms .= "numgridlines=3,"; // Number of grid lines
$Solucion_Anticipada_cht_parms .= "gridlinecolor=#DCDCDC,"; // Grid line color
$Solucion_Anticipada_cht_parms .= "xaxisname=" . ew_Encode("Solucionadas") . ","; // X axis name
$Solucion_Anticipada_cht_parms .= "xaxisnamerotated=0,"; // X axis name rotated
$Solucion_Anticipada_cht_parms .= "xaxisvaluemaxchar=20,"; // X axis value max char
$Solucion_Anticipada_cht_parms .= "yaxisname=" . ew_Encode("Total") . ","; // Y axis name
$Solucion_Anticipada_cht_parms .= "yaxisnamerotated=1,"; // Y axis name rotated
$Solucion_Anticipada_cht_parms .= "shownames=0,"; // Show names
$Solucion_Anticipada_cht_parms .= "showvalues=1,"; // Show values
$Solucion_Anticipada_cht_parms .= "showhover=1,"; // Show hover
$Solucion_Anticipada_cht_parms .= "alpha=50,"; // Chart alpha
$Solucion_Anticipada_cht_parms .= "colorpalette=#FF0000|#FF0080|#FF00FF|#8000FF|#FF8000|#FF3D3D|#7AFFFF|#0000FF|#FFFF00|#FF7A7A|#3DFFFF|#0080FF|#80FF00|#00FF00|#00FF80|#00FFFF,"; // Chart color palette
$Solucion_Anticipada_cht_parms .= "cssurl=rptcss/ewchart.css"; // Chart css
ew_SortChartData($Solucion_Anticipada_cht_smry, 0);
echo ew_ShowChart($Solucion_Anticipada_cht_id, $Solucion_Anticipada_cht_parms, $Solucion_Anticipada_cht_smry, 550, 440, "");
?>
</div>
<a href="#top">Top</a>
<br><br>
...
function GetRow($opt) {
	...
	while ($row) {
		if (ValidRow($row)) {
			...
			$val[5] = $GLOBALS["x_fecha_sol"];
			$GLOBALS["x_fechaestsol_asig"] = $row["fechaestsol_asig"];
			$val[6] = $GLOBALS["x_fechaestsol_asig"];
			break;
		} else {
			$rsidx++;
			$row = ($rsidx < $rscnt) ? $rs[$rsidx] : FALSE;
...
function ProcessChartData(&$rs) {
	AccumulateChartSummary($rs, $GLOBALS["Solucion_Anticipada_cht_smry"], $GLOBALS["Solucion_Anticipada_cht_XFld"], "", $GLOBALS["Solucion_Anticipada_cht_YFld"], 0, "", "SUM");
}
?>
<?php
