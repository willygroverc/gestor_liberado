...
// PHP Report Maker 1.0 - Table level configuration (ANS)
// Table Level Constants

define("EW_TABLE_VAR", "ANS", TRUE);
define("EW_TABLE_GROUP_PER_PAGE", "grpperpage", TRUE);
define("EW_TABLE_SESSION_GROUP_PER_PAGE", "ANS_grpperpage", TRUE);
define("EW_TABLE_START_GROUP", "start", TRUE);
define("EW_TABLE_SESSION_START_GROUP", "ANS_start", TRUE);
define("EW_TABLE_SESSION_SEARCH", "ANS_search", TRUE);
define("EW_TABLE_CHILD_USER_ID", "childuserid", TRUE);
define("EW_TABLE_SESSION_CHILD_USER_ID", "ANS_childuserid", TRUE);

// Table Level SQL
define("EW_TABLE_SQL_FROM", "nivservicio", TRUE);
$EW_TABLE_SQL_SELECT = "SELECT nivservicio.id_servi, nivservicio.tecnico, nivservicio.desc_ser, nivservicio.clie_ser, nivservicio.tiem_ser FROM " . EW_TABLE_SQL_FROM;
$EW_TABLE_SQL_WHERE = "";
...
$af_id_servi = NULL; // Advanced filter for id_servi
$af_tecnico = NULL; // Advanced filter for tecnico
$af_desc_ser = NULL; // Advanced filter for desc_ser
$af_clie_ser = NULL; // Advanced filter for clie_ser
$af_tiem_ser = NULL; // Advanced filter for tiem_ser
?>
<?php
...
// Detail variables
$x_id_servi = NULL; $ox_id_servi = NULL; $tx_id_servi = NULL; $ftx_id_servi = 3; $rf_id_servi = NULL; $rt_id_servi = NULL;
$x_tecnico = NULL; $ox_tecnico = NULL; $tx_tecnico = NULL; $ftx_tecnico = 200; $rf_tecnico = NULL; $rt_tecnico = NULL;
$x_desc_ser = NULL; $ox_desc_ser = NULL; $tx_desc_ser = NULL; $ftx_desc_ser = 200; $rf_desc_ser = NULL; $rt_desc_ser = NULL;
$x_clie_ser = NULL; $ox_clie_ser = NULL; $tx_clie_ser = NULL; $ftx_clie_ser = 200; $rf_clie_ser = NULL; $rt_clie_ser = NULL;
$x_tiem_ser = NULL; $ox_tiem_ser = NULL; $tx_tiem_ser = NULL; $ftx_tiem_ser = 200; $rf_tiem_ser = NULL; $rt_tiem_ser = NULL;
?>
<?php
...
ANS
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="ANSsmry.php?export=html">Imprimir</a>
&nbsp;&nbsp;<a href="ANSsmry.php?export=excel">Exportar a Excel</a>
&nbsp;&nbsp;<a href="ANSsmry.php?export=word">Exportar a Word</a>
<?php } ?>
<br><br>
<?php if (@$sExport == "") { ?>
</div></td></tr>
...
<?php if (@$sExport == "") { ?>
<form action="ANSsmry.php" name="ewpagerform" id="ewpagerform">
...
<!--first page button-->
	...
	<?php } else { ?>
	<td><a href="ANSsmry.php?start=1"><img src="rptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($PrevStart == $nStartGrp) { ?>
	<td><img src="rptimages/prevdisab.gif" alt="Previous" width="16" height="16" border="0"></td>
	<?php } else { ?>
	<td><a href="ANSsmry.php?start=<?php echo $PrevStart; ?>"><img src="rptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } ?>
<!--current page number-->
...
<!--next page button-->
	...
	<?php } else { ?>
	<td><a href="ANSsmry.php?start=<?php echo $NextStart; ?>"><img src="rptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>
	<?php  } ?>
<!--last page button-->
	<?php if ($LastStart == $nStartGrp) { ?>
	<td><img src="rptimages/lastdisab.gif" alt="Last" width="16" height="16" border="0"></td>
	<?php } else { ?>
	<td><a href="ANSsmry.php?start=<?php echo $LastStart; ?>"><img src="rptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>
	<?php } ?>
	...
	<span class="phpreportmaker"> <?php echo $nStartGrp; ?> to <?php echo $nStopGrp; ?> de <?php echo $nTotalGrps; ?></span>
<?php } else { ?>
...
function GetRow($opt) {
	...
	while ($row) {
		if (ValidRow($row)) {
			$GLOBALS["x_id_servi"] = $row["id_servi"];
			$val[1] = $GLOBALS["x_id_servi"];
			$GLOBALS["x_tecnico"] = $row["tecnico"];
			$val[2] = $GLOBALS["x_tecnico"];
			$GLOBALS["x_desc_ser"] = $row["desc_ser"];
			$val[3] = $GLOBALS["x_desc_ser"];
			$GLOBALS["x_clie_ser"] = $row["clie_ser"];
			$val[4] = $GLOBALS["x_clie_ser"];
			$GLOBALS["x_tiem_ser"] = $row["tiem_ser"];
			$val[5] = $GLOBALS["x_tiem_ser"];
			break;
		} else {
			$rsidx++;
			$row = ($rsidx < $rscnt) ? $rs[$rsidx] : FALSE;
