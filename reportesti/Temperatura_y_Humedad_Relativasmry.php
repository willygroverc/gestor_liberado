...
// PHP Report Maker 1.0 - Table level configuration (Temperatura y Humedad Relativa)
// Table Level Constants

define("EW_TABLE_VAR", "Temperatura_y_Humedad_Relativa", TRUE);
define("EW_TABLE_GROUP_PER_PAGE", "grpperpage", TRUE);
define("EW_TABLE_SESSION_GROUP_PER_PAGE", "Temperatura_y_Humedad_Relativa_grpperpage", TRUE);
define("EW_TABLE_START_GROUP", "start", TRUE);
define("EW_TABLE_SESSION_START_GROUP", "Temperatura_y_Humedad_Relativa_start", TRUE);
define("EW_TABLE_SESSION_SEARCH", "Temperatura_y_Humedad_Relativa_search", TRUE);
define("EW_TABLE_CHILD_USER_ID", "childuserid", TRUE);
define("EW_TABLE_SESSION_CHILD_USER_ID", "Temperatura_y_Humedad_Relativa_childuserid", TRUE);
...
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="Temperatura_y_Humedad_Relativasmry.php?export=html">Imprimir</a>
&nbsp;&nbsp;<a href="Temperatura_y_Humedad_Relativasmry.php?export=excel">Exportar a Excel</a>
&nbsp;&nbsp;<a href="Temperatura_y_Humedad_Relativasmry.php?export=word">Exportar a Word</a>
<?php } ?>
<br><br>
<?php if (@$sExport == "") { ?>
</div></td></tr>
...
<?php if (@$sExport == "") { ?>
<form action="Temperatura_y_Humedad_Relativasmry.php" name="ewpagerform" id="ewpagerform">
...
<!--first page button-->
	...
	<?php } else { ?>
	<td><a href="Temperatura_y_Humedad_Relativasmry.php?start=1"><img src="rptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($PrevStart == $nStartGrp) { ?>
	<td><img src="rptimages/prevdisab.gif" alt="Previous" width="16" height="16" border="0"></td>
	<?php } else { ?>
	<td><a href="Temperatura_y_Humedad_Relativasmry.php?start=<?php echo $PrevStart; ?>"><img src="rptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } ?>
<!--current page number-->
...
<!--next page button-->
	...
	<?php } else { ?>
	<td><a href="Temperatura_y_Humedad_Relativasmry.php?start=<?php echo $NextStart; ?>"><img src="rptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>
	<?php  } ?>
<!--last page button-->
	<?php if ($LastStart == $nStartGrp) { ?>
	<td><img src="rptimages/lastdisab.gif" alt="Last" width="16" height="16" border="0"></td>
	<?php } else { ?>
	<td><a href="Temperatura_y_Humedad_Relativasmry.php?start=<?php echo $LastStart; ?>"><img src="rptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>
	<?php } ?>
