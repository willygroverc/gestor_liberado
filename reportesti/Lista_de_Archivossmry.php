...
// PHP Report Maker 1.0 - Table level configuration (Lista de Archivos)
// Table Level Constants

define("EW_TABLE_VAR", "Lista_de_Archivos", TRUE);
define("EW_TABLE_GROUP_PER_PAGE", "grpperpage", TRUE);
define("EW_TABLE_SESSION_GROUP_PER_PAGE", "Lista_de_Archivos_grpperpage", TRUE);
define("EW_TABLE_START_GROUP", "start", TRUE);
define("EW_TABLE_SESSION_START_GROUP", "Lista_de_Archivos_start", TRUE);
define("EW_TABLE_SESSION_SEARCH", "Lista_de_Archivos_search", TRUE);
define("EW_TABLE_CHILD_USER_ID", "childuserid", TRUE);
define("EW_TABLE_SESSION_CHILD_USER_ID", "Lista_de_Archivos_childuserid", TRUE);

// Table Level SQL
define("EW_TABLE_SQL_FROM", "modulo RIGHT OUTER JOIN datos_archivos ON (modulo.id_mod = datos_archivos.id_mod) LEFT OUTER JOIN versiones ON (datos_archivos.id_arch = versiones.id_arch) LEFT OUTER JOIN asignacion_cvs ON (datos_archivos.id_arch = asignacion_cvs.id_arch)", TRUE);
$EW_TABLE_SQL_SELECT = "SELECT datos_archivos.id_arch, datos_archivos.fecha_modi, modulo.nombre_mod, modulo.desc_mod, versiones.nombre_arch, asignacion_cvs.login_resp FROM " . EW_TABLE_SQL_FROM;
$EW_TABLE_SQL_WHERE = "";
...
$af_id_arch = NULL; // Advanced filter for id_arch
$af_fecha_modi = NULL; // Advanced filter for fecha_modi
$af_nombre_mod = NULL; // Advanced filter for nombre_mod
$af_desc_mod = NULL; // Advanced filter for desc_mod
$af_nombre_arch = NULL; // Advanced filter for nombre_arch
$af_login_resp = NULL; // Advanced filter for login_resp
?>
<?php
...
// Detail variables
$x_id_arch = NULL; $ox_id_arch = NULL; $tx_id_arch = NULL; $ftx_id_arch = 3; $rf_id_arch = NULL; $rt_id_arch = NULL;
$x_fecha_modi = NULL; $ox_fecha_modi = NULL; $tx_fecha_modi = NULL; $ftx_fecha_modi = 133; $rf_fecha_modi = NULL; $rt_fecha_modi = NULL;
$x_nombre_mod = NULL; $ox_nombre_mod = NULL; $tx_nombre_mod = NULL; $ftx_nombre_mod = 201; $rf_nombre_mod = NULL; $rt_nombre_mod = NULL;
$x_desc_mod = NULL; $ox_desc_mod = NULL; $tx_desc_mod = NULL; $ftx_desc_mod = 201; $rf_desc_mod = NULL; $rt_desc_mod = NULL;
$x_nombre_arch = NULL; $ox_nombre_arch = NULL; $tx_nombre_arch = NULL; $ftx_nombre_arch = 200; $rf_nombre_arch = NULL; $rt_nombre_arch = NULL;
$x_login_resp = NULL; $ox_login_resp = NULL; $tx_login_resp = NULL; $ftx_login_resp = 200; $rf_login_resp = NULL; $rt_login_resp = NULL;
?>
<?php
...
Lista de Archivos
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="Lista_de_Archivossmry.php?export=html">Imprimir</a>
&nbsp;&nbsp;<a href="Lista_de_Archivossmry.php?export=excel">Exportar a Excel</a>
&nbsp;&nbsp;<a href="Lista_de_Archivossmry.php?export=word">Exportar a Word</a>
<?php } ?>
<br><br>
<?php if (@$sExport == "") { ?>
</div></td></tr>
...
<?php if (@$sExport == "") { ?>
<form action="Lista_de_Archivossmry.php" name="ewpagerform" id="ewpagerform">
...
<!--first page button-->
	...
	<?php } else { ?>
	<td><a href="Lista_de_Archivossmry.php?start=1"><img src="rptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($PrevStart == $nStartGrp) { ?>
	<td><img src="rptimages/prevdisab.gif" alt="Previous" width="16" height="16" border="0"></td>
	<?php } else { ?>
	<td><a href="Lista_de_Archivossmry.php?start=<?php echo $PrevStart; ?>"><img src="rptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } ?>
<!--current page number-->
...
<!--next page button-->
	...
	<?php } else { ?>
	<td><a href="Lista_de_Archivossmry.php?start=<?php echo $NextStart; ?>"><img src="rptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>
	<?php  } ?>
<!--last page button-->
	<?php if ($LastStart == $nStartGrp) { ?>
	<td><img src="rptimages/lastdisab.gif" alt="Last" width="16" height="16" border="0"></td>
	<?php } else { ?>
	<td><a href="Lista_de_Archivossmry.php?start=<?php echo $LastStart; ?>"><img src="rptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>
	<?php } ?>
...
<?php echo $x_id_arch ?>
		...
		<td class="ewRptDtlField">
<?php echo ew_FormatDateTime($x_fecha_modi,5) ?>
</td>
		<td class="ewRptDtlField">
<?php echo $x_nombre_mod ?>
</td>
		<td class="ewRptDtlField">
<?php echo str_replace(chr(10), "<br>", $x_desc_mod); ?>
</td>
		<td class="ewRptDtlField">
<?php echo $x_nombre_arch ?>
</td>
		<td class="ewRptDtlField">
<?php echo $x_login_resp ?>
</td>
	</tr>
<?php
...
function GetRow($opt) {
	...
	while ($row) {
		if (ValidRow($row)) {
			$GLOBALS["x_id_arch"] = $row["id_arch"];
			$val[1] = $GLOBALS["x_id_arch"];
			$GLOBALS["x_fecha_modi"] = $row["fecha_modi"];
			$val[2] = $GLOBALS["x_fecha_modi"];
			$GLOBALS["x_nombre_mod"] = $row["nombre_mod"];
			$val[3] = $GLOBALS["x_nombre_mod"];
			$GLOBALS["x_desc_mod"] = $row["desc_mod"];
			$val[4] = $GLOBALS["x_desc_mod"];
			$GLOBALS["x_nombre_arch"] = $row["nombre_arch"];
			$val[5] = $GLOBALS["x_nombre_arch"];
			$GLOBALS["x_login_resp"] = $row["login_resp"];
			$val[6] = $GLOBALS["x_login_resp"];
			break;
		} else {
			$rsidx++;
			$row = ($rsidx < $rscnt) ? $rs[$rsidx] : FALSE;
	...
	if (!$row) {
		$GLOBALS["x_id_arch"] = "";
		$GLOBALS["x_fecha_modi"] = "";
		$GLOBALS["x_nombre_mod"] = "";
		$GLOBALS["x_desc_mod"] = "";
		$GLOBALS["x_nombre_arch"] = "";
		$GLOBALS["x_login_resp"] = "";
	}
}
