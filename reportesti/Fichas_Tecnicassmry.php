...
// PHP Report Maker 1.0 - Table level configuration (Fichas Tecnicas)
// Table Level Constants

define("EW_TABLE_VAR", "Fichas_Tecnicas", TRUE);
define("EW_TABLE_GROUP_PER_PAGE", "grpperpage", TRUE);
define("EW_TABLE_SESSION_GROUP_PER_PAGE", "Fichas_Tecnicas_grpperpage", TRUE);
define("EW_TABLE_START_GROUP", "start", TRUE);
define("EW_TABLE_SESSION_START_GROUP", "Fichas_Tecnicas_start", TRUE);
define("EW_TABLE_SESSION_SEARCH", "Fichas_Tecnicas_search", TRUE);
define("EW_TABLE_CHILD_USER_ID", "childuserid", TRUE);
define("EW_TABLE_SESSION_CHILD_USER_ID", "Fichas_Tecnicas_childuserid", TRUE);

// Table Level SQL
define("EW_TABLE_SQL_FROM", "asigcustficha RIGHT OUTER JOIN datfichatec ON (asigcustficha.IdFicha = datfichatec.IdFicha)", TRUE);
$EW_TABLE_SQL_SELECT = "SELECT count(*) AS total, datfichatec.IdFicha, datfichatec.TpRegFicha, datfichatec.AdicUSI, datfichatec.CodActFijo, datfichatec.Marca, datfichatec.Modelo, asigcustficha.NombAsig, datfichatec.Proveedor FROM " . EW_TABLE_SQL_FROM;
$EW_TABLE_SQL_WHERE = "";
define("EW_TABLE_SQL_GROUPBY", "datfichatec.IdFicha, datfichatec.TpRegFicha, datfichatec.AdicUSI, datfichatec.CodActFijo, datfichatec.Marca, datfichatec.Modelo, asigcustficha.NombAsig, datfichatec.Proveedor", TRUE);
define("EW_TABLE_SQL_HAVING", "", TRUE);
define("EW_TABLE_SQL_ORDERBY", "datfichatec.TpRegFicha ASC", TRUE);
define("EW_TABLE_SQL_USERID_FILTER", "", TRUE);
$af_IdFicha = NULL; // Advanced filter for IdFicha
$af_TpRegFicha = NULL; // Advanced filter for TpRegFicha
$af_AdicUSI = NULL; // Advanced filter for AdicUSI
$af_CodActFijo = NULL; // Advanced filter for CodActFijo
$af_Marca = NULL; // Advanced filter for Marca
$af_Modelo = NULL; // Advanced filter for Modelo
$af_NombAsig = NULL; // Advanced filter for NombAsig
$af_Proveedor = NULL; // Advanced filter for Proveedor
?>
<?php
...
// Group variables
$x_TpRegFicha = NULL; $ox_TpRegFicha = NULL; $gx_TpRegFicha = NULL; $dgx_TpRegFicha = NULL; $tx_TpRegFicha = NULL; $ftx_TpRegFicha = 200; $gfx_TpRegFicha = $ftx_TpRegFicha; $gbx_TpRegFicha = ""; $gix_TpRegFicha = "0"; $rf_TpRegFicha = NULL; $rt_TpRegFicha = NULL;

// Detail variables
$x_IdFicha = NULL; $ox_IdFicha = NULL; $tx_IdFicha = NULL; $ftx_IdFicha = 3; $rf_IdFicha = NULL; $rt_IdFicha = NULL;
$x_AdicUSI = NULL; $ox_AdicUSI = NULL; $tx_AdicUSI = NULL; $ftx_AdicUSI = 200; $rf_AdicUSI = NULL; $rt_AdicUSI = NULL;
$x_CodActFijo = NULL; $ox_CodActFijo = NULL; $tx_CodActFijo = NULL; $ftx_CodActFijo = 200; $rf_CodActFijo = NULL; $rt_CodActFijo = NULL;
$x_Marca = NULL; $ox_Marca = NULL; $tx_Marca = NULL; $ftx_Marca = 200; $rf_Marca = NULL; $rt_Marca = NULL;
$x_Modelo = NULL; $ox_Modelo = NULL; $tx_Modelo = NULL; $ftx_Modelo = 200; $rf_Modelo = NULL; $rt_Modelo = NULL;
$x_NombAsig = NULL; $ox_NombAsig = NULL; $tx_NombAsig = NULL; $ftx_NombAsig = 200; $rf_NombAsig = NULL; $rt_NombAsig = NULL;
$x_Proveedor = NULL; $ox_Proveedor = NULL; $tx_Proveedor = NULL; $ftx_Proveedor = 200; $rf_Proveedor = NULL; $rt_Proveedor = NULL;
?>
<?php

// Chart configuration parameters
$Fichas_Tecnicas_cht_parms = NULL; // Store all chart parameters

// Chart data
$Fichas_Tecnicas_cht_index = NULL;
$Fichas_Tecnicas_cht_id = NULL;
$Fichas_Tecnicas_cht_smry = NULL;
$Fichas_Tecnicas_cht_XFld = NULL;
$Fichas_Tecnicas_cht_YFld = NULL;
$Fichas_Tecnicas_cht_YFldBase = NULL;
$Fichas_Tecnicas_cht_XFld = "TpRegFicha";
$Fichas_Tecnicas_cht_YFld = "total";
$Fichas_Tecnicas_cht_XDateFld = "";
?>
<?php
...
Fichas Tecnicas
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="Fichas_Tecnicassmry.php?export=html">Imprimir</a>
&nbsp;&nbsp;<a href="Fichas_Tecnicassmry.php?export=excel">Exportar a Excel</a>
&nbsp;&nbsp;<a href="Fichas_Tecnicassmry.php?export=word">Exportar a Word</a>
<?php } ?>
<br><br>
<?php if (@$sExport == "") { ?>
</div></td></tr>
...
<?php if (@$sExport == "") { ?>
<form action="Fichas_Tecnicassmry.php" name="ewpagerform" id="ewpagerform">
...
<!--first page button-->
	...
	<?php } else { ?>
	<td><a href="Fichas_Tecnicassmry.php?start=1"><img src="rptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($PrevStart == $nStartGrp) { ?>
	<td><img src="rptimages/prevdisab.gif" alt="Previous" width="16" height="16" border="0"></td>
	<?php } else { ?>
	<td><a href="Fichas_Tecnicassmry.php?start=<?php echo $PrevStart; ?>"><img src="rptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } ?>
<!--current page number-->
...
<!--next page button-->
	...
	<?php } else { ?>
	<td><a href="Fichas_Tecnicassmry.php?start=<?php echo $NextStart; ?>"><img src="rptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>
	<?php  } ?>
<!--last page button-->
	<?php if ($LastStart == $nStartGrp) { ?>
	<td><img src="rptimages/lastdisab.gif" alt="Last" width="16" height="16" border="0"></td>
	<?php } else { ?>
	<td><a href="Fichas_Tecnicassmry.php?start=<?php echo $LastStart; ?>"><img src="rptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>
	<?php } ?>
...
<?php if ($nTotalGrps > 0) { ?>
		<td nowrap>&nbsp;&nbsp;&nbsp;&nbsp;</td>
		<td align="right" valign="top" nowrap><span class="phpreportmaker">Grupos pro Pagina&nbsp;
...
<?php
	...
	if (intval($nGrpCount) >= intval($nStartGrp) && $nGrpCount <= $nStopGrp) {
		...
		// Show group values
		$dgx_TpRegFicha = $x_TpRegFicha;
		if (($x_TpRegFicha == NULL && $ox_TpRegFicha == NULL) ||
			(($x_TpRegFicha <> "" && $ox_TpRegFicha == $dgx_TpRegFicha) && !ChkLvlBreak(1))) {
			$dgx_TpRegFicha = "";
		} elseif ($x_TpRegFicha == NULL) {
			$dgx_TpRegFicha = EW_NULL_LABEL;
		} elseif ($x_TpRegFicha == "") {
			$dgx_TpRegFicha = EW_EMPTY_LABEL;
		}
?>
	<tr<?php echo $sItemRowClass; ?>>
		<td class="ewRptGrpField1">
		<?php $tx_TpRegFicha = $x_TpRegFicha; $x_TpRegFicha = $dgx_TpRegFicha; ?>
<?php echo $x_TpRegFicha ?>
		<?php $x_TpRegFicha = $tx_TpRegFicha; ?></td>
...
<?php if ($nTotalGrps > 0) { ?>
	...
	<tr class="ewRptGrandSummary"><td colspan="8">Total Registros (<?php echo ew_FormatNumber($cnt[0][0],0,-2,-2,-2); ?> Resgistros Detallados)</td></tr>
	<!--tr><td colspan="8"><span class="phpreportmaker">&nbsp;<br></span></td></tr-->
<?php } ?>
</table>
<!-- </form> -->
...
<tr><td colspan="3" class="ewPadding"><div id="ewBottom" class="phpreportmaker">
	<!-- Bottom slot -->
<a name="cht_Fichas_Tecnicas"></a>
<div id="div_Fichas_Tecnicas">
<?php

// Initialize chart data
$Fichas_Tecnicas_cht_id = "Fichas_Tecnicas_Fichas_Tecnicas"; // Chart ID
$Fichas_Tecnicas_cht_parms .= "type=2,"; // Chart type
$Fichas_Tecnicas_cht_parms .= "bgcolor=#FCFCFC,"; // Background color
$Fichas_Tecnicas_cht_parms .= "caption=" . ew_Encode("Fichas Tecnicas") . ","; // Chart caption
$Fichas_Tecnicas_cht_parms .= "borderleftcolor=#808080,"; // Border left color
$Fichas_Tecnicas_cht_parms .= "bordertopcolor=#808080,"; // Border top color
$Fichas_Tecnicas_cht_parms .= "borderbottomcolor=#808080,"; // Border bottom color
$Fichas_Tecnicas_cht_parms .= "borderrightcolor=#808080,"; // Border right color
$Fichas_Tecnicas_cht_parms .= "chartbgcolor=#EEEEEE,"; // Chart background color
$Fichas_Tecnicas_cht_parms .= "chartbordercolor=#A9A9A9,"; // Chart border color
$Fichas_Tecnicas_cht_parms .= "numgridlines=3,"; // Number of grid lines
$Fichas_Tecnicas_cht_parms .= "gridlinecolor=#DCDCDC,"; // Grid line color
$Fichas_Tecnicas_cht_parms .= "xaxisname=" . ew_Encode("Tipo de Registro") . ","; // X axis name
$Fichas_Tecnicas_cht_parms .= "xaxisnamerotated=0,"; // X axis name rotated
$Fichas_Tecnicas_cht_parms .= "xaxisvaluemaxchar=20,"; // X axis value max char
$Fichas_Tecnicas_cht_parms .= "yaxisname=" . ew_Encode("Total") . ","; // Y axis name
$Fichas_Tecnicas_cht_parms .= "yaxisnamerotated=1,"; // Y axis name rotated
$Fichas_Tecnicas_cht_parms .= "shownames=1,"; // Show names
$Fichas_Tecnicas_cht_parms .= "showvalues=1,"; // Show values
$Fichas_Tecnicas_cht_parms .= "showhover=1,"; // Show hover
$Fichas_Tecnicas_cht_parms .= "alpha=50,"; // Chart alpha
$Fichas_Tecnicas_cht_parms .= "colorpalette=#FFFF00|#FF9900|#003399|#0099FF|#339966|#FF3D3D|#7AFFFF|#0000FF|#FFFF00|#FF7A7A|#3DFFFF|#0080FF|#80FF00|#00FF00|#00FF80|#00FFFF,"; // Chart color palette
$Fichas_Tecnicas_cht_parms .= "cssurl=rptcss/ewchart.css"; // Chart css
ew_SortChartData($Fichas_Tecnicas_cht_smry, 0);
echo ew_ShowChart($Fichas_Tecnicas_cht_id, $Fichas_Tecnicas_cht_parms, $Fichas_Tecnicas_cht_smry, 550, 440, "");
?>
</div>
<a href="#top">Top</a>
<br><br>
...
function ChkLvlBreak($lvl) {
	switch ($lvl) {
		case 1:
			return ($GLOBALS["x_TpRegFicha"] == NULL && $GLOBALS["ox_TpRegFicha"] != NULL) ||
				($GLOBALS["x_TpRegFicha"] !== NULL && $GLOBALS["ox_TpRegFicha"] == NULL) ||
				($GLOBALS["x_TpRegFicha"] <> $GLOBALS["ox_TpRegFicha"]);
	}
}
...
function ResetLevelSummary($lvl) {
	...
	// Clear old values
	if ($lvl <= 1) $GLOBALS["ox_TpRegFicha"] = "";
...
function GetRow($opt) {
	...
	while ($row) {
		if (ValidRow($row)) {
			$GLOBALS["x_TpRegFicha"] = $row["TpRegFicha"];
			$GLOBALS["x_IdFicha"] = $row["IdFicha"];
			$val[1] = $GLOBALS["x_IdFicha"];
			$GLOBALS["x_AdicUSI"] = $row["AdicUSI"];
			$val[2] = $GLOBALS["x_AdicUSI"];
			$GLOBALS["x_CodActFijo"] = $row["CodActFijo"];
			$val[3] = $GLOBALS["x_CodActFijo"];
			$GLOBALS["x_Marca"] = $row["Marca"];
			$val[4] = $GLOBALS["x_Marca"];
			$GLOBALS["x_Modelo"] = $row["Modelo"];
			$val[5] = $GLOBALS["x_Modelo"];
			$GLOBALS["x_NombAsig"] = $row["NombAsig"];
			$val[6] = $GLOBALS["x_NombAsig"];
			$GLOBALS["x_Proveedor"] = $row["Proveedor"];
			$val[7] = $GLOBALS["x_Proveedor"];
			break;
		} else {
			$rsidx++;
			$row = ($rsidx < $rscnt) ? $rs[$rsidx] : FALSE;
...
function InitReportData(&$rs) {
	...
	foreach ($rs as $row) {
		...
		// Update group count
		if ($bValidRow) {
			$x_TpRegFicha = $row["TpRegFicha"];
			$gx_TpRegFicha = $x_TpRegFicha;
			$bNewGroup = ($grpcnt == 0) ||
				($grpvalue == NULL && $x_TpRegFicha != NULL) ||
				($grpvalue != NULL && $x_TpRegFicha == NULL) ||
				(@$grpvalue <> $gx_TpRegFicha);
			if ($bNewGroup) {
				$grpvalue = $gx_TpRegFicha;
				$grpcnt++;
			}
...
function ProcessChartData(&$rs) {
	AccumulateChartSummary($rs, $GLOBALS["Fichas_Tecnicas_cht_smry"], $GLOBALS["Fichas_Tecnicas_cht_XFld"], "", $GLOBALS["Fichas_Tecnicas_cht_YFld"], 0, "", "SUM");
}
?>
<?php
