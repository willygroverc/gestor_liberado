...
$fechahoy = date('Y-m-d');
if ($_SESSION['tipo']=='A'){
	$sql_ordenes="SELECT DISTINCT(o.asig), o.fecha, o.time, o.cod_usr, o.desc_inc, o.tipo, o.nomb_archivo, o.area, o.dominio, o.objetivo, o.ci_ruc, o.id_anidacion, o.origen, o.hash_archivo, o.observaciones,
