...
session_start();
if (!isset($GUARDAR)) unset($_SESSION['id_pruInsert']);
if (isset($SALIR)){header("location: lista_pruebrecup.php");}
if (isset($RESINT)){@header("location: pruebrecup1.php?id_pru=$id_pru");}
if (isset($RESEXT)){header("location: pruebrecup2.php?id_pru=$id_pru");}
if (isset($HDWREQ)){header("location: pruebrecup3.php?id_pru=$id_pru");}
if (isset($INSBD)){header("location: pruebrecup4.php?id_pru=$id_pru");}
if (isset($INSSB)){header("location: pruebrecup5.php?id_pru=$id_pru");}
if (isset($INSAPLI)){header("location: pruebrecup6.php?id_pru=$id_pru");}
if (isset($RESTBD)){header("location: pruebrecup7.php?id_pru=$id_pru");}
if (isset($PRUINT)){header("location: pruebrecup8.php?id_pru=$id_pru");}
if (isset($PRUURS)){header("location: pruebrecup9.php?id_pru=$id_pru");}
...
if (isset($GUARDAR)) {
    ...
    if ((isset($execute) && $execute<=0) || !isset($validateDoit)) {
		$recordDb=$record;
...
<table border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#006699" bgcolor="#EAEAEA" background="images/fondo.jpg">   
  ...
  <table width="100%" border="2" align="center" background="images/fondo.jpg">
    ...
    <tr align="center"> 
      ...
      <td nowrap height="48"><div align="center">&nbsp;<?php if (isset($listPrueba[0]["fecpru"])) echo substr($listPrueba[0]['fecpru'],8,2)."/".substr($listPrueba[0]['fecpru'],5,2)."/".substr($listPrueba[0]['fecpru'],0,4);?></div></td>
      <td nowrap height="48"><div align="center">&nbsp;<?php if (isset($listPrueba['serpro']))echo $listPrueba['serpro'];?></div></td>
      <td nowrap><div align="center">&nbsp;<?php if (isset($listPrueba['sitconti'])) echo $listPrueba['sitconti'];?></div></td>
  ...
  <table border="2" align="center"  background="images/fondo.jpg">
    ...
    <tr> 
      ...
      <td align="center" ><strong> 
        <input name="serpro" type="text" value="<?php if (isset($recordDb['serpro'])) echo $recordDb['serpro'];?>" size="20" maxlength="70">
        </strong></td>
      <td align="center" ><strong> 
        <input name="sitconti" type="text" value="<?php if (isset($recordDb['sitconti']))echo $recordDb['sitconti'];?>" size="20" maxlength="70">
        </strong></td>
    </tr>
    <tr> 
      <td width="20%" bgcolor="#006699"> <div align="center"><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">Nombre 
