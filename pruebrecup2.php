...
$listCombo = array("-1" => "Nuevo Responsables Externos", "-2" => "Nuevo Proveedor");
$formType = "INSSB000";
$typeRespAct = 2;
$listResAct = $listCombo;//$list -> GetNumberType($id_pru, $typeRespAct, $listCombo);
$listUser = $list -> GetTable3();
...
<table width="100%" border="2" align="center" background="./images/fondo.jpg">
  <td colspan="8" bgcolor="#006699" > <div align="center"> 
        <p><font size="1" face="Arial, Helvetica, sans-serif" color="#FFFFFF"><strong><font size="3"> 
          Comunicacion a Responsable Externos</font></strong></font></p>
    </div></td>
  </tr>
  <tr> 
...
if (sizeof($listPrueba) > 0) {
    foreach ($listPrueba as $k => $v) {
        ...
        print "<td align=\"center\">" . $v["resact"] . " " . $v["tipo2"] . "</td>";
...
<form method="post" name="form1" action="<?php print $PHP_SELF;?>" onKeyPress="return Form()">
  <table width="100%" border="2" align="center" background="./images/fondo.jpg">
    ...
    <tr> 
      <td width="30%" align="center"><select name="resact" id="resact">
	  <?php
if (sizeof($listResAct) > 0) {
    foreach ($listResAct as $k => $v) {
        print "<option value=\"$k\"";
        if ($k == $recordDb[id_pruresin]) print "selected";
        print ">$v</option>";
    } 
} 
...
?></textarea></td>
    ...
    <tr> 
      ...
      <input name="<?php print "$formType" ?>" type="hidden" id="action" value="1">
