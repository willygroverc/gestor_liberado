...
//Función para habilitar colores
 lck=0;
	function r(hval)
    {
        if ( lck == 0 )
...
<center>
	...
	if ($row2['tipo2_usr']=="T" OR $row2['tipo2_usr']=="A" OR $row2['tipo2_usr']=="B"){
		...
		echo '<td width="21%" align="left"><font color="#FFFFFF" size="1"><b>Pendientes de solución: '.$nosolu.'</b></font></td>';
		...
		if ($row2['tipo2_usr']=="T")
			echo '<td width="33%"align="left"><font color="#FFFFFF" size="1"><b>Pendientes de conformidad del técnico: '.$noconftec.'</b></font></td>';
	}
	else{
		echo '<td width="20%" align="left"><font color="#FFFFFF" size="1"><b>Usuario: '.$row2['login_usr'].'</b></font></td>';
		echo '<td width="40%" align="left"><font color="#FFFFFF" size="1"><b>Ordenes de trabajo pendientes de solución: '.$nosolu.'</b></font></td>';
		...
		<td width="747" valign="top">
			<table width="100%" border="0" cellpadding="0" cellspacing="0" background="images/bannerTI.jpg">
				<tr>
					...
					<td colspan="2" rowspan="2" align="center" valign="middle"><span class="Estilo5 Estilo1">Gestor F1 </span></td>
					<td width="354"></td>
				...
				<tr>
					<td height="22"></td>
					<td width="13"></td>
					<td width="134" valign="top"><span class="Estilo3"> Gestor TI </span></td>
					<td></td>
					<td></td>
					<td></td>
				</tr>
