...
{	require("conexion.php");
	...
	$sql3="UPDATE vacaciones SET Nombre='$Nombre',estado='Planificado',fecha_del='$fecha_del',fecha_al='$fecha_al', ausencia='$ausencia' WHERE id_vacac='$var1'";
/*/	$sql3="INSERT INTO ".
	"vacaciones (id_vacac,Nombre,estado,fecha_del,fecha_al) ".
	"VALUES ('$var1','$Nombre','Planificado','$fecha_del','$fecha_al')";//*/
//	echo $sql3;
	mysql_query($sql3);
	$var1=$var1+1;
...
<table border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#006699" bgcolor="#EAEAEA"  background="images/fondo.jpg">  
	...
	<input name="var1" type="hidden" value="<?php echo $_REQUEST['id_vacac'];?>">
	<tr> 
      <td>
        <table border="2" align="center" cellpadding="2" cellspacing="4">
          <tr bgcolor="#006699"> 
            <td colspan="18"><div align="center"><font size="3" face="Arial, Helvetica, sans-serif" color="#FFFFFF"><strong> 
                CALENDARIZACION DE AUSENCIA PROGRAMADA</strong></font></div></td>
          </tr>
          <tr bgcolor="#006699"> 
            <th width="53" rowspan="2" nowrap><div align="center"><font color="#FFFFFF" size="1" face="Arial, Helvetica, sans-serif">Nombre</font></div></th>
            <th width="40" rowspan="2" nowrap><div align="center"><font color="#FFFFFF" size="1" face="Arial, Helvetica, sans-serif">Estado</font></div></th>
            <th height="17" colspan="4" nowrap>
<div align="center"><font color="#FFFFFF" size="1" face="Arial, Helvetica, sans-serif">Cuatrimestre1</font></div></th>
            <th colspan="4" nowrap><div align="center"><font color="#FFFFFF" size="1" face="Arial, Helvetica, sans-serif">Cuatrimestre2</font></div></th>
            <th colspan="4" nowrap><div align="center"><font color="#FFFFFF" size="1" face="Arial, Helvetica, sans-serif">Cuatrimestre3</font></div></th>
		<th width="129" colspan="4" rowspan="2" nowrap><div align="center"><font color="#FFFFFF" size="1" face="Arial, Helvetica, sans-serif">AUSENCIA</font></div></th>
		  </tr>
          <tr bgcolor="#006699"> 
            <th nowrap  id="1" width="23"><div align="center"><font color="#FFFFFF" size="1" face="Arial, Helvetica, sans-serif">Ene</font></div></th>
            <th nowrap id="2" width="23"><div align="center"><font color="#FFFFFF" size="1" face="Arial, Helvetica, sans-serif">Feb</font></div></th>
            <th nowrap id="3" width="23"><div align="center"><font color="#FFFFFF" size="1" face="Arial, Helvetica, sans-serif">Mar</font></div></th>
            <th nowrap id="4" width="23"><div align="center"><font color="#FFFFFF" size="1" face="Arial, Helvetica, sans-serif">Abr</font></div></th>
            <th nowrap id="5" width="29"><div align="center"><font color="#FFFFFF" size="1" face="Arial, Helvetica, sans-serif">May</font></div></th>
            <th nowrap id="6" width="23"><div align="center"><font color="#FFFFFF" size="1" face="Arial, Helvetica, sans-serif">Jun</font></div></th>
            <th nowrap id="7" width="23"><div align="center"><font color="#FFFFFF" size="1" face="Arial, Helvetica, sans-serif">Jul</font></div></th>
            <th nowrap id="8" width="18"><div align="center"><font color="#FFFFFF" size="1" face="Arial, Helvetica, sans-serif">Ago</font></div></th>
            <th nowrap id="9" width="28"><div align="center"><font color="#FFFFFF" size="1" face="Arial, Helvetica, sans-serif">Sept</font></div></th>
            <th nowrap id="10" width="31"><div align="center"><font color="#FFFFFF" size="1" face="Arial, Helvetica, sans-serif">Oct</font></div></th>
            <th nowrap id="11" width="32"><div align="center"><font color="#FFFFFF" size="1" face="Arial, Helvetica, sans-serif">Nov</font></div></th>
            <th nowrap id="12" width="26"><div align="center"><font color="#FFFFFF" size="1" face="Arial, Helvetica, sans-serif">Dic</font></div></th>
          </tr>
          <?php $id_vacac=$_REQUEST['id_vacac'];
                $Nombre=$_REQUEST['Nombre'];
		$sql = "SELECT * FROM vacaciones where id_vacac='$id_vacac' AND Nombre='$Nombre'";
          ...
          <tr> 
            <td width="53"  nowrap align="center"><strong> 
			  ...
			  while ($row = mysql_fetch_array($result)){
				...
				if($row['login_usr']==$Nombre) echo " selected";
				echo '> '.$row['apa_usr'].' '.$row['ama_usr'].' '.$row['nom_usr'].'</option>';
				}
			  ?>
              </select>
			  </strong></td>
            <td width="40" nowrap align="center">Planificado</td>
...
//				$m1=substr($fsist,5,2);
	...
	//			$d1=substr($fsist,8,2);
          ...
          <tr> 
            <td colspan="14" nowrap> <div align="center"><br>
                <table width="75%" border="0">
                  <tr> 
                    <td align="center"><input name="reg_form" type="submit" id="reg_form3" value="MODIFICAR" <?php print $valid->onSubmit() ?>></td>
