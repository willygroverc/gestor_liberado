...
$typeRespAct = 5;
$c = 0;
$sql = "SELECT distinct (Id_Tipo) as Id_Tipo FROM sistemas ORDER BY Id_Sistema";
$res = mysql_db_query($db, $sql, $link);
while ($row = mysql_fetch_array($res))
{	$listResAct[$row[Id_Tipo]] = $row[Id_Tipo];
	$medios[$c] = $row[Id_Tipo];
	$c++;
}
for ($i=0; $i<count($listResAct); $i++)
{	$medio = $medios[$i]; 
	$sql = "SELECT Id_Sistema, Descripcion as Id_Tipo FROM sistemas WHERE Id_Tipo = '$medio' ORDER BY Id_Tipo";
	$res = mysql_db_query($db, $sql, $link);	
	...
	{	$mat[$i][$j] = $fila[Id_Tipo]."*".$fila[Id_Sistema];
		$j++;
	}
}
$lon = count($mat);
...
<table width="100%" border="2" align="center" background="./images/fondo.jpg">
  <td colspan="8" bgcolor="#006699" > <div align="center"> 
        <p><font size="1" face="Arial, Helvetica, sans-serif" color="#FFFFFF"><strong><font size="3"> 
          Instalacion de Software Base</font></strong></font></p>
    </div></td>
  </tr>
  <tr> 
...
?>
        ...
        <font color="#FFFFFF" size="1" face="Arial, Helvetica, sans-serif"><strong><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong><font color="#FFFFFF" size="1" face="Arial, Helvetica, sans-serif"><strong><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong><font size="2" face="Arial, Helvetica, sans-serif"><a href="javascript:cal.popup();"><img src="images/cal.gif" width="16" height="16" border="0" alt="Haga click para seleccionar una fecha"></a></font></strong></font></strong></font></strong></font><font size="2" face="Arial, Helvetica, sans-serif"></font></strong></font></strong></font></strong></font> 
        </strong></td>
