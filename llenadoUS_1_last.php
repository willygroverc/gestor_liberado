...
if (isset($GUARDAR1)){
  ...
  $sql = "UPDATE solicitud SET Fecha='$Fecha1',Hora='$Hora',AsignA='$AsignA',Viabilidad='$Viabilidad',Tiempo='$Tiempo',Tiempo1='$Tiempo1',CostoI='$Costo10',MonedaI='$Costo11',
		  CostoII='$Costo20',MonedaII='$Costo21',Prioridad='$Prioridad',FechEstEnt='$Fcha2',Aceptac='$Aceptac',FechAcep='$Fecha3' WHERE OrdAyuda='$var'";
  mysql_query($sql);
  header("location: llenadoUS_2_last.php?var=$var");
} 
include("top.php");
$OrdAyuda=($_GET['var']);
$sql = "SELECT *, DATE_FORMAT(Fecha, '%d/%m/%Y') AS Fecha FROM solicitud WHERE OrdAyuda='$var'";
...
$valid->addCompareDates  ( "dia1", "mes1", "ano1", "dia2", "mes2", "ano2", "Fecha De Recepcion y Fecha de Entrega, $errorMsgJs[compareDates]" );
$valid->addCompareDates  ( "dia1", "mes1", "ano1", "dia3", "mes3", "ano3", "Fecha De Recepcion y Fecha de Asignacion, $errorMsgJs[compareDates]" );
...
<form name="form1" method="post" action="">
  ...
  <table width="90%" border="1" align="center" cellpadding="0" cellspacing="0" bgcolor="#006699">
    <tr> 
      <td><div align="center"><font color="#FFFFFF" size="3" face="Arial, Helvetica, sans-serif"><strong>LLENADO 
  ...
  <table width="90%" border="1" align="center" cellpadding="0" cellspacing="0" background="images/fondo.jpg">
          ...
          <tr> 
            <td width="64%" height="32"><font size="2" face="Arial, Helvetica, sans-serif">Fecha 
              ...
              <select name="dia1" id="dia1" >
                <?php
				if(!isset($row['FechEstEnt']))
					$row['FechEstEnt']=date("Y-m-d");				
          ...
          <tr> 
            <td width="64%"><font size="2" face="Arial, Helvetica, sans-serif">Asignado 
              ...
              <select name="AsignA">
                ...
                <?php 
			  $sql2 = "SELECT * FROM users WHERE tipo2_usr='T' ORDER BY apa_usr ASC";
	...
	<tr>
	  <td><div align="center"><br>
          <input name="GUARDAR1" type="submit" id="GUARDAR1" value="GUARDAR Y CONTINUAR">
		  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
