      ...
      <td > 
        <table width="100%" border="2" align="center" cellpadding="2" cellspacing="0" background="images/fondo.jpg">
          ...
          <tr> 
            ...
            <th width="175" nowrap bgcolor="#006699"><font size="2" face="Arial, Helvetica, sans-serif" color="#FFFFFF">CARGO</font></th>
          </tr>
          <?php
		$cont=0;	
		...
		<?php	$sql5 = "SELECT * FROM users WHERE login_usr='$row[nombre]'";
		 ...
		 ?>
          ...
          <tr> 
            <td width="40" height="7" nowrap bgcolor="#006699">
<div align="center"><strong><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">Nuevo</font></strong></div></td>
            ...
            <td width="175" nowrap height="7"><div align="center"><strong> </strong> 
              </div></td>
          </tr>
          <tr> 
