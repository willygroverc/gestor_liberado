...
{   include("conexion.php");
	...
	$sql="INSERT INTO ".
	"soliccambiocierre (Codigo,Responsabilid,Actividades,Aprobacion,Observac,Fecha_cier,Hora_cier,Fecha_del,Fecha_al) ".
  ...
  <form name="form2" method="post" onKeyPress="return Form()">
	...
	<tr> 
      <td> 
        <table width="100%" border="1" cellpadding="0" cellspacing="0" bgcolor="#006699">
          <tr> 
            <td><div align="center"><font color="#FFFFFF" size="3" face="Arial, Helvetica, sans-serif"><strong>CAMBIO 
                EN PRODUCCION- FASE DE CIERRE</strong></font></div></td>
          </tr>
        </table>
        <table width="100%" cellspacing="0" cellpadding="0">
          <tr> 
            <td width="10%"><font color="#000000" size="2" face="Arial, Helvetica, sans-serif">&nbsp;&nbsp;&nbsp;<strong>Orden 
              Nro. :</strong> </font></td>
            <td width="90%"><font color="#000000" size="2" face="Arial, Helvetica, sans-serif"><?php echo $id_orden;?></font></td>
          </tr>
        </table>
        <table width="100%" cellspacing="0" cellpadding="0">
          <tr> 
            <td width="14%" valign="top"><font color="#000000" size="2" face="Arial, Helvetica, sans-serif">&nbsp;&nbsp;&nbsp;<strong>Requerimiento 
              :</strong> </font></td>
            <td width="86%" valign="top"><font color="#000000" size="2" face="Arial, Helvetica, sans-serif"> 
              <?php 
        ...
        <table width="100%" cellspacing="0" cellpadding="0">
          <tr> 
            <td width="19%" valign="top"><font size="2" face="Arial, Helvetica, sans-serif">&nbsp;&nbsp;&nbsp;<strong>Descripcion 
              del Cambio :</strong> </font></td>
            <td width="81%" valign="top"><font size="2" face="Arial, Helvetica, sans-serif"><?php echo $row0['DescProyecto'];?></font></td>
          </tr>
        </table>
        <br>
        <table width="100%" border="1" align="center" cellpadding="1" cellspacing="2" background="images/fondo.jpg">
          <tr> 
            ...
            <th width="215" rowspan="2" nowrap bgcolor="#006699"><p><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">CIERRE</font><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif"><br>
                </font></p></th>
            ...
            <th width="192" rowspan="2" nowrap bgcolor="#006699"><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">ENTRE FECHAS</font></th>
          </tr>
          <tr> 
            <th width="43" height="25" nowrap bgcolor="#006699"><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">SI</font></th>
            <th width="39" nowrap bgcolor="#006699"><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">NO</font></th>
            <th nowrap bgcolor="#006699"><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">OBSERVACIONES</font></th>
          </tr>
          <?php
			
		$sql = "SELECT *,DATE_FORMAT(Fecha_del, '%d/%m/%Y') AS Fecha_del,DATE_FORMAT(Fecha_al, '%d/%m/%Y') AS Fecha_al FROM soliccambiocierre WHERE Codigo='$id_orden' ORDER BY Responsabilid ASC";
          ...
          <tr> 
            <td height="7" nowrap><div align="center"><strong> </strong><strong> 
                ...
                <select name="Responsabilid">
                  <?php 
			  $sql = "SELECT * FROM soliccambiocontrol WHERE Codigo='$id_orden' AND Aprobacion='SI' ORDER BY IdProyPlanif ASC";
			  $result = mysql_db_query($db,$sql,$link);
			  while ($row = mysql_fetch_array($result)) 
			  {
				$sql2 = "SELECT * FROM soliccambiocierre WHERE Codigo='$id_orden' AND Responsabilid='$row[Responsabilid]'";
				$result2 = mysql_db_query($db,$sql2,$link);
			  	$row2 = mysql_fetch_array($result2); 
				if (!$row2['Responsabilid'])
				{
					$sql_resp="SELECT Responsabilid FROM soliccambioplanif WHERE Codigo='$id_orden' AND IdProyPlanif='$row[Responsabilid]'";
					$row_resp=mysql_fetch_array(mysql_db_query($db,$sql_resp,$link));
					echo "<option value=\"$row[Responsabilid]\">";
				 	if(strlen($row_resp['Responsabilid'])>35) {echo substr($row_resp['Responsabilid'],0,35)."....";} else{ echo $row_resp['Responsabilid'];}
				 	echo "</option>";
				}
	          }
			  ?>
            ...
            <td width="185" height="7" nowrap><div align="center"> 
            ...
            <td width="192" nowrap><div align="center"> 
