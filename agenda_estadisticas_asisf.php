...
<?php
$sql_tot="SELECT count(*) AS total_reunion FROM agenda WHERE en_fecha BETWEEN '$fec1' AND '$fec2'";
...
<table width="60%" border="1" align="center"  background="images/fondo.jpg">
  <tr> 
    <td width="455"> <table border="1" cellpadding="0" cellspacing="0" width="100%">
		...
		<?php
		$sql="SELECT count(*) AS numero, i.nombre FROM invitados i,agenda a WHERE a.id_agenda=i.id_agenda AND i.Tipo='Interno' AND a.en_fecha BETWEEN '$fec1' AND '$fec2' GROUP BY nombre";
