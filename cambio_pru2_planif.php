...
?>  
  ...
  <table width="95%" border="2" align="center" cellpadding="2" cellspacing="0" background="images/fondo.jpg">
    ...
    <tr> 
      <th nowrap bgcolor="#006699"><font color="#FFFFFF" size="1" face="Arial, Helvetica, sans-serif">N&ordf;</font></th>
      <th width="336" nowrap bgcolor="#006699"><font color="#FFFFFF" size="1" face="Arial, Helvetica, sans-serif">DESCRIPCION 
        DE LA PRUEBA</font></th>
      <th width="212" nowrap bgcolor="#006699"><font color="#FFFFFF" size="1" face="Arial, Helvetica, sans-serif">TIEMPO 
        ESTIMADO (Minutos)</font></th>
      <th nowrap bgcolor="#006699"><font size="1" face="Arial, Helvetica, sans-serif" color="#FFFFFF">OBSERVACIONES</font></th>
    </tr>
    <?php
		$cont=0;	
    ...
    <tr> 
      <td width="44" height="7" nowrap bgcolor="#006699"> <div align="center"><strong><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">Nuevo</font> 
          </strong></div></td>
      <td nowrap><div align="center"><strong> 
          <textarea name="desc_pru" cols="40"></textarea>
          </strong></div></td>
      <td nowrap><div align="center"><strong> 
          <input name="tiem_est" type="text" size="20" maxlength="20">
          Min. </strong></div></td>
      <td width="307" height="7" nowrap><div align="center"><strong> 
          <textarea name="obs_pru" cols="40"></textarea>
          </strong></div></td>
    </tr>
    <tr> 
