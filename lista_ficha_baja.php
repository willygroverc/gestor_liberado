...
if (isset($RETORNAR)){header("location: lista1_ficha.php?Naveg=Soporte Tecnico");}
...
<form name="form1" method="post" action="" onKeyPress="return Form()">
  <table width="80%" align="center">
    <tr>
      <td bgcolor="#006699"><div align="center"><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif"><strong>Busqueda 
          ...
          &nbsp;&nbsp;&nbsp; 
          <input name="busqueda" type="text" size="40" value="<?php if (isset($busqueda))echo trim($busqueda);?>"> &nbsp;&nbsp;&nbsp;&nbsp; 
  ...
  <tr> 
      <td height="68" valign="top"> 
        ...
        <tr> 
          <th width="30" rowspan="1" align="\&quot;center\&quot;" bgcolor="#006699"><font face="Arial, Helvetica, sans-serif" color="#FFFFFF" size="1">N° 
            FICHA</font></th>
          <th width="64" rowspan="1" align="\&quot;center\&quot;" bgcolor="#006699"><font face="Arial, Helvetica, sans-serif" color="#FFFFFF" size="1">FECHA REALIZACION</font></th>
          <th width="90" rowspan="1" bgcolor="#006699"><div align="center"><font face="Arial, Helvetica, sans-serif" color="#FFFFFF" size="1">TIPO REGISTRO</font></div></th>
          <th width="70" rowspan="1" align="\&quot;center\&quot;" bgcolor="#006699"><font face="Arial, Helvetica, sans-serif" color="#FFFFFF" size="1">CODIGO 
              ACTIVO FIJO</font></th>
          <th width="70" rowspan="1" align="\&quot;center\&quot;" bgcolor="#006699"><font face="Arial, Helvetica, sans-serif" color="#FFFFFF" size="1">CODIGO 
              ADICIONAL</font></th>
          <th width="68" rowspan="1" align="\&quot;center\&quot;" bgcolor="#006699"><font face="Arial, Helvetica, sans-serif" color="#FFFFFF" size="1">MODELO</font></th>
          <th width="82" rowspan="1" align="\&quot;center\&quot;" bgcolor="#006699"><font face="Arial, Helvetica, sans-serif" color="#FFFFFF" size="1">ASIGNADO 
            A </font></th>
        </tr>
...
if (isset($hqt) && $hqt=="1" && !isset($BUSCAR))
{	$hqt1="0";
...
if ($_pagi_actual != 1)
{
	...
	if ($hqt=="1" and $hqt1=="1")
	{$_pagi_navegacion .= "<a href='lista_ficha_baja.php?pg=".$_pagi_url."&hqt=".$hqt."&campo=".$campo."&busqueda=".$busqueda."'>&laquo; Anterior</a>&nbsp;";}
	else
	{$_pagi_navegacion .= "<a href='lista_ficha_baja.php?pg=".$_pagi_url."&hqt=".$hqt."&campo=".$campo1."&busqueda=".$busqueda1."'>&laquo; Anterior</a>&nbsp;";}
}
...
for ($_pagi_i = 1; $_pagi_i<=$_pagi_totalPags; $_pagi_i++){//Desde página 1 hasta ultima página ($_pagi_totalPags)
    if ($_pagi_i == $_pagi_actual) {
     ...
     if ($hqt=="1" and $hqt1=="1")  
	    {$_pagi_navegacion .= "<a href='lista_ficha_baja.php?pg=".$_pagi_i."&hqt=".$hqt."&campo=".$campo."&busqueda=".$busqueda."'>".$_pagi_i."</a>&nbsp;";}
     else
	    {$_pagi_navegacion .= "<a href='lista_ficha_baja.php?pg=".$_pagi_i."&hqt=".$hqt."&campo=".$campo1."&busqueda=".$busqueda1."'>".$_pagi_i."</a>&nbsp;";}
	}
}
...
if ($_pagi_actual < $_pagi_totalPags){
    ...
    $_pagi_url = $_pagi_actual + 1;//será el numero de página al que enlazamos
    if ($hqt=="1" and $hqt1=="1")
	 {$_pagi_navegacion .="<a href='lista_ficha_baja.php?pg=".$_pagi_url."&hqt=".$hqt."&campo=".$campo."&busqueda=".$busqueda."'>Siguiente &raquo;</a>";}
	else
  	 {$_pagi_navegacion .="<a href='lista_ficha_baja.php?pg=".$_pagi_url."&hqt=".$hqt."&campo=".$campo1."&busqueda=".$busqueda1."'>Siguiente &raquo;</a>";}
}
...
<div align="left"><a href="lista_ficha.php">&lt;&lt;&lt; Ver Fichas Normales</a> 
</div><!--
