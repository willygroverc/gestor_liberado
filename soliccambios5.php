...
{   include("conexion.php");
	...
	$sql="INSERT INTO ".
	"soliccambiocontrol (Codigo,Responsabilid,Actividades,Aprobacion,Observac,Fecha_cont,Hora_cont,Fecha_del,Fecha_al) ".
	...
	<tr> 
      <td> 
        <table width="100%" border="1" cellpadding="0" cellspacing="0" bgcolor="#006699">
          <tr> 
            <td><div align="center"><font color="#FFFFFF" size="3" face="Arial, Helvetica, sans-serif"><strong>CAMBIO 
                EN PRODUCCION - FASE DE CONTROL</strong></font></div></td>
          </tr>
        </table>
        ...
        <table width="100%" border="1" align="center" cellpadding="1" cellspacing="2" background="images/fondo.jpg">
          <tr> 
            <th width="249" rowspan="2" nowrap bgcolor="#006699"><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">ACTIVIDADES</font></th>
            <th width="215" rowspan="2" nowrap bgcolor="#006699"><p><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">CONTROL</font></p></th>
          ...
          <tr> 
            <th width="43" height="20" nowrap bgcolor="#006699"><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">SI</font></th>
            <th width="48" nowrap bgcolor="#006699"><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">NO</font></th>
            <th nowrap bgcolor="#006699"><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">OBSERVACIONES</font></th>
          </tr>
          <?php
			
		$sql = "SELECT *,DATE_FORMAT(Fecha_del, '%d/%m/%Y') AS Fecha_del,DATE_FORMAT(Fecha_al, '%d/%m/%Y') AS Fecha_al FROM soliccambiocontrol WHERE Codigo='$id_orden' ORDER BY Responsabilid ASC";
		$result=mysql_db_query($db,$sql,$link);
		while($row=mysql_fetch_array($result)) 
  		{
		 ?>
          <tr align="center"> 
            <td height="42"><div align="center">&nbsp;<?php 
		 ...
		 ?>
          <tr> 
            <td colspan="8" height="17" nowrap><font size="1" face="Verdana, Arial, Helvetica, sans-serif">&nbsp;</font> 
          ...
          <tr> 
            <td height="7" nowrap><div align="center"><strong> </strong><strong> 
			  ...
			  $sql = "SELECT * FROM soliccambioejecucion WHERE Codigo='$id_orden' AND Aprobacion='SI' ORDER BY IdProyPlanif ASC";
			  $result = mysql_db_query($db,$sql,$link);
			  while ($row = mysql_fetch_array($result)) 
			  {
				$sql2 = "SELECT * FROM soliccambiocontrol WHERE Codigo='$id_orden' AND Responsabilid='$row[Responsabilid]'";
