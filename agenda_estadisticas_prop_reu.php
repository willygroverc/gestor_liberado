...
<?php
$sql_tot="SELECT count(*) AS total_reunion FROM asistentes WHERE prop IS NOT NULL";
...
<table width="60%" border="1" align="center"  background="images/fondo.jpg">
  <tr> 
    <td width="455"> <table border="1" cellpadding="0" cellspacing="0" width="100%">
		...
		<?php
		$sql="SELECT count(*) AS numero, num_codigo, a1.id_minuta FROM minuta a1, asistentes a2 WHERE a1.id_minuta=a2.id_minuta AND prop IS NOT NULL GROUP BY a1.id_minuta";
