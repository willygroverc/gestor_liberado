...
<table width="636" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr> 
    <td> <div align="center"><b><u><font size="4" face="Arial, Helvetica, sans-serif">REPORTE DE BITACORAS</font></u></b></div></td>
  </tr>
</table>
<br>
  ...
  <tr> 
    <td height="68" valign="top"><table width="100%" border="1" align="center" cellpadding="4" cellspacing="0">
        <tr align=\"center\" bgcolor="#CCCCCC"> 
          ...
          <th width="6%"><font face="Arial, Helvetica, sans-serif" color="#000000" size="2"><B>DIA</B></font></th>
			...
			case "ASIGNADO":
				...
				while ($tmp=mysql_fetch_array($rs1))  {			
					...
					if ($rsTmp["asig"]==$nombre) {
						...
						$sqlsg="SELECT COUNT(id_seg) AS num, fecha_seg FROM seguimiento WHERE id_orden = '$rsTmp[id_orden]'";
						$resultsg=mysql_query($sqlsg);
						$filasg=mysql_fetch_array($resultsg);
							
							$date = date_create($filasg['fecha_seg']);
							$fcmb=date_format($date, 'd/m/Y');
							echo nombredia($fcmb);
						echo '</font></td>';
				...
				/*echo '<tr align="center" border="0">
							...
							<td>&nbsp;</td>
							<td>&nbsp;</td>
							<td><font size=\"1\" face=\"Arial, Helvetica, sans-serif\">&nbsp;Total Bitacoras:'; echo $resto; echo '<br>Total seguimientos:'; echo $numsgm; echo '<br>
							Total Seg. esperados:'; echo $ttl=$resto*8;
							echo '</font></td>
							<td>&nbsp;</td>
						</tr>';*/
				...
				$sqlnu = "SELECT nom_usr,apa_usr,ama_usr FROM users WHERE login_usr='$nombre'";
				$resultnu = mysql_query($sqlnu);
				$rownu = mysql_fetch_array($resultnu);
				echo "<font size=2 face='verdana'><b> Nombre:&nbsp;$rownu[nom_usr] $rownu[apa_usr] $rownu[ama_usr]</b></font>";
				echo "<br><br>";				
				break;
			case "CLIENTE":
				if($area == "0"){ $area = "%";}
...
<?php
echo '<div align="center"><font size=\"1\" face=\"Arial, Helvetica, sans-serif\">&nbsp;Total Bitacoras:'; echo $resto; echo '<br>Total seguimientos:'; echo $numsgm; 
echo '<br>Total Seg. esperados:'; echo $ttl=$resto*8;
echo '</font>&nbsp;</div>';
function area($id)
{
	include("conexion.php");
...
function nombredia($fecha='')//formato: 00/00/0000
