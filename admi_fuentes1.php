...
if (isset($reg_form)) {
	...
	{ 
			/*$sql2 = "SELECT probArchivos, probDesc FROM problemas WHERE probIdOrden='$num'";
			...
			*/
			...
			//}
			//$sql="UPDATE problemas SET probArchivos='$cadena', probDesc = '$txtObservacion' WHERE probIdOrden='$num'";
			//mysql_db_query($db,$sql,$link);
