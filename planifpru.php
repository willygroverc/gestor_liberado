...
$var2=$row5['num']+1; 
echo '<form name="frm_planif" id="frm_planif" method="POST" action="#">
      ...
      <td height="281"> 
        ...
        <table width="100%" border="1">
          <tr> 
            ...
            <td width="66%"><textarea name="objprue" id="objprue" cols="108"></textarea></td>
          </tr>
          <tr> 
            <td><blockquote> 
                <blockquote> 
            ...
            <td><textarea name="tipcontin" id="tipcontin" cols="108"></textarea></td>
          </tr>
          <tr> 
            <td><blockquote> 
                <blockquote> 
            ...
            <td><textarea name="condicion" id="condicion" cols="108"></textarea></td>
          </tr>
          <tr> 
            <td><blockquote> 
                <blockquote> 
            ...
            <td><textarea name="fecrelac" id="fecrelac" cols="108"></textarea></td>
          </tr>
          <tr> 
            ...
            <td><textarea name="varios" id="varios" cols="108"></textarea></td>
          </tr>
          <tr bordercolor="#000000" bgcolor="#006699"> 
          ...
          <tr> 
            ...
            <td><textarea name="rechard" id="rechard" cols="108"></textarea></td>
          </tr>
          <tr> 
            <td><blockquote> 
                <blockquote> 
            ...
            <td><textarea name="recsoft" id="recsoft" cols="108"></textarea></td>
          </tr>
          <tr> 
            <td><blockquote> 
                <blockquote> 
            ...
            <td><textarea name="recresp" id="recresp" cols="108"></textarea></td>
          </tr>
          <tr> 
            <td><blockquote> 
                <blockquote> 
            ...
            <td><textarea name="facilidad" id="facilidad" cols="108"></textarea></td>
          </tr>
          <tr> 
            <td><blockquote> 
                <blockquote> 
            ...
            <td><input name="costo" id="costo" type="text" maxlength="10"> <select name="moneda" id="moneda">
          ...
          <tr> 
            <td height="24" colspan="2"><div align="center"> 
			  ...
			  while ($row4 = mysql_fetch_array($result4)) 
                ...
                <br>
                <input name="GUARDATOS" type="submit" id="GUARDATOS" value="GUARDAR Y CONTINUAR" onclick="guardar_planif();">
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
