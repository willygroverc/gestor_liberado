...
{   include("conexion.php");
	...
	$sql="INSERT INTO ".
	"solicproycierre (Codigo,Responsabilid,Actividades,Aprobacion,Observac,Fecha_cier) ".
	"VALUES ('$var','$Responsabilid','$Actividades','$Aprobacion','$Observac','".date("Y-m-d")."')";
	mysql_db_query($db,$sql,$link);
	header("location: solicproyecto6.php?Codigo=$var");
}
else { 
include("top.php");
require_once('funciones.php');
	...
	<tr> 
      <td> 
        <table width="100%" border="1" cellpadding="0" cellspacing="0" bgcolor="#006699">
          <tr> 
            <td><div align="center"><font color="#FFFFFF" size="3" face="Arial, Helvetica, sans-serif"><strong>SOLICITUD 
                DE PROYECTOS - FASE DE CIERRE</strong></font></div></td>
          </tr>
        </table>
        ...
        <table width="100%" border="1" align="center" cellpadding="1" cellspacing="2" background="images/fondo.jpg">
          <tr> 
            <th width="173" rowspan="2" nowrap bgcolor="#006699"><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">ACTIVIDADES</font></th>
            <th width="310" rowspan="2" nowrap bgcolor="#006699"><p><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">CIERRE</font><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif"><br>
          ...
          <tr> 
            <th width="20" nowrap bgcolor="#006699"><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">SI</font></th>
            <th width="45" nowrap bgcolor="#006699"><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">NO</font></th>
		 ...
		 ?>
          ...
          <tr> 
            <td height="7" nowrap><div align="center"><strong> </strong><strong> 
			  ...
			  while ($row = mysql_fetch_array($result)) 
				{
				$sql2 = "SELECT * FROM solicproycierre WHERE Codigo='$Codigo' AND Responsabilid='$row[Responsabilid]'";
            ...
            <td width="310" nowrap height="7"><div align="center"><strong> 
            ...
            <td width="259" height="7" nowrap><div align="center"> 
