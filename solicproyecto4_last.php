...
if (isset($_REQUEST['RETORNAR'])) {
        $var=$_REQUEST['var'];
	header("location: solicproyecto1_last.php?Codigo=$var");
}
elseif (isset($_REQUEST['reg_form']))
	{	include("conexion.php");
		...
		$sql6= "SELECT * FROM solicproyejecucion WHERE Codigo='$var' AND Responsabilid='$Responsabilid'";
		...
		{	$sql="INSERT INTO ".
			"solicproyejecucion (Codigo,Responsabilid,Actividades,Aprobacion,Observac) ".
			"VALUES ('$var','$Responsabilid','$Actividades','$Aprobacion','$Observac')";
			mysql_query($sql);                      
			header("location: solicproyecto4_last.php?Codigo=$var");
		}
		else
		{	$sql="UPDATE solicproyejecucion SET Actividades='$Actividades',Aprobacion='$Aprobacion',".
      ...
      <td> 
        <table width="100%" border="1" cellpadding="0" cellspacing="0" bgcolor="#006699">
          <tr> 
            <td><div align="center"><font color="#FFFFFF" size="3" face="Arial, Helvetica, sans-serif"><strong>SOLICITUD 
                DE PROYECTOS - MODIFICACION EJECUCION</strong></font></div></td>
          </tr>
        </table>
        ...
        <table width="100%" border="1" align="center" cellpadding="1" cellspacing="2" background="images/fondo.jpg">
          <tr> 
            ...
            <th width="311" rowspan="2" nowrap bgcolor="#006699"><p><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">EJECUCION<br>
          ...
          <tr> 
            <th width="33" nowrap bgcolor="#006699"><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">SI</font></th>
            <th width="32" nowrap bgcolor="#006699"><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">NO</font></th>
		...
		while($row=mysql_fetch_array($result)) 
  		{
		 ?>
          <tr align="center"> <?php echo "<td><a href=\"solicproyecto4_last.php?Codigo=$Codigo&Respon=".$row['Responsabilid']."\">".$row['Responsabilid']."</a></td>";?> 
          ...
          <tr> 
            <td height="7" nowrap><div align="center"><strong> </strong><strong> 
                ...
                <select name="Responsabilid">
                  ...
                  <?php 
			  $sql4 = "SELECT *,DATE_FORMAT(Fecha_ejec, '%d/%m/%Y') AS Fecha_ejec FROM solicproyejecucion WHERE Codigo='$Codigo' AND Responsabilid='$Respon'";
            ...
            <td width="311" nowrap height="7"><div align="center"><strong> 
            ...
            <td width="283" height="7" nowrap><div align="center"> 
                <textarea name="Observac" cols="35"><?php echo $row4['Observac']?></textarea>
              </div></td>
            <td width="52" nowrap><div align="center"> <?php if (!isset($Respon)){echo date("d/m/Y");} else {echo $row4['Fecha_ejec'];}?></div></td>
          </tr>
          <tr> 
