...
function abrir(x){
	dir="iiexterno.php?id_agenda=<?php echo $id_agenda;?>&id_mod="+x
	self.location=dir
}
</script>
          ...
          <tr> 
            ...
            <td width="240" nowrap height="7"><div align="center"><strong> 
                <select name="nombre" id="nombre">
				  ...
				  $lista=implode(", ",$ident);
				  if(strlen($lista)==0) 
				  	$sql_ext="SELECT nombre FROM us_ext_user WHERE id_mod='$id_mod' ORDER BY nombre";
