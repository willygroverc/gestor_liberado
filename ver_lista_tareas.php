...
<form name="form1" method="post" action="">
  ...
  <table width="98%"  border="1" align="center" cellpadding="2" cellspacing="0" background="images/fondo.jpg">
	...
	<input type="radio" name="opc" value="1" onClick="cambio(this.value, <?php echo $IdProgTarea;?>, <?php echo $tipo;?>)" <?php if (isset($op) && $op == 1) print "checked"; else print "checked"; ?>>
        <font face="Arial, Helvetica, sans-serif" size="2"><B>GENERAL</B></font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
        <input type="radio" name="opc" value="F" onClick="cambio(this.value,  <?php echo $IdProgTarea;?>, <?php echo $tipo;?>)" <?php if (isset($op) && $op == 'F') print "checked";  ?>> 
...
function OpenPrint(){
	...
	window.open("ver_lista_tareasdiaria.php?IdProgTarea="+IdProgTarea+"&menu="+menu+"&nombre="+nombre);
