...
if ($RESINT){header("location: pruebrecup1_mod.php?id_pru=$id_pru");}
if ($RESEXT){header("location: pruebrecup2_mod.php?id_pru=$id_pru");}
if ($HDWREQ){header("location: pruebrecup3_mod.php?id_pru=$id_pru");}
if ($INSBD){header("location: pruebrecup4_mod.php?id_pru=$id_pru");}
if ($INSSB){header("location: pruebrecup5_mod.php?id_pru=$id_pru");}
if ($INSAPLI){header("location: pruebrecup6_mod.php?id_pru=$id_pru");}
if ($RESTBD){header("location: pruebrecup7_mod.php?id_pru=$id_pru");}
if ($PRUINT){header("location: pruebrecup8_mod.php?id_pru=$id_pru");}
if ($PRUURS){header("location: pruebrecup9_mod.php?id_pru=$id_pru");}
include("top.php");
...
//$listCombo = array("-1" => "Nuevo Motor de Base de Datos", "-2" => "Nuevo Sistema Operativo", "-3" => "Nuevo Software");
$formType = "PRUURS";
$typeRespAct = 9;
//$listResAct = $list -> GetNumberType($id_pru, 5, $listCombo);
$listUser = $list -> GetTable2("C");
...
print "<font color=\"#FF0000\" face=\"Arial, Helvetica, sans-serif\"><strong>";
    ...
    if ($validateDoit) {
       	if ($actionQuery=="update") {	        
    	    $execute = $prueba -> UpdateDetail2($record);
	  	  } else {    	  
        	$execute = $prueba -> InsertDetail($record);
	    }
    }
	else {				
...
function compareFecha () {
	...
	if (Date.parse(from) == Date.parse(to)) {
	  ...
	  if ( form.resact ) {
		if (form.resact.value.length > 500)
		{ alert ("Responsables / Actividades, debe ser menor a 500 caracteres.\n \nMensaje generado por GesTor F1.");
		return false;
		 }}
	return true;
}
...
<table width="100%" border="2" align="center" background="./images/fondo.jpg">
  <td colspan="8" bgcolor="#006699" > <div align="center"> 
        <p><font size="1" face="Arial, Helvetica, sans-serif" color="#FFFFFF"><strong><font size="3">Pruebas de Usuario</font></strong></font></p>
    </div></td>
  </tr>
  <tr> 
    ...
    <td width="12%" bgcolor="#006699" > <div align="center"><div align="center"><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">Nombres 
        y Apellidos<br>(Razon Social)</font></div></div></td>
    ...
    <td width="14%" bgcolor="#006699" > <div align="center"> 
        <font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">Fecha 
  ...
  <?php
$listPrueba = $prueba -> GetDetail2($typeRespAct, $id_pru, 0);
if (sizeof($listPrueba) > 0) {
    foreach ($listPrueba as $k => $v) {
        ...
        print "<td align=\"center\">" . $v["usuario"] . "</td>";
  ...
  <table width="100%" border="2" align="center" background="./images/fondo.jpg">
    <tr> 
      ...
      <td width="30%" bgcolor="#006699" > <div align="center"><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">Nombres 
        y Apellidos<br>(Razon Social)</font></div></td>
    ...
    <tr> 
      <td width="30%" align="center"><textarea name="resact" cols="20"><?php print $recordDb[resact];
?></textarea> </td>
...
?>
    ...
    <tr > 
      ...
      <td align="center" bgcolor="#006699"><div align="center"><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">Hora de Conclusion</font></div></td>
...
<form name="form2" method="post" action="">
  <table width="90%" border="0" align="center" cellpadding="0" cellspacing="2">
    ...
    <tr> 
      <td align="center"><font size="2" face="Arial, Helvetica, sans-serif"><strong>4.- 
        </strong></font> 
