...
<table width="80%" border="1" align="center" background="images/fondo.jpg">
    <tr bgcolor="#006699"> 
      <th colspan="9"><font color="#FFFFFF" face="Arial, Helvetica, sans-serif">Boletin Informativo</strong></font></div></td>
    </tr>
    <tr bgcolor="#006699"> 
      <td width="4%"> <div align="center"><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">Nro</font></div></td>
      <td width="11%"> <div align="center"><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">Fecha y Hora</font></div></td>
      <td width="77%"> <div align="center"><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">Descripcion</font></div></td>
      <td width="8%"> <div align="center"><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">Adjunto</font></div></td>
    </tr>
	...
	if ( (($row2['tipo2_usr']=="A") or ($row2['tipo2_usr']=="B") or ($row2['tipo2_usr']=="T")) and $tipo_usr != "EXTERNO")
	{
        ...
        <td>
	    <?php if (!isset($row1['nomb_archivo'])){echo "NINGUNO";}
