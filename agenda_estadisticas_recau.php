...
<?php
$sql_tot="SELECT SUM(recau) AS total_reunion FROM minuta WHERE recau<>0";
...
<table width="60%" border="1" align="center"  background="images/fondo.jpg">
  <tr> 
    <td width="455"> <table border="1" cellpadding="0" cellspacing="0" width="100%">
		...
		<?php
		$sql="SELECT recau,a.num_codigo FROM `minuta` m, agenda a WHERE m.id_minuta=a.id_agenda AND recau <>0";
		$res=mysql_db_query($db,$sql,$link);
		while($row=mysql_fetch_array($res)){
		?>
        <tr> 
          <td> <div align="left"><font size="2" face="Arial, Helvetica, sans-serif">&nbsp;&nbsp;
		  <?php echo "Reunion ".$row['num_codigo']; ?></font></div></td>
...
<div align="center"><strong><font size="1" face="Arial, Helvetica, sans-serif">NOTA 
  : En algunos casos, la suma estadistica tiene un error de 1% por motivos de redondeo.</font> 
</div>
</body>
</html>
