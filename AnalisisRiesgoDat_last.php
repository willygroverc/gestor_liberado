...
if (isset($_REQUEST['GUARDATOS'])) {
  ...
  $sql = "UPDATE analisisriesgdatos SET NombProy='$NombProy',NombResp='$NombResp',DocuRef='$DocuRef',DescImpacto='$DescImpacto',".
  		"AccionPrev='$AccionPrev',AccionConting='$AccionConting',DocuSoporte='$DocuSoporte',FechaAnalisis='$FechaAnalisis' ".
		"WHERE IdAnalisis='$var'";
  ...
  <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
	...
	<table width="100%" border="1" align="center" cellpadding="0" cellspacing="0" bgcolor="#006699">
          ...
          <table width="100%" border="1" cellpadding="1" cellspacing="0" background="images/fondo.jpg">
            <tr> 
              <td height="257"> <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr> 
                    <td height="19" colspan="2"><font size="2" face="Arial, Helvetica, sans-serif">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Formulario 
                      Nro.</font> <font size="2" face="Arial, Helvetica, sans-serif"><?php echo $IdAnalis;?></font></td>
                    <td height="19">&nbsp;</td>
                  </tr>
                  <tr> 
					...
					$sql0 = "SELECT DISTINCT Requerimiento FROM solicproydatos ORDER BY Requerimiento ASC";
			  		...
			  		while ($row0=mysql_fetch_array($result0)) {
						if ($row4['NombProy']==$row0['Requerimiento'])
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr> 
                    <td width="471" height="25"><font size="2" face="Arial, Helvetica, sans-serif">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Nombre 
                      ...
                      <select name="NombResp" id="select2">
						...
						{
				   		if ($row['login_usr']==$row4['NombResp'])
                    ...
                    <td width="401" height="25" colspan="3"><font size="2" face="Arial, Helvetica, sans-serif">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Fecha 
                      :</font>&nbsp;<strong> 
                      <select name="dia1" >
                        <?php
  				$a1=substr($row4['FechaAnalisis'],0,4);
				$m1=substr($row4['FechaAnalisis'],5,2);
				$d1=substr($row4['FechaAnalisis'],8,2);
					for($i=1;$i<=31;$i++)
					{
			   ...
			   ?>
                ...
                <table width="100%">
                  <tr> 
                    ...
                    <td width="40%"><textarea name="DocuRef" cols="35"><?php echo $row4['DocuRef'];?></textarea></td>
                    <td width="13%"><div align="center"><font size="2" face="Arial, Helvetica, sans-serif">Descripcion 
                        del Impacto</font> </div></td>
                    <td width="32%"><textarea name="DescImpacto" cols="35"><?php echo $row4['DescImpacto'];?></textarea></td>
                  </tr>
                </table>
                <table width="100%">
                  <tr> 
                    ...
                    <td width="25%"><textarea name="AccionPrev" cols="27" id="AccionPrev"><?php echo $row4['AccionPrev'];?></textarea></td>
                    <td width="9%"><div align="center"><font size="2" face="Arial, Helvetica, sans-serif">Acciones 
                        de Contingencia Recomendadas</font></div></td>
                    <td width="24%"><textarea name="AccionConting" cols="27"><?php echo $row4['AccionConting'];?></textarea></td>
                    ...
                    <td width="23%"><font size="2" face="Arial, Helvetica, sans-serif"> 
                      <textarea name="DocuSoporte" cols="27"><?php echo $row4['DocuSoporte'];?></textarea>
                      </font></td>
                  </tr>
                  <tr> 
                    <td colspan="6">&nbsp;</td>
