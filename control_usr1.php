...
function agregarFila($formulario){
	...
	$str_html_td7 = '<img src="images/delete.png" width="16" height="16" alt="Eliminar" onclick="if(confirm(\'Realmente desea eliminar este detalle?\')){xajax_eliminarFila('. $id_campos .', frm_usu.cant_campos.value);}"/>';
...
<table width="90%" border="2" cellspacing="4" cellpadding="2" background="images/fondo.jpg">
          ...
          <tr align="center"> 
            ...
            <?php 	
				require_once('funciones.php');
				$IdControl=SanitizeString($_REQUEST['IdControl']);
				$sql4 = "SELECT * FROM control_usr WHERE IdControl='$IdControl'";
