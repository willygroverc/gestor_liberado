<?php
include ("top_ver.php");
$sql="SELECT *,DATE_FORMAT(FechaDe,'%d / %m / %Y') as FechaDe FROM progtareassemanal ORDER BY Dia ASC";
...
<table width="100%" border="0">
  <tr>
    <td><div align="center"><font size="4" face="Arial, Helvetica, sans-serif"><strong><u>LISTA DE TAREAS SEMANALES </u></strong></font></div></td>
  </tr>
</table>
