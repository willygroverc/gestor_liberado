<?php if (isset($_REQUEST['RETORNAR']))
//$var= $_REQUEST['var'];
header("location: solicproyecto3.php?Codigo=$_REQUEST[var]");
?>
<?php
	...
	<tr> 
      <td height="221"> 
        ...
        <table width="100%" border="1" align="center" cellpadding="1" cellspacing="2" background="images/fondo.jpg">
          ...
          <tr> 
            <th width="150" rowspan="2" nowrap bgcolor="#006699"><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">ACTIVIDADES</font></th>
            <th width="225" rowspan="2" nowrap bgcolor="#006699"><p><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">PLANIFICACION 
                <br>
          ...
          <tr> 
            ...
            <th width="93" nowrap bgcolor="#006699"><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">OBSERVACIONES</font></th>
          </tr>
          <?php
		 ...
		 ?>
          ...
          <tr> 
            <td height="7" nowrap><div align="center"><strong> </strong><strong> 
                ...
                <input name="Responsabilid" type="text" size="35" maxlength="40">
                </font> </strong> </div></td>
            <td width="225" nowrap height="7"><div align="center"><strong> 
