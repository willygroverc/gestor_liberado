...
$IdProgTarea=SanitizeString(isset($_GET['IdProgTarea']));
@session_start();
if($_SESSION['tipo']=="C") {
...
<script language="JavaScript" src="js/tareas_mensual.js"></script>
...
if(isset($_GET["do"]) && $_GET["do"]=="editar"){
	$sql="SELECT * FROM progtareasmensual WHERE IdProgTarea='$IdProgTarea'";
	$wTarea=mysql_fetch_array(mysql_query( $sql));
}
echo '<form name="frm_mensual" id="frm_mensual" action="#" method="POST">
<input name="IdProgTarea" type="hidden" id="IdProgTarea" value="'; echo $IdProgTarea; echo '">
    ...
    <table width="70%" border="1" align="center" cellpadding="2" cellspacing="0" background="images/fondo.jpg">
      ...
      <tr>
        <th height="50" colspan="9" background="images/main-button-tileR2.jpg">
          <p><font size="2" face="Arial, Helvetica, sans-serif">Fecha: </font> <strong><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong><font size="2" face="Verdana, Arial, Helvetica, sans-serif">
            <input type="text" name="FechaProceso" id="FechaProceso" value="'; echo date('Y-m-d'); echo '" maxlength="10" size="10">
      ...
      <tr align="center">
        ...
        <th width="120" colspan="5" rowspan="2" background="images/main-button-tileR2.jpg"><font size="2" face="Arial, Helvetica, sans-serif" color="#FFFFFF">Dia</font></th>
      ...
      <tr>
        <td height="28" colspan="9" nowrap>
          <div align="center"><br>
            <input name="INSERTAR" type="button" id="INSERTAR2" value="INSERTAR" onclick="guardar_mensual();">
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
