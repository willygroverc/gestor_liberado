...
{	
	...
	$hora_fin="$hf:$mf";
		...
		"fecha='$fecha',hora='$hora',lugar='$lugar',entidad='$entidad',hora_conv='$hora_conv' WHERE id_agenda='$var'";
	...
	else
	 {
	   ...
	   $sql="INSERT INTO ".
	   "agenda (codigo,elab_por,en_fecha,tipo_reu,fecha,hora,lugar,entidad,hora_conv,num_codigo) ".
	   "VALUES ('$codigo','$elab_por','$en_fecha','$tipo_reu','$fecha','$hora','$lugar','$entidad','$hora_conv','$num')";
  	   mysql_db_query($db,$sql,$link);
...
{   if ($verif=="1")
	...
	$sql="INSERT INTO ".
	"agenda (codigo,elab_por,en_fecha,tipo_reu,fecha,hora,lugar,num_codigo,entidad,hora_conv) ".
	"VALUES ('$codigo','$elab_por','$en_fecha','$tipo_reu','$fecha','$hora','$lugar','$num','$entidad','$hora_conv')";
  	mysql_db_query($db,$sql,$link);
	}
...
<!--                  <option value="CAI" <?php if ($row2[codigo]=='CAI') { echo "selected"; } ?> >CAI</option>
        ...
        <table width="100%" height="52" cellpadding="0" cellspacing="0">
  		...
  		?>
				...
				<!--***********************************-->
              <p><font size="2" face="Arial, Helvetica, sans-serif"><strong>Hora c:</strong></font> <font size="2">
              <?php /*if($verif==1) { print $row2[hora];}
				else { */ 
				//$vhora=date("H:i:s");
				$vhorac=$row2[hora_conv];
				$hc1=substr($vhorac,0,2);
				$mic1=substr($vhorac,3,2);
  		?>
              <select name="hc" id="mc">
                <option value="00" <?php if($hc1=="00") echo "selected"?>>00</option>
                <option value="01"<?php if($hc1=="01") echo " selected"?>>01</option>
                <option value="02"<?php if($hc1=="02") echo " selected"?>>02</option>
                <option value="03"<?php if($hc1=="03") echo " selected"?>>03</option>
                <option value="04"<?php if($hc1=="04") echo " selected"?>>04</option>
                <option value="05"<?php if($hc1=="05") echo " selected"?>>05</option>
                <option value="06"<?php if($hc1=="06") echo " selected"?>>06</option>
                <option value="07"<?php if($hc1=="07") echo " selected"?>>07</option>
                <option value="08"<?php if($hc1=="08") echo " selected"?>>08</option>
                <option value="09"<?php if($hc1=="09") echo " selected"?>>09</option>
                <option value="10"<?php if($hc1=="10") echo " selected"?>>10</option>
                <option value="11"<?php if($hc1=="11") echo " selected"?>>11</option>
                <option value="12"<?php if($hc1=="12") echo " selected"?>>12</option>
                <option value="13"<?php if($hc1=="13") echo " selected"?>>13</option>
                <option value="14"<?php if($hc1=="14") echo " selected"?>>14</option>
                <option value="15"<?php if($hc1=="15") echo " selected"?>>15</option>
                <option value="16"<?php if($hc1=="16") echo " selected"?>>16</option>
                <option value="17"<?php if($hc1=="17") echo " selected"?>>17</option>
                <option value="18"<?php if($hc1=="18") echo " selected"?>>18</option>
                <option value="19"<?php if($hc1=="19") echo " selected"?>>19</option>
                <option value="20"<?php if($hc1=="20") echo " selected"?>>20</option>
                <option value="21"<?php if($hc1=="21") echo " selected"?>>21</option>
                <option value="22"<?php if($hc1=="22") echo " selected"?>>22</option>
                <option value="23"<?php if($hc1=="23") echo " selected"?>>23</option>
              </select>
:
<select name="mc" id="select4">
  <option value="00" <?php if($mic1=="00") echo "selected"?>>00</option>
  <option value="15"<?php if($mic1=="15") echo " selected"?>>15</option>
  <option value="30"<?php if($mic1=="30") echo " selected"?>>30</option>
  <option value="45"<?php if($mic1=="45") echo " selected"?>>45</option>
</select>
              </font><font size="2">
                <?php //} ?>
              </font> </strong> </p></td>
            <td width="42%"><div align="center"> <font size="2" face="Arial, Helvetica, sans-serif"><strong>Lugar:</strong></font> 
				...
				<div align="center"> <font size="2" face="Arial, Helvetica, sans-serif"><strong>Entidad:</strong></font> 
                <font size="2"> 
                <?php /*if ($verif==1) { print $row2[lugar];}
				else {*/?>
                <input name="entidad" type="text" id="entidad" value="<?php echo $row2[entidad];?>" size="35" maxlength="60">
                <?php //}?>
                </font></strong> </div>
				</td>
          </tr>
	    ...
	    <table width="90%" border="2" align="center" cellpadding="0" cellspacing="0">
          <tr bgcolor="#006699"> 
            <td width="6%" height="21" background="images/main-button-tileR1.jpg"> <div align="center"><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif"><strong>N&ordf;</strong></font></div></td>
            <td width="30%" background="images/main-button-tileR1.jpg"> <div align="center"><font face="Arial, Helvetica, sans-serif"><strong><font color="#FFFFFF" size="2">NOMBRE</font></strong></font></div></td>
            <td width="12%" background="images/main-button-tileR1.jpg"> <div align="center"><font face="Arial, Helvetica, sans-serif"><strong><font color="#FFFFFF" size="2">CARGO/ROL</font></strong></font></div></td>
          </tr>
          <?php
		$cont=0;	
        ...
        <table width="90%" border="2" align="center" cellpadding="0" cellspacing="0">
          <tr bgcolor="#006699"> 
            <td width="8%" height="21" background="images/main-button-tileR1.jpg"> <div align="center"><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif"><strong>N&ordf;</strong></font></div></td>
            <td width="51%" background="images/main-button-tileR1.jpg"> <div align="center"><font face="Arial, Helvetica, sans-serif"><strong><font color="#FFFFFF" size="2">TEMA</font></strong></font></div></td>
            <td width="26%" background="images/main-button-tileR1.jpg"> <div align="center"><font face="Arial, Helvetica, sans-serif"><strong><font color="#FFFFFF" size="2">RESPONSABLE</font></strong></font></div></td>
            <td width="15%" background="images/main-button-tileR1.jpg"> <div align="center"><font face="Arial, Helvetica, sans-serif"><strong><font color="#FFFFFF" size="2">DURACION 
        ...
        <table width="90%" border="1" align="center" cellpadding="0" cellspacing="0" bgcolor="#006699">
          <tr>
            <td background="images/main-button-tileR1.jpg" height="20"><div align="center"><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif"><strong>COMENTARIOS</strong></font></div></td>
          </tr>
        </table>
