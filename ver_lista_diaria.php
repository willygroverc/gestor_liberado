<?php
include ("top_ver.php");
$sql="SELECT *,DATE_FORMAT(FechaDe,'%d / %m / %Y') as FechaDe FROM progtareasdiaria ORDER BY HoraDe ASC";
...
<table width="100%" border="0">
  <tr>
    <td><div align="center"><font size="4" face="Arial, Helvetica, sans-serif"><strong><u>LISTA DE TAREAS DIARIAS </u></strong></font></div></td>
  </tr>
</table>
<br>
