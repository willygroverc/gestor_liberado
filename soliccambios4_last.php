...
{   include("conexion.php");
	...
	{
		$sql="UPDATE soliccambioejecucion SET Actividades='$Actividades',Aprobacion='$Aprobacion',".
	...
	<tr> 
      <td> 
        ...
        <table width="100%" cellspacing="0" cellpadding="0">
          <tr> 
            ...
            <td width="85%" valign="top"><font color="#000000" size="2" face="Arial, Helvetica, sans-serif"> 
			  ...
			  $row_req=mysql_fetch_array(mysql_query($sql_req));			  
		...
		while($row=mysql_fetch_array($result)) 
		 ...
		 ?>
          <tr align="center"> 
            <td><div align="center">&nbsp;<?php echo "<a href=\"soliccambios4_last.php?id_orden=$id_orden&Cod=$row[IdProyPlanif]\">".$limbo++."</a>";?></div></td>
		 ...
		 ?>
          <tr> 
		   ...
		   <?php 
		  $sql_up="SELECT *,DATE_FORMAT(Fecha_del, '%d/%m/%Y') AS Fecha_del,DATE_FORMAT(Fecha_al, '%d/%m/%Y') AS Fecha_al FROM soliccambioejecucion WHERE Codigo='$id_orden' AND IdProyPlanif='$Cod'";
          ...
          <tr> 
		     <td><strong> 
              <select name="IdProyPlanif" onChange="cambia(this.value)">
                ...
                <?php 
			  $sql2 = "SELECT * FROM soliccambioejecucion WHERE Codigo='$id_orden'";
            ...
            <td width="234" height="7" nowrap><div align="center"> 
              <?php if($Cod=="Nueva" OR !$Cod){?>
			...
			{
				$sql_act="SELECT Responsabilid FROM soliccambioplanif WHERE Codigo='$id_orden' AND IdProyPlanif='$row_up[Responsabilid]'";
				$row_act=mysql_fetch_array(mysql_db_query($db,$sql_act,$link));
				echo "<font face=\"Arial, Helvetica, sans-serif\">$row_act[Responsabilid]</font>";
			}?>
                </div></td>
            <td width="215" nowrap height="7"><div align="center"><strong> 
                <textarea name="Actividades" cols="30" onKeyDown="textCounter(form2.Actividades,form2.remLen2,490);" onKeyUp="textCounter(form2.Actividades,form2.remLen2,490);"><?php echo $row_up['Actividades'];?></textarea>
            ...
            <td width="189" height="7" nowrap><div align="center"> 
                <textarea name="Observac" cols="25" onKeyDown="textCounter(form2.Observac,form2.remLen3,240);" onKeyUp="textCounter(form2.Observac,form2.remLen3,240);"><?php echo $row_up['Observac'];?></textarea>
          ...
          <tr> 
            <td height="47" colspan="8" nowrap> <div align="center"><br>
                <input name="reg_form" type="submit" id="reg_form3" value="<?php if($Cod=="Nueva" OR !$Cod){echo "INSERTAR";}else{echo "MODIFICAR";}?>" <?php print $valid->onSubmit() ?>>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
...
{   
	irapagina("soliccambios4_last.php?id_orden="+<?php echo $id_orden;?>+"&Cod="+numero);
}
