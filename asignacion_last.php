...
if(isset($send_mail))
{
		...
		if (!(empty($ordenCliente['email'])))
		{
			...
			{ $msg ="Precauci�n, no se ha podido enviar la orden por correo electr�nico al Cliente.";}																
			else{$msg="Mensaje enviado exitosamente $mail $asunto $mensaje $headers";}
		}//end isset si correo no es vacio
		else {	$msg ="Precauci�n, no se ha podido enviar la orden por correo electr�nico al Cliente. El Usuario no tiene registrado su cuenta de correo";  }
...
// Adici�n del control de CONFORMIDAD
	$ordAbiertas = 1;
	$sCad = "select *from solucion	where login_sol='$asig'";
	$rCad = mysql_query($sCad);
	$cadena = "yanapti";
	$cont = 1;
...
{	
		...
		if($rows['reg_asig'])
		{
			...
			{	
				...
				"VALUES ('$id_orden','$nivel_asig','$criticidad_asig','$prioridad_asig','$asig','".date("Y-m-d")."','".date("H:i:s")."',"."'".$AA."-".$MA."-".$DA."','$login','$diagnos','','','0000-00-00','0000-00-00','$area','$pru1|$pru2|$pru3')";
				}
				else//en caso contrario
				{
				$sql3="INSERT INTO asignacion (id_orden,nivel_asig,criticidad_asig,prioridad_asig,asig,fecha_asig,hora_asig,fechaestsol_asig,reg_asig,".
				"diagnos,escal,date_esc,time_esc,fechasol_esc,area,area_1) ".
				"VALUES ('$id_orden','$nivel_asig','$criticidad_asig','$prioridad_asig','$asig','".date("Y-m-d")."','".date("H:i:s")."',"."'".$AA."-".$MA."-".$DA."','$login','$diagnos','0','0000-00-00','00:00:00','0000-00-00','$area','$pru1|$pru2|$pru3')";
			...
			else
			{
				...
				"'".$AA."-".$MA."-".$DA."','$login','$diagnos','$escal','".date("Y-m-d")."','".date("H:i:s")."','0000-00-00','$area','')";
				}
				else//En caso contrario
				{
				$sql3="INSERT INTO asignacion (id_orden,nivel_asig,criticidad_asig,prioridad_asig,asig,fecha_asig,hora_asig,fechaestsol_asig,reg_asig,".
				"diagnos,escal,date_esc,time_esc,fechasol_esc,area,area_1) ".
				"VALUES ('$id_orden','$nivel_asig','$criticidad_asig','$prioridad_asig','$asig','".date("Y-m-d")."','".date("H:i:s")."',"."'".$AA."-".$MA."-".$DA."','$login','$diagnos','0','0000-00-00','00:00:00','0000-00-00','$area','')";
				}//Fin de check
			}
		}
		else
...
//************************************************************************************************************************************	
				...
				{
				$sql3="UPDATE asignacion SET id_orden='$id_orden',nivel_asig='$nivel_asig',criticidad_asig='$criticidad_asig',prioridad_asig='$prioridad_asig',asig='$asig',fecha_asig='".date("Y-m-d")."',hora_asig='".date("H:i:s")."',fechaestsol_asig='".$AA."-".$MA."-".$DA."',reg_asig='$login',".
				"diagnos='$diagnos',escal='0',time_esc='00:00:00',fechasol_esc='0000-00-00',area='$area',area_1='$pru1|$pru2|$pru3' WHERE id_asig='$rows[id_asig]'";
				}//fin de check
			}
			else
			{
				...
				if(isset($chkEscalar))
		  	    {
				$sql3="UPDATE asignacion SET id_orden='$id_orden',nivel_asig='$nivel_asig',criticidad_asig='$criticidad_asig',prioridad_asig='$prioridad_asig',asig='$asig',fecha_asig='".date("Y-m-d")."',hora_asig='".date("H:i:s")."',fechaestsol_asig='".$AA."-".$MA."-".$DA."',reg_asig='$login',".
				"diagnos='$diagnos',escal='$escal',fechasol_esc='0000-00-00',area='$area' WHERE id_asig='$rows[id_asig]'";
...
//************************************************************************************************************************************	
				...
				{
				$sql3="UPDATE asignacion SET id_orden='$id_orden',nivel_asig='$nivel_asig',criticidad_asig='$criticidad_asig',prioridad_asig='$prioridad_asig',asig='$asig',fecha_asig='".date("Y-m-d")."',hora_asig='".date("H:i:s")."',fechaestsol_asig='".$AA."-".$MA."-".$DA."',reg_asig='$login',".
				"diagnos='$diagnos',escal='0',time_esc='00:00:00',fechasol_esc='0000-00-00',area='$area' WHERE id_asig='$rows[id_asig]'";
				}//fin de check
			}
		}
...
else     
{
		...
		if($rows['reg_asig'])
		{
			...
			{	
				...
				"'".$AA."-".$MA."-".$DA."','$login','$diagnos','','','','0000-00-00','$area','$pru1|$pru2|$pru3')";
...
//************************************************************************************************************************************	
				...
				"diagnos,escal,date_esc,time_esc,fechasol_esc,area,area_1) ".
				"VALUES ('$var','$nivel_asig','$criticidad_asig','$prioridad_asig','$asig','".date("Y-m-d")."','".date("H:i:s")."',".
				"'".$AA."-".$MA."-".$DA."','$login','$diagnos','0','','','0000-00-00','$area','$pru1|$pru2|$pru3')";
				}
			}
			else
			{
...
//************************************************************************************************************************************	
				...
				"diagnos,escal,date_esc,time_esc,fechasol_esc,area,area_1) ".
				"VALUES ('$var','$nivel_asig','$criticidad_asig','$prioridad_asig','$asig','".date("Y-m-d")."','".date("H:i:s")."',".
				"'".$AA."-".$MA."-".$DA."','$login','$diagnos','0','','','0000-00-00','$area','')";
				}
		...
		else
		{
			...
			if($area=="Cambios")
			{
				...
				if(isset($chkEscalar))
		  	    {
				$sql3="UPDATE asignacion SET id_orden='$id_orden',nivel_asig='$nivel_asig',criticidad_asig='$criticidad_asig',prioridad_asig='$prioridad_asig',asig='$asig',fecha_asig='".date("Y-m-d")."',hora_asig='".date("H:i:s")."',fechaestsol_asig='".$AA."-".$MA."-".$DA."',reg_asig='$login',".
				"diagnos='$diagnos',escal='$escal',date_esc='".date("Y-m-d")."',time_esc='".date("H:i:s")."',fechasol_esc='0000-00-00',area='$area',area_1='$pru1|$pru2|$pru3' WHERE id_asig='$rows[id_asig]'";
//****************************************Envio de Email*****************************************************************************	
					include("conexion.php");
					$sqlTmp="SELECT * FROM ordenes WHERE id_orden='$id_orden'";
					$ordenTmp=mysql_fetch_array(mysql_db_query($db, $sqlTmp, $link));
...
//************************************************************************************************************************************	
				...
				{
				$sql3="UPDATE asignacion SET id_orden='$id_orden',nivel_asig='$nivel_asig',criticidad_asig='$criticidad_asig',prioridad_asig='$prioridad_asig',asig='$asig',fecha_asig='".date("Y-m-d")."',hora_asig='".date("H:i:s")."',fechaestsol_asig='".$AA."-".$MA."-".$DA."',reg_asig='$login',".
				"diagnos='$diagnos',escal='0',date_esc='',time_esc='',fechasol_esc='0000-00-00',area='$area',area_1='$pru1|$pru2|$pru3' WHERE id_asig='$rows[id_asig]'";
				}//Fin de Control Check
			}
			else
			{
				...
				if(isset($chkEscalar))
		  	    {
				$sql3="UPDATE asignacion SET id_orden='$id_orden',nivel_asig='$nivel_asig',criticidad_asig='$criticidad_asig',prioridad_asig='$prioridad_asig',asig='$asig',fecha_asig='".date("Y-m-d")."',hora_asig='".date("H:i:s")."',fechaestsol_asig='".$AA."-".$MA."-".$DA."',reg_asig='$login',".
				"diagnos='$diagnos',escal='$escal',date_esc='".date("Y-m-d")."',time_esc='".date("H:i:s")."',fechasol_esc='0000-00-00',area='$area' WHERE id_asig='$rows[id_asig]'";
//****************************************Envio de Email*****************************************************************************	
					include("conexion.php");
					$sqlTmp="SELECT * FROM ordenes WHERE id_orden='$id_orden'";
					$ordenTmp=mysql_fetch_array(mysql_db_query($db, $sqlTmp, $link));
...
//************************************************************************************************************************************	
				...
				{
				$sql3="UPDATE asignacion SET id_orden='$id_orden',nivel_asig='$nivel_asig',criticidad_asig='$criticidad_asig',prioridad_asig='$prioridad_asig',asig='$asig',fecha_asig='".date("Y-m-d")."',hora_asig='".date("H:i:s")."',fechaestsol_asig='".$AA."-".$MA."-".$DA."',reg_asig='$login',".
				"diagnos='$diagnos',escal='0',date_esc='',time_esc='',fechasol_esc='0000-00-00',area='$area' WHERE id_asig='$rows[id_asig]'";
				}//Fin de control check
			}
		}
				//echo "<br>sql es : ".$sql3;
				...
				$row5=mysql_fetch_array($result5);
					...
					if($systemData["conf_mail"]==2 || $systemData["conf_mail"]==3){																				
						...
						{							
						//******************
								$asunto = "Nro. $id_orden. Recordatorio de Asignacion de Orden de Trabajo";	
								$mail = $userData['email'];
								$mensaje = "
		Recordatorio de Asignacion de Orden de Trabajo: Nro. $id_orden <br>
		Cliente/Tecnico: $clienteNombre <br>
		Descripcion: $ordenTmp[desc_inc] <br>
		Complejidad: $tmpComplejidad[$nivel_asig] <br>
		Criticidad: $tmpPrioridad[$criticidad_asig] <br>
...
Para mayores detalles, consulte el Sistema GesTor F1.<br>$systemData[nombre]";
								$tunombre = $systemData['nombre'];		
								$tuemail  = $systemData['mail_institucion'];												
								$headers = "MIME-Version: 1.0\r\n"; 
								$headers .= "Content-type: text/html; charset=iso-8859-1\r\n"; 
...
//------------------------------------------------------------------------------------------------------------------------------
				...
				$sqlIns="INSERT INTO ordenes (fecha, time, cod_usr, desc_inc,tipo,nomb_archivo,area,dominio,objetivo,'ci_ruc',id_anidacion,origen,hash_archivo,observaciones) ".
				"VALUES('".date("Y-m-d")."','".date("H:i:s")."','SISTEMA','$desc','0','0','0','0','0','0','0','0','','0')"; 
...
<form action="asignacion.php" method="post" name="form1" onKeyPress="return Form()">
...
<input name="pg" type="hidden" value="<?php=$pg?>">
  ...
  <table width="95%" border="1" align="center" background="images/fondo.jpg">
    ...
    <?php  $id_ord=$_REQUEST['id_orden'];
            $sql7 = "SELECT *, DATE_FORMAT(fecha_asig, '%d/%m/%Y') AS fecha_asig, DATE_FORMAT(fechaestsol_asig , '%d/%m/%Y') AS fechaestsol_asig 
				FROM asignacion WHERE id_orden='$id_orden' OR id_orden='$id_orden'";
		$result7=mysql_query($sql7);
  ...
  <table width="80%" border="2" align="center" cellpadding="0" cellspacing="0" bordercolor="#006699" bgcolor="#F4F2EA" style="border-collapse:collapse;" background="images/fondo.jpg">
	...
	?>
          ...
          <tr align="center"> 
            <td class="normal"><strong>Asignado a:</strong> <br> <select name="asig" id="asig">
                <?php
					...
					$sql2 = "SELECT * FROM users WHERE bloquear=0 AND (tipo2_usr='T' OR tipo2_usr='A') ORDER BY apa_usr ASC";
 			  		$result2=mysql_db_query($db,$sql2,$link);
          ...
          <tr align="center" id="frm2" <?php=$display?>> 
            <td class="normal">Fecha estimada de solucion: 
...
function visualizar()
{
	...
	{
		document.form1.all.frm1.style.display = "";
		document.form1.all.frm2.style.display = "";
	}
	else{
		document.form1.all.frm1.style.display = "none";
		document.form1.all.frm2.style.display = "none";
	}
}
...
{	
		...
		if(escal == 0 || escal == asig)
		{
		  if(check)
		  {
			msg = "Debe elegir una persona distinta de vac�o o distinta del usuario asignado para realizar el escalamiento.\n";
			msg = msg + "\nMensaje generado por GesTor F1.";
			alert(msg);
			return false;
		  }
