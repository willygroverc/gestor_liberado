...
$data="<chart caption='Conformes y No Conformes' shownames='1' showvalues='1' decimals='0' numberPrefix='Ordenes '>";
////desde aqui
//==========ORDENES DE TRABAJO==========================-
...
$data.="<set label='Conforme' value='$tmp[num]'/>";

$sql="SELECT count(*) as num FROM conformidad WHERE calidaten_conf = 2 $sql_alt";
$rs = mysql_db_query($db,$sql,$link);
$tmp = mysql_fetch_array($rs);
$data.="<set label='No Conforme' value='$tmp[num]'/>";
