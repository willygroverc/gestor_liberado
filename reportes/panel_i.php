...
<!--
function ampliar(rep) {	
	window.open("report_amp.php?rep="+rep,'Reporte', 'width=950,height=700,status=no,resizable=no,top=0,left=50,dependent=yes,alwaysRaised=yes');
}
-->
</script>
...
<?php
$sql_pmi="SELECT * FROM pmi_sao WHERE id_report IN (5,7,8,27)";
...
<input name="          AMPLIAR          " type="button" class="Estilo2" id="AMPLIAR" onClick="ampliar('<?php=$row_pmi['nom_arch']?>')" value="                     AMPLIAR                     ">
<?php
echo "<td>";
if ($row_pmi[ind]<>0) include("reportes/a_i1.php");
echo "</td></tr></table></td>";
