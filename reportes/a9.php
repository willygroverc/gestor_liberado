...
$data="<chart caption='Tiempo de Ejecución de Ordenes desde el Ingreso' shownames='1' showvalues='0' decimals='0' numberPrefix='Dias '>";
...
<body bgcolor="#ffffff">
   ...
   <script type="text/javascript">
      var myChart = new FusionCharts("Charts/MSColumn3D.swf", "myChartId", "900", "300", "0", "0");
