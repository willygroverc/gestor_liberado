...
{
	$sCon = "select *from progtareasmensual WHERE IdProgTarea=$IdProgTarea";
...
if (isset($INSERTAR)){   
	...
	if(isset($action) && $action=="editar"){
		//$sql="UPDATE progtareasmensual SET Actividad='$Actividad', HoraDe='$HoraDe', HoraA='$HoraA', FechaDe='$FechaProceso', Observaciones='$Observaciones', m_asig='$cadena' WHERE IdProgTarea=$IdProgTarea";
		$sql="UPDATE progtareasmensual SET Actividad='$Actividad', HoraDe='$HoraDe', HoraA='$HoraA', FechaDe='$FechaProceso', Observaciones='$Observaciones', Dia='$Dia', m_asig='$cadena' WHERE IdProgTarea=$IdProgTarea";
	}
	else{
		$sql="INSERT INTO ".
		...
		/*$sql="INSERT INTO ".
		"progtareasmensual (Actividad, HoraDe, HoraA, FechaDe, Observaciones,m_asig) ".
...
include("top.php");
if($_GET["do"]=="editar"){
	$sql="SELECT * FROM progtareasmensual WHERE IdProgTarea=".$_GET["IdProgTarea"];
...
-->
  ...
  <form name="form2" method="post" action="prog_tareasmensualp.php" onKeyPress="return Form()">
    ...
    <table width="70%" border="1" align="center" cellpadding="2" cellspacing="0" background="images/fondo.jpg">
      <tr>
        <th colspan="9" background="images/main-button-tileR2.jpg"><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">PROGRAMACION DE TAREAS - MENSUALES<br>
      ...
      <tr>
        <td width="91" height="7" nowrap>
          <div align="center"><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif"><strong>
            <textarea name="Actividad" cols="30" rows="4" id="textarea3"><?php=$wTarea["Actividad"]?></textarea>
        </strong></font></div></td>
        ...
        <td height="7" colspan="5" nowrap>
          <div align="center"><strong><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif"><strong>
            <textarea name="Observaciones" cols="30" rows="4" id="textarea4"><?php=$wTarea["Observaciones"]?></textarea>
