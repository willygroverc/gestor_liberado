...
if($IdProgTarea <> "")
{
	$sCon = "select *from progtareastrimestral WHERE IdProgTarea=$IdProgTarea";
...
{   include("conexion.php");
	...
	if($action=="editar")
	{
		$sql="UPDATE progtareastrimestral SET Actividad='$Actividad', HoraDe='$HoraDe', HoraA='$HoraA', FechaDe='$FechaProceso', Observaciones='$Observaciones', t_asig='$cadena' WHERE IdProgTarea=$IdProgTarea";
	}
	else
	{
		$sql="INSERT INTO ".
...
include("top.php");
if($_GET["do"]=="editar"){
	$sql="SELECT * FROM progtareastrimestral WHERE IdProgTarea=".$_GET["IdProgTarea"];
...
-->
  ...
  <form name="form2" method="post" action="prog_tareastrimestralp.php" onKeyPress="return Form()">
