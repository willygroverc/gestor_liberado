...
if(isset($IdProgTarea)){
	$sCon = "select *from progtareassemanal WHERE IdProgTarea=$IdProgTarea";
...
if (isset($INSERTAR)){   
	...
	$HoraA="$Hora2:$Min2";
	if($action=="editar"){
		//$sql="UPDATE progtareassemanal SET Actividad='$Actividad', HoraDe='$HoraDe', HoraA='$HoraA', FechaDe='$FechaProceso', Observaciones='$Observaciones', s_asig='$cadena' WHERE IdProgTarea=$IdProgTarea";
		$sql="UPDATE progtareassemanal SET Actividad='$Actividad', HoraDe='$HoraDe', HoraA='$HoraA', FechaDe='$FechaProceso', Observaciones='$Observaciones', Dia='$Dia', s_asig='$cadena' WHERE IdProgTarea=$IdProgTarea";
	}
	else{
		$sql="INSERT INTO ".
		"progtareassemanal (Actividad, HoraDe, HoraA, FechaDe, Observaciones, Dia, s_asig) ".
		"VALUES ('$Actividad','$HoraDe','$HoraA','$FechaProceso','$Observaciones', '$Dia','$cadena')";
		
		/*$sql="INSERT INTO ".
		"progtareassemanal (Actividad, HoraDe, HoraA, FechaDe, Observaciones,s_asig) ".
...
if(isset($_GET["do"]) && $_GET["do"]=="editar"){
	$sql="SELECT * FROM progtareassemanal WHERE IdProgTarea=".$_GET["IdProgTarea"];
...
-->
  ...
  <form name="form2" method="post" action="prog_tareassemanalp.php" onKeyPress="return Form()">
    ...
    <table width="70%" border="1" align="center" cellpadding="2" cellspacing="0" background="images/fondo.jpg">
      ...
      <th colspan="9" background="images/main-button-tileR1.jpg"><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">PROGRAMACION 
        DE TAREAS - SEMANALES <br>
                    <?php if(isset($_GET["do"]) && $_GET["do"]=="editar") echo  "Editando: Nro. $IdProgTarea";
				else echo  "Registro Nuevo"; ?>
        </font></th>
      </tr>
      <tr>
        <th height="60" colspan="9" background="images/main-button-tileR2.jpg">
      ...
      <tr>
        <td width="91" height="7" nowrap>
          <div align="center"><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif"><strong>
            <textarea name="Actividad" cols="30" rows="4" id="textarea3"><?phpif (isset($wTarea["Actividad"]))echo $wTarea["Actividad"];?></textarea>
        </strong></font></div></td>
        <td height="3" nowrap><div align="center"><strong>
            <select name="Hora1">
			  ...
			  for($i=1;$i<=24;$i++)
				{ echo "<option value=\"$i\"";
				if($i==substr($wTarea["HoraDe"],0,2)) echo  "selected";
				echo  ">$i</option>"; }
			   ?>
            </select>
        -
        <select name="Min1">
          <?php for($i=0; $i<=60; $i=$i+5){
					echo  "<option value=\"$i\"";
					if($i==substr($wTarea["HoraDe"],3,2)) echo  "selected";
					echo  ">$i</option>";
				} ?>
        </select>
        </strong></div></td>
        <td height="7" nowrap><div align="center"><strong>
            <select name="Hora2">
			  ...
			  for($i=1;$i<=24;$i++)
				{echo "<option value=\"$i\"";
				if($i==substr($wTarea["HoraA"],0,2)) echo  "selected";
				echo  ">$i</option>";}
			   ?>
            </select>
        -
        <select name="Min2">
          <?php for($i=0; $i<=60; $i=$i+5){
					echo  "<option value=\"$i\"";
					if($i==substr($wTarea["HoraA"],3,2)) echo  "selected";
					echo  ">$i</option>";
				} ?>
        </select>
        </strong></div></td>
        <td align="center" nowrap><strong>
          <select name="Dia" id="Dia">
			<?php $wDia=array("Domingo", "Lunes", "Martes", "Miercoles", "Jueves", "Viernes", "Sabado"); 
				foreach($wDia as $key => $tmp){
					echo  "<option value=\"$tmp\"";
					if($tmp==$wTarea["Dia"]) echo  "selected";
					echo  ">".$tmp."</option>";
			}
			?>
		</select>
        ...
        <td height="7" colspan="5" nowrap>
          <div align="center"><strong><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif"><strong>
            <textarea name="Observaciones" cols="30" rows="4" id="textarea4"><?php if (isset($wTarea["Observaciones"])) echo $wTarea["Observaciones"];?></textarea>
 ...
 <tr>
 	<td colspan="8" align="center" valign="middle">
      ...
      <tr>
        <td height="28" colspan="9" nowrap>
          <div align="center"><br>
              <input name="INSERTAR" type="submit" id="INSERTAR2" value="INSERTAR" <?php echo  $valid->onSubmit() ?>>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
