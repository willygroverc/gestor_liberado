...
if(!isset($varia2)){$varia2="INF";}
if(!isset($varia3)){$varia3="CIN";}
if(!isset($varia4)){$varia4="APP";}
?>
<script language="JavaScript">
      ...
      <td height="150"> 
        <table width="100%" border="2" align="center" cellpadding="2" cellspacing="4" background="images/fondo.jpg">
          ...
          <tr> 
            ...
            <th width="203" nowrap background="images/main-button-tileR2.jpg"><font size="1" face="Arial, Helvetica, sans-serif" color="#FFFFFF">FECHA 
              ALTA </font></th>
		 ...
		 ?>
          ...
          <tr> 
            ...
            <td width="203" nowrap height="3"><div align="center"><strong><font size="2" face="Verdana, Arial, Helvetica, sans-serif"> 
				...
				for($i=1;$i<=31;$i++)
				{
                if (isset($Cod)){echo "<option value=\"$i\"";if($Dia=="$i")echo "selected";echo">$i</option>";
				}else{
				...
				for($i=1;$i<=12;$i++)
					  {
					  if (isset($Cod)){echo "<option value=\"$i\"";if($Mes=="$i")echo "selected";echo">$i</option>";
						}else{
			   ...
			   ?>
                ...
                <select name="AnoA" id="select3">
                  <?php for($i=2002;$i<=2020;$i++)
				      {
					   if (isset($Cod)){echo "<option value=\"$i\"";if($Ano=="$i")echo "selected";echo">$i</option>";
						}else{
			...
			<td height="7" align="center">
                <textarea name="Observ" cols="30" rows="2"><?php if (isset($obs)) echo $Obs?></textarea>
            </td>
          </tr>
          <tr> 
