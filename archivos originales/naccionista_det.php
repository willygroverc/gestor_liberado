...
{	
		...
		$sql="INSERT INTO acciones (id_ac, serie_ac,valor_ac,fecas_ac,num_ac,id_acc,class_ac) VALUES ('$id_ac','$serie_ac','$valor_ac','$fecas_ac','$num_ac','$num','$class_ac')";
		}
		else
		{
...
?>">Modificar</div></td>
  ...
  <table width="75%" border="2" align="center" cellpadding="2" cellspacing="0" background="images/fondo.jpg">
    ...
    <tr> 
      <td height="7" nowrap bgcolor="#006699"><select name="selecciona" onChange="cambia(this.value)">
        ...
        <?php 
			...
			{	
				...
				if(isset($np) && $np==$row_r['id_ac']){echo "selected";}
	  ...
	  <td><div align="center"><input name="class_ac" type="text" value="<?php if(isset($row_ed['class_ac'])) echo $row_ed['class_ac']; else echo "Ordinaria";?>" size="15" /></div></td>
    </tr>
    <tr> 
