...
if(isset($elim_ficha)){
	...
	mysql_query($sql);
	header("location: lista_ficha.php?Naveg=Soporte%20Tecnico%20>>%20Fichas%20Tecnicas");
}
if (valida("FichasTecnicas")=="bad") {header("location: pagina_error.php");}
if (isset($RETORNAR))
{
	//header("location: lista1_ficha.php?Naveg=Soporte Tecnico");
	echo "<script type=\"text/javascript\">
           history.go(-2);
       </script>";
}
if (isset($NueFicha)){ header("location: ficha_tecnica.php");}
include ("top.php");
...
<form name="form1" method="post" action="" onKeyPress="return Form()">
  <table width="80%" align="center">
    <tr>
      <td bgcolor="#006699" background="windowsvista-assets1/main-button-tile.jpg" height="30"><div align="center"><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif"><strong>Busqueda 
          de ficha tecnica :</stron></font> 
          <select name="campo">
            <option value="TpRegFicha"<?php if (isset($campo) && ($campo=="TpRegFicha" OR $campo=="")){echo "selected";}?>>TIPO REGISTRO</option>
            <option value="CodActFijo" <?php if (isset($campo)  && $campo=="CodActFijo"){echo "selected";}?>>COD. ACTIVO FIJO</option>
            <option value="Modelo" <?php if (isset($campo)  && $campo=="Modelo"){echo "selected";}?>>MODELO</option>
            <option value="AdicUSI" <?php if (isset($campo)  && $campo=="AdicUSI"){echo "selected";}?>>CODIGO ADICIONAL</option>
          </select>
          &nbsp;&nbsp;&nbsp; 
  ...
  <tr> 
      <td height="68" valign="top"> 
        ...
        <tr> 
          <th colspan="15" bgcolor="#006699" background="images/main-button-tileR2.jpg" height="30"><font face="Arial, Helvetica, sans-serif" color="#FFFFFF">REGISTRO 
            DE FICHAS TECNICAS</font></th>
        </tr>
        <tr> 
          <th width="30" rowspan="2" align="\&quot;center\&quot;" background="images/main-button-tileR2.jpg"><font face="Arial, Helvetica, sans-serif" color="#FFFFFF" size="1">N° 
            FICHA</font></th>
          <th width="64" rowspan="2" align="\&quot;center\&quot;" background="images/main-button-tileR2.jpg"><font face="Arial, Helvetica, sans-serif" color="#FFFFFF" size="1">FECHA 
            REALIZACION</font></th>
          <th width="90" rowspan="2" background="images/main-button-tileR2.jpg"><font face="Arial, Helvetica, sans-serif" color="#FFFFFF" size="1">TIPO<br>
            REGISTRO</font></th>
          <th width="70" rowspan="2" align="\&quot;center\&quot;" background="images/main-button-tileR2.jpg"><font face="Arial, Helvetica, sans-serif" color="#FFFFFF" size="1">CODIGO 
              ACTIVO FIJO</font></th>
          <th width="70" rowspan="2" align="\&quot;center\&quot;" background="images/main-button-tileR2.jpg"><font face="Arial, Helvetica, sans-serif" color="#FFFFFF" size="1">CODIGO 
              ADICIONAL</font></th>
          <th width="68" rowspan="2" align="\&quot;center\&quot;" background="images/main-button-tileR2.jpg"><font face="Arial, Helvetica, sans-serif" color="#FFFFFF" size="1">MODELO</font></th>
          <th width="82" rowspan="2" align="\&quot;center\&quot;" background="images/main-button-tileR2.jpg"><font face="Arial, Helvetica, sans-serif" color="#FFFFFF" size="1">ASIGNADO 
            A </font></th>
          <th width="60" rowspan="2" align="\&quot;center\&quot;" background="images/main-button-tileR2.jpg"><font color="#FFFFFF" size="1" face="Arial, Helvetica, sans-serif"> 
            <?php print $help->AddLink("fechaRecepcion","FECHA RECEPCION"); ?></font></th>
          <th width="71" rowspan="2" align="\&quot;center\&quot;" background="images/main-button-tileR2.jpg"><font color="#FFFFFF" size="1" face="Arial, Helvetica, sans-serif"> 
            <?php print $help->AddLink("fechaDevolucion","FECHA DEVOLUCION") ?></font></th>
          <?php if (isset($tipo) && ($tipo=="A" or $tipo=="B")) {?>
		  <th width="62" rowspan="2" align="\&quot;center\&quot;" background="images/main-button-tileR2.jpg"><font color="#FFFFFF" size="1" face="Arial, Helvetica, sans-serif">MODIFICAR 
            FICHA </font></th>
          <?php } ?>
          <th width="80" rowspan="2" align="\&quot;center\&quot;" background="images/main-button-tileR2.jpg"><font color="#FFFFFF" size="1" face="Arial, Helvetica, sans-serif">MANTENIMIENTO 
            </font></th>
          <th width="70" rowspan="2" align="\&quot;center\&quot;" background="images/main-button-tileR2.jpg"><font color="#FFFFFF" size="1" face="Arial, Helvetica, sans-serif">CRONOGRAMA</font></th>
          <th height="13" colspan="2" align="\&quot;center\&quot;" background="images/main-button-tileR2.jpg"><font color="#FFFFFF" size="1" face="Arial, Helvetica, sans-serif">VISTA 
            DE IMPRESION</font></th>
			<th width="68" rowspan="2" align="\&quot;center\&quot;" background="images/main-button-tileR2.jpg"><font face="Arial, Helvetica, sans-serif" color="#FFFFFF" size="1">DAR DE BAJA</font></th>
        </tr>
        <tr align=\"center\"> 
          <th width="65" height="24" background="images/main-button-tileR2.jpg"><font color="#FFFFFF" size="1" face="Arial, Helvetica, sans-serif">FICHA 
            TECNICA </font></th>
          <th width="67" background="images/main-button-tileR2.jpg"><font color="#FFFFFF" size="1" face="Arial, Helvetica, sans-serif">CUSTODIO</font></th>
        </tr>
...
//////
	echo "<td onclick=\"eliminar_ficha('$row[IdFicha]')\">&nbsp;<a href=\"#\"><img src=\"images/eliminar.gif\" border=\"0\" alt=\"Eliminar Ficha\"></a></font></td>";
	echo "</tr>";
}
?>
      </table></td>
...
<div align="right"><a href="lista_ficha_baja.php">Ver Fichas Dadas de Baja &gt;&gt;&gt;</a> 
</div>
