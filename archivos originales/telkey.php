...
if (isset($RETORNAR)){header("location: lista_telkey.php");}
if (isset($reg_form)){ 
	if ($opcion1=="S")
	{
...
//	$id=$id+1;
	...
	$sql="INSERT INTO ".
	"telkey (idtelkey,Responsable,Cuenta,Tipo,Sistema,Fechaen,Fechare,Reemplazo,Observaciones) ".
	"VALUES ('$id','$Responsable','$Cuenta','$Tipo','$Sistema','$Fechaentrada','$Fecharetiro','$Reemplazo','$Observ')";
	mysql_query($sql);
	//$var1=$id+1;
	header("location: telkey.php?varia1=$var1");
}
else {
include("top.php");
echo "<p>";
...
{	 $fsistema=date("Y-m-d");
	...
	$d1=substr($fsistema,8,2);}
          ...
          <tr>
            <td>&nbsp;</td>
            <td  background="images/main-button-tileR1.jpg" height="22" align="center"><div align="center" class="style1">OBSERVACIONES</div></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
