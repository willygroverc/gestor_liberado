...
<table width="100%" border="2" align="center">
  <tr bgcolor="#CCCCCC"> 
    <td width="2%" rowspan="2"><div align="center"><span class="titulo2"><span class="style1">N.</span><font size="1">-</font></font></span></div></td>
...
<div align="center"><font size="1">1</font></div></td>
    ...
    <td><div align="center" class="titulo2" >
      <?php if ($row5['FeProIni'] == "00 / 00 / 0000") echo "&nbsp"; else echo $row5['FeProIni'];?>
    </div></td>
    <td><div align="center" class="titulo2"><strong>&nbsp;</strong>
      <?php if ($row5['FeProTer'] == "00 / 00 / 0000") echo "&nbsp"; else echo $row5['FeProTer'];?>
    </div></td>
