...
<script language="JavaScript" src="js/tareas_semanal.js"></script>
...
echo '<form name="frm_semanal" id="frm_semanal" action="#" method="POST">
<input name="IdProgTarea" type="hidden" id="IdProgTarea" value="'; echo $IdProgTarea; echo '">
    ...
    <table width="70%" border="1" align="center" cellpadding="2" cellspacing="0" background="images/fondo.jpg">
      ...
      <th colspan="10" background="images/main-button-tileR1.jpg"><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">PROGRAMACION 
        DE TAREAS - SEMANAL<br>';
		if(isset($_GET["do"]) && $_GET["do"]=="editar") echo "Editando: Nro. $IdProgTarea";
				else echo "Registro Nuevo"; 
      echo '</font></th>
      </tr>
      <tr>
        <th height="50" colspan="10" background="images/main-button-tileR2.jpg">
      ...
      <tr align="center">
        ...
        <th width="282" colspan="6" rowspan="2" background="images/main-button-tileR2.jpg"><font size="2" face="Arial, Helvetica, sans-serif" color="#FFFFFF">Dia</font></th>
		<th width="282" colspan="6" rowspan="2" background="images/main-button-tileR2.jpg"><font size="2" face="Arial, Helvetica, sans-serif" color="#FFFFFF">Observaciones</font></th>
	  </tr>
      <tr align="center">
      ...
      <tr>
        ...
        <td align="center" nowrap><strong>
          <select name="Dia" id="Dia">';
				$wDia=array("Domingo", "Lunes", "Martes", "Miercoles", "Jueves", "Viernes", "Sabado"); 
      ...
      <tr>
        <td height="28" colspan="10" nowrap>
          <div align="center"><br>
            <input name="INSERTAR" type="button" id="INSERTAR2" value="INSERTAR" onclick="guardar_semanal();">
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
