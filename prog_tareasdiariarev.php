...
<table width="95%" border="1" align="center" cellpadding="2" cellspacing="0" background="images/fondo.jpg">
  <tr>
    <th colspan="7" bgcolor="#006699"><font color="#FFFFFF" size="3" face="Arial, Helvetica, sans-serif">PROGRAMACION DE TAREAS - DIARIAS</font></th>
  </tr>
  <tr align="center">
	...
	<th width="162" rowspan="2" bgcolor="#006699"><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">Asignado a</font></th>
  </tr>
  <tr align="center">
...
<table width="80%"  border="1" align="center" cellpadding="2" cellspacing="0" background="images/fondo.jpg">
  <tr align="center">
    <th colspan="9"><font size="3">REALIZACION&nbsp;/&nbsp;REVISION</font></th>
  </tr>
  <tr align="center">
    ...
    <th><font size="2">Archivos adjuntos</font></th>
  </tr>
<?php
...
if(isset($menu) && $menu=='realizado'){
	...
	$_pagi_sqlConta = "SELECT count(*) AS pagi_totalReg FROM progtareasdiaria1 WHERE IdProgTarea='$IdProgTarea' $cond";
	...
	$_pagi_inicial = ($_pagi_actual-1) * $_pagi_cuantos;
		...
		FROM progtareasdiaria1 WHERE IdProgTarea='$IdProgTarea' $cond ORDER BY IdProgTarea1 DESC LIMIT $_pagi_inicial,$_pagi_cuantos";
		$rs=mysql_query($sql);
		echo mysql_error();
		while($tmp=mysql_fetch_array($rs)){
			echo "<tr>";
			...
			if($tmp["Revisado"]==1) echo '<td align="center"><img src="images/ok.gif" border="0"></td>';
			else {
				if($_SESSION['tipo']=="A"  || $tmp['RealizadoPor']!=$_SESSION['login']) 
				echo '<td align="center"><a href="prog_tareasdiariarev.php?do=revisar&IdProgTarea='.$IdProgTarea.'&IdProgTarea1='.$tmp['IdProgTarea1'].'"><img src="images/no3.gif" border="0"></a></td>';
				else echo '<td align="center"><img src="images/no2.gif" border="0"></td>';
			}
			$valor=$tmp['adjunto'];
			echo "<td align='center'><a href=\"adjuntos/".$valor."\" target=\"_blank\">$valor</a></td>";
			echo "</tr>";
		}
  		 ?>  
</table>
...
<form action="prog_tareasdiariarev.php" method="get" name="form2" id="form2" onKeyPress="return Form()">
	<input name="IdProgTarea" type="hidden" value="<?php echo $IdProgTarea;?>">
	<input name="IdProgTarea1" type="hidden" id="IdProgTarea1" value="<?php if (isset($_GET['IdProgTarea1'])) echo $_GET['IdProgTarea1'];?>">
	<input name="action" type="hidden" id="action" value="<?php $do=SanitizeString($do); if (isset($do))echo $do;?>">
	<input name="pg" type="hidden" id="pg" value="<?php if(isset($pg)) echo $pg;?>"> 
	<?php if(isset($do) && $do =="revisar"){?>
	<table width="80%"  border="1" align="center" cellpadding="2" cellspacing="0" background="images/fondo.jpg">
    <tr align="center">
    ...
    <tr align="center">
	  ...
	  <?php 
			...
			echo '<td>&nbsp;'.$row3['nom_usr'].' '.$row3['apa_usr'].' '.$row3['ama_usr'].'</td>';?>
...
&nbsp;
      ...
      NA</font> </td>
      <td><font size="2" face="Arial, Helvetica, sans-serif">
        <textarea name="Observaciones" cols="15" id="Observaciones"><?php echo @$row3['Observac'];?></textarea>  <!-- variable $row3['OBSERVAC'] NO ESTA DEFINIDA-->
      </font></td>
    </tr>
    <tr align="center">
      <td height="50" colspan="4">
        <input name="INSERTAR" type="submit" id="INSERTAR" value="INSERTAR REVISION"<?php echo $valid->onSubmit() ?>>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <table width="80%"  border="1" align="center" cellpadding="2" cellspacing="0" background="images/fondo.jpg">
    <tr align="center">
      <th colspan="5"><font size="3">REALIZACION</font></th>
    </tr>
    <tr align="center">
      <th><font size="2">Realizado por </font></th>
      <th><font size="2">Realizacion</font></th>
      <th><font size="2">Observaciones</font></th>
      <th><font size="2">Adjuntos</font></th>
    </tr>
    <tr align="center">
      <!-- <td><?php echo $lstUsuario[$_SESSION['login']];?></td>-->
	  <?php 	
		  	$sql4 = "SELECT * FROM users WHERE login_usr='$_SESSION[login]'";
		  	$result4 = mysql_query($sql4);
		  	$row4 = mysql_fetch_array($result4);
			echo '<td>&nbsp;'.$row4['nom_usr'].' '.$row4['apa_usr'].' '.$row4['ama_usr'].'</td>';?>
	  
      <td> <font size="2" face="Arial, Helvetica, sans-serif">
        <input name="Aprobacion" type="radio" value="SI" checked <?php if (@$row3['Aprobacion']=="SI") echo "checked";?>> <!-- variable $row3['Aprobacion'] NO ESTA DEFINIDA-->
      SI</font> <font size="2" face="Arial, Helvetica, sans-serif"><br>
&nbsp;
      <input type="radio" name="Aprobacion" value="NO" <?php if (@$row3['Aprobacion']=="NO") echo "checked";?>> <!-- variable $row3['Aprobacion'] NO ESTA DEFINIDA-->
      NO</font> <font size="2" face="Arial, Helvetica, sans-serif"><br>
&nbsp;
      <input type="radio" name="Aprobacion" value="NA" <?php if (@$row3['Aprobacion']=="NA") echo "checked";?>> <!-- variable $row3['Aprobacion'] NO ESTA DEFINIDA-->
      NA</font> </td>
      <td><font size="2" face="Arial, Helvetica, sans-serif">
        <textarea name="Observaciones" cols="15" id="Observaciones"><?php echo @$row3['Observac'];?></textarea>  <!-- variable $row3['OBSERVAC'] NO ESTA DEFINIDA-->
      </font></td>
	  <td><input name="archivo" type="file" size="60" value="<?php print @$archivo ?>" onClick="msgFile()"></td>
    </tr>
    <tr align="center">
      <td height="50" colspan="5">
        <input name="INSERTAR" type="submit" onClick="Mensaje()" id="INSERTAR" value="INSERTAR REALIZACION" <?php echo $valid->onSubmit() ?>>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <input type="submit" name="Terminar" value="RETORNAR"></td>
    </tr>
  </table>
...
<?php
	...
	$msg =  "El usuario ".$_SESSION['login']." ya registro la Realizacion de Tarea de hoy\\n\\n\tMensaje generado por GesTor F1.";	
	if ($sw == 1 )
	{	echo "alert(\"$msg\");";
		echo " return false; "; 
	}	
...
function enviar(){
	...
	open("report_tarea.php?IdProgTarea="+IdProgTarea+"&tarea=diaria","TAREAS",'width=590,height=200,status=no,resizable=no,toolbars=no,top=0,left=250,dependent=yes,alwaysRaised=yes')
}
-->	
</script>
<?php
