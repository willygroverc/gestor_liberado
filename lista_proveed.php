...
// LA VERSION 2.0 TIENE CAMBIOS QUE DESCRIBE 
// Version: 	2.0
...
//_____________________________________________________________________________
//PERO VERIFICANDO CODIGO LOS CODIGOS QUE HACEN REFERENCIA A CONSULTAS SQL NO SON VALIDAS LA TABLA T_SERVICIO NO EXISTE 
//EN LA BASE DE DATOS
//SE TOMO LA VERSION 1.0 QUE FUNCIONA CORRECTAMENTE
@session_start();
@session_start();
...
if (isset($_REQUEST['accion'])=="elimina")
{	
    $IdProv=$_GET['IdProv'];
    ...
    <tr> 
      <td width="60%" background="windowsvista-assets1/main-button-tile.jpg" height="30px"><div align="center"><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif"><strong>Busqueda 
          ...
          <select name="menu" id="menu">
            ...
            <option value="prov" <?php  if ($menu=="prov"){echo "selected";}?>>NOM. PROVEEDOR</option>
          </select>
          &nbsp;&nbsp;&nbsp; 
...
<table width="95%"border="1" cellpadding="0" cellspacing="2" background="images/fondo.jpg">
	...
	<tr align=\"center\"> 
	  <th class="menu" background="images/main-button-tileR1.jpg"><?php  print $help->AddLink("num", "N�"); ?></th>
