  ...
  <table width="80%" border="1" align="center" bgcolor="#006699">
    <tr> 
      <td width="60%"><div align="center"><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif"><strong>Busqueda 
		  ...
		  <?php }else{?>
		  <input name="selecta" type="text" size="5" maxlength="5" value="">
		  <?php }?>&nbsp;&nbsp;
          <input name="BUSCAR" type="submit" id="BUSCAR" value="BUSCAR">
        </div></td>
	    </tr>
...
while ($row=mysql_fetch_array($result)) {
	...
	echo "<td><font size=\"1\" face=\"Arial, Helvetica, sans-serif\">&nbsp;<a href=\"ver_fichatecnica_.php?IdFicha=".$row[IdFicha]."\" target=\"_blank\"><img src=\"images/imprimir.gif\" border=\"0\" alt=\"Imprimir Ficha Tecnica\"></a></font></td>";
