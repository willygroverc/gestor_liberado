...
if (isset($cmdnuevo)) { header("location:servicio_nuevo.php?pg=$pg"); }

if(isset($elim) && $elim=='ok')
{
	
			$sql_eli="DELETE FROM t_servicio WHERE servicio_cod='$servicio_cod'";
			mysql_query($sql_eli);
			
			$cont="NULL";
			$sql="SELECT * FROM t_servicio2 WHERE servicio_cod ='$servicio_cod'";
			$res=mysql_query($sql);
			...
			$sql_eli1="DELETE FROM t_servicio2 WHERE servicio_cod='$servicio_cod'"; 
...
<table  width="80%" border="1" background="images/fondo.jpg" >
  ...
  <?php
	...
	$_pagi_sqlConta = "SELECT count(*) AS pagi_totalReg FROM t_servicio";
	...
	$sql="SELECT * FROM t_servicio LIMIT $_pagi_inicial,$_pagi_cuantos";
  ...
  <tr> 
    ...
    <td><div align="center"><?php echo $servicio['servicio_nombre']; ?></div></td>
    <td><div align=""><span>&nbsp;<?php echo $servicio['servicio_desc']; ?></span></div></td>
    <!--<td><div align="center"><?php echo "<a href=area_nuevo.php?Naveg=Modificacion%20Areas&cod=".$area['servicio_cod']."&pg=".@$pg."><img src=images/editar.gif width=16 height=14 border=0></a>"; ?></div></td>-->
    <td><div align="center"><?php echo "<a href=Servicio.php?elim=ok&Naveg=Areas&servicio_cod=".$servicio['servicio_cod']."&pg=".@$pg." onclick=\"return elimina('$area[area_cod]','$area[area_nombre]')\"><img src=images/eliminar.gif width=16 height=14 border=0></a>"; ?></div></td>
  ...
  <table width="75%" border="0">
    <tr> 
      <td width="47%"> <div align="center"> 
          <input name="cmdnuevo" type="submit" id="cmdnuevo" value="NUEVO NIVEL SERVICIO">
		  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          </div></td>
    </tr>
  </table>
