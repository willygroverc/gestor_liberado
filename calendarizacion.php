...
{	require("conexion.php");
	...
	$var1=_clean($var1);
	$row6['AdicUSI']=_clean($row6['AdicUSI']);
	$fecha_del=_clean($fecha_del);
	$fecha_al=_clean($fecha_al);
	
	$var1=SanitizeString($var1);
	$row6['AdicUSI']=SanitizeString($row6['AdicUSI']);
	$fecha_del=SanitizeString($fecha_del);
	$fecha_al=SanitizeString($fecha_al);
	$sql3="INSERT INTO ".
	"calenmantplanif  (id_cmant,AdicUSI,estado,fecha_del,fecha_al,Observ,orden,elim) ".
	"VALUES ('$var1','$row6[AdicUSI]','Planificado','$fecha_del','$fecha_al','','0','0')";
	//echo $sql3;
	mysql_query($sql3);
	$var1=$var1+1;
	}
...
<table width="95%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#006699"  background="images/fondo.jpg" bgcolor="#EAEAEA">
  <form name="form2" method="get" action="<?php echo $PHP_SELF ?> " onKeyPress="return Form()">
	...
	<input  type= "hidden" name="usr2"  value=<?php if (isset($usr))echo @$usr;?>>
	<tr> 
      <td>
        <table width="100%" border="2" align="center" cellpadding="2" cellspacing="4">
           <tr bgcolor="#006699"> 
            <td colspan="15" background="images/main-button-tileR1.jpg"> <div align="center"><font size="2" face="Arial, Helvetica, sans-serif" color="#FFFFFF"><strong> 
                CALENDARIZACION DE MANTENIMIENTO </strong></font></div></td>
          </tr>
          <tr bgcolor="#006699"> 
            <th colspan="2" height="42" background="images/main-button-tileR2.jpg"><div align="center"><font color="#FFFFFF" size="1" face="Arial, Helvetica, sans-serif">Codigo Adicional</font></div></th>
            <th width="66" rowspan="2" height="10" background="images/main-button-tileR2.jpg"><font color="#FFFFFF" size="1" face="Arial, Helvetica, sans-serif">Estado</font></th>
            <th colspan="3" background="images/main-button-tileR2.jpg"><font color="#FFFFFF" size="1" face="Arial, Helvetica, sans-serif">Cuatrimestre1</font></th>
            <th colspan="3" background="images/main-button-tileR2.jpg"><font color="#FFFFFF" size="1" face="Arial, Helvetica, sans-serif">Cuatrimestre2</font></th>
            <th colspan="3" background="images/main-button-tileR2.jpg"><font color="#FFFFFF" size="1" face="Arial, Helvetica, sans-serif">Cuatrimestre3</font></th>
			<th colspan="3" background="images/main-button-tileR2.jpg"><font color="#FFFFFF" size="1" face="Arial, Helvetica, sans-serif">Cuatrimestre4</font></th>
          </tr>
          <tr bgcolor="#006699"> 
            <th width="142" background="images/main-button-tileR1.jpg"><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">DE</font></th>
            <th width="142" background="images/main-button-tileR1.jpg"><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">AL</font></th>
            <th width="33" background="images/main-button-tileR1.jpg"><font color="#FFFFFF" size="1" face="Arial, Helvetica, sans-serif">Ene</font></th>
            ...
            <th width="33" background="images/main-button-tileR1.jpg"><font color="#FFFFFF" size="1" face="Arial, Helvetica, sans-serif">Mar</font></th>
            <th width="34" background="images/main-button-tileR1.jpg"><font color="#FFFFFF" size="1" face="Arial, Helvetica, sans-serif">Abr</font></th>
            <th width="33" background="images/main-button-tileR1.jpg"><font color="#FFFFFF" size="1" face="Arial, Helvetica, sans-serif">May</font></th>
            <th width="33" background="images/main-button-tileR1.jpg"><font color="#FFFFFF" size="1" face="Arial, Helvetica, sans-serif">Jun</font></th>
            <th width="34" background="images/main-button-tileR1.jpg"><font color="#FFFFFF" size="1" face="Arial, Helvetica, sans-serif">Jul</font></th>
            ...
            <th width="37" background="images/main-button-tileR1.jpg"><font color="#FFFFFF" size="1" face="Arial, Helvetica, sans-serif">Sept</font></th>
            <th width="33" background="images/main-button-tileR1.jpg"><font color="#FFFFFF" size="1" face="Arial, Helvetica, sans-serif">Oct</font></th>
            <th width="33" background="images/main-button-tileR1.jpg"><font color="#FFFFFF" size="1" face="Arial, Helvetica, sans-serif">Nov</font></th>
            <th width="35" background="images/main-button-tileR1.jpg"><font color="#FFFFFF" size="1" face="Arial, Helvetica, sans-serif">Dic</font></th>
          </tr>
          <?php
		 ...
		 ?>
          <tr align="center"> 
			...
			{	$lstTecnico[$tmp['IdFicha']]=$tmp['nombre'];}
			  ...
			  {	
			  	if(!empty($lstTecnico[$row9['IdFicha']]))	{
          ...
          <tr> 
			...
			{	$lstTecnico[$tmp['IdFicha']] = $tmp['nombre'];}
			  ...
			  while ($row = mysql_fetch_array($result)) 
			  {
				...
				if (!isset($usr)) $usr = "No asignado"; 			
				if (isset($odActFijo) && $row['CodActFijo']==$CodActFijo)
            ...
            <td align="center"  nowrap><strong> 
			  ...
			  {	
			  	$usr = $lstTecnico[$row['IdFicha']];
				if (!isset($usr)) $usr = "No asignado";
				if (isset($CodActFijo) && $row['CodActFijo']==$CodActFijo)
				 			echo "<option value=\"$row[AdicUSI]\" selected>$row[AdicUSI] [".$usr."]</option>";
				   else
							echo "<option value=\"$row[AdicUSI]\">$row[AdicUSI] [".$usr."]</option>";
	            }
            ...
            <td colspan="15" nowrap> <div align="center"><br>
                <table width="75%" border="0">
                  <tr> 
                    ...
                    <td align="center"><input name="CodActFijo" type="hidden" value="<?phpif (isset($CodActFijo)) echo $CodActFijo;?>"> 
