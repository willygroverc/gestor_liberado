<?php if ($Terminar) header("location: lista_progtareas2.php");

include("conexion.php");
require_once('funciones.php');
if($IdProgTarea <> "")
{
	$sCon = "select *from progtareasanual WHERE IdProgTarea=$IdProgTarea";
...
{   include("conexion.php");
	...
	if($action=="editar")
	{
		...
		$sql="UPDATE progtareasanual SET Actividad='$Actividad', HoraDe='$HoraDe', HoraA='$HoraA', FechaDe='$FechaProceso', Observaciones='$Observaciones', Dia='$Dia', a_asig='$cadena' WHERE IdProgTarea=$IdProgTarea";
	}
	else
	{
		$Actividad=SanitizeString($Actividad);
		...
		$cadena=SanitizeString($cadena);
		$sql="INSERT INTO ".
		"progtareasanual (Actividad, HoraDe, HoraA, FechaDe, Observaciones, Dia, a_asig) ".
		"VALUES ('$Actividad','$HoraDe','$HoraA','$FechaProceso','$Observaciones', '$Dia','$cadena')";
...
include("top.php");
if($_GET["do"]=="editar"){
	$sql="SELECT * FROM progtareasanual WHERE IdProgTarea=".$_GET["IdProgTarea"];
...
-->
  ...
  <form name="form2" method="post" action="prog_tareasanualp.php" onKeyPress="return Form()">
    ...
    <table width="70%" border="1" align="center" cellpadding="2" cellspacing="0" background="images/fondo.jpg">
      <tr>
        <th colspan="10" background="images/main-button-tileR1.jpg"><font color="#FFFFFF" size="3" face="Arial, Helvetica, sans-serif">PROGRAMACION DE TAREAS - ANUALES<br>
      ...
      <tr>
        ...
        <td align="center" nowrap><strong><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong><font size="2" face="Verdana, Arial, Helvetica, sans-serif">
          <select name="DiaR" id="DiaR" >
            <?php if($_GET["do"]=="editar"){					
							$a1=substr($wTarea["Dia"],0,4);
							$m1=substr($wTarea["Dia"],5,2);
							$d1=substr($wTarea["Dia"],8,2);
						}
						else {
							$fsist=date("Y-m-d");
							$a1=substr($fsist,0,4);
        ...
        <select name="AnoR" id="AnoR">
          <?php for($i=2003;$i<=2020;$i++)
				      {echo "<option value=\"$i\""; if($a1=="$i") echo "selected"; echo">$i</option>";}
				?>
                </select>
        <font color="#FFFFFF" size="1" face="Arial, Helvetica, sans-serif"><strong><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong><strong><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong><strong><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong><strong><font color="#FFFFFF" size="1" face="Arial, Helvetica, sans-serif"><strong><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong><font size="2" face="Arial, Helvetica, sans-serif"><a href="javascript:cal1.popup();"><img src="images/cal.gif" width="16" height="16" border="0" alt="Haga click para seleccionar una fecha"></a></font></strong></font></strong></font></strong></font></strong></strong></font></strong></strong></font></strong></strong></font></strong></font></font></strong></font></strong></td>
  ...
  <script language="JavaScript">
		<!-- 
		 ...
		 var cal = new calendar1(document.forms[form].elements['DiaP'], document.forms[form].elements['MesP'], document.forms[form].elements['AnoP']);
			...
			cal.time_comp = false;
		var cal1 = new calendar1(document.forms[form].elements['DiaR'], document.forms[form].elements['MesR'], document.forms[form].elements['AnoR']);
