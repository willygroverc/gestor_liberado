<?php
include ("top_ver.php");
$sql="SELECT *,DATE_FORMAT(FechaDe,'%d / %m / %Y') as FechaDe FROM progtareastrimestral ORDER BY Mes, Dia ASC";
...
<table width="100%" border="0">
  <tr>
    <td><div align="center"><font size="4" face="Arial, Helvetica, sans-serif"><strong><u>LISTA DE TAREAS TRIMESTRALES </u></strong></font></div></td>
  </tr>
</table>
...
<table width="98%" border="1" align="center" cellpadding="2" cellspacing="0">
  <tr bgcolor="#CCCCCC"> 
    ...
    <td width="20%" align="center"><strong><font size="2" face="Arial, Helvetica, sans-serif">MES / DIA</font></strong></td>
...
while ($row=mysql_fetch_array($rs))
{
	...
	echo "<td align=\"center\" class=\"text\">Mes&nbsp;$row[Mes]&nbsp;/&nbsp;Dia&nbsp;$row[Dia]</td>";
