    ...
    <td width="455"> 
      <table border="1" cellpadding="0" cellspacing="0" width="100%">
        ...
        <tr> 
          ...
          <td width="97"> <div align="center" style="cursor:hand" onClick="procesos('asignadas','<?php echo $login_usr; ?>','<?php echo $menu; ?>')"><font size="2" face="Arial, Helvetica, sans-serif" color="#0000FF">&nbsp;<u><?php echo $row1[asig];?></u></font></div></td>
          <td width="100"> <div align="center"><font size="2" face="Arial, Helvetica, sans-serif">&nbsp;<?php echo $pasig;?> 
              %</font></div></td>
          <td nowrap width="145" bgcolor="#006699"> <?php echo "<IMG HEIGHT=15 WIDTH=$pasig% SRC=images/barra.jpg>"; ?> 
          </td>
        </tr>
        <tr> 
          <td width="237"> <div align="left"><font size="2" face="Arial, Helvetica, sans-serif">&nbsp;&nbsp;No 
              Asignadas</font></div></td>
          <td width="97"> <div align="center" style="cursor:hand" onClick="procesos('noasignadas','<?php echo $login_usr; ?>','<?php echo $menu; ?>')"><font size="2" face="Arial, Helvetica, sans-serif" color="#0000FF">&nbsp;<u><?php echo $noasig;?></u></font></div></td>
        ...
        <tr> 
          ...
          <td width="97"> <div align="center" style="cursor:hand" onClick="procesos('escaladas','<?php echo $login_usr; ?>','<?php echo $menu; ?>')"><font size="2" face="Arial, Helvetica, sans-serif" color="#0000FF">&nbsp;<u><?php echo $row2[esc];?></u></font></div></td>
        ...
        <tr> 
          ...
          <td width="97"> <div align="center" style="cursor:hand" onClick="procesos('noescaladas','<?php echo $login_usr; ?>','<?php echo $menu; ?>')"><font size="2" face="Arial, Helvetica, sans-serif" color="#0000FF">&nbsp;<u><?php echo $noesc;?></u></font></div></td>
        ...
        <tr> 
          ...
          <td width="97"> <div align="center" style="cursor:hand" onClick="procesos('conseguimiento','<?php echo $login_usr; ?>','<?php echo $menu; ?>')"><font size="2" face="Arial, Helvetica, sans-serif" color="#0000FF">&nbsp;<u><?php echo $row3[seg];?></u></font></div></td>
        ...
        <tr> 
          <td width="237"> <div align="left"><font size="2" face="Arial, Helvetica, sans-serif">&nbsp;&nbsp;Sin 
              Seguimiento</font></div></td>
          <td width="97"> <div align="center" style="cursor:hand" onClick="procesos('sinseguimiento','<?php echo $login_usr; ?>','<?php echo $menu; ?>')"><font size="2" face="Arial, Helvetica, sans-serif" color="#0000FF">&nbsp;<u><?php echo $noseg;?></u></font></div></td>
        ...
        <tr> 
          ...
          <td width="97"> <div align="center" style="cursor:hand" onClick="procesos('consolucion','<?php echo $login_usr; ?>','<?php echo $menu; ?>')"><font size="2" face="Arial, Helvetica, sans-serif" color="#0000FF">&nbsp;<u><?php echo $row4[solu];?></u></font></div></td>
        ...
        <tr> 
          <td width="237"> <div align="left"><font size="2" face="Arial, Helvetica, sans-serif">&nbsp;&nbsp;Sin 
              Solucion</font></div></td>
          <td width="97"> <div align="center" style="cursor:hand" onClick="procesos('sinsolucion','<?php echo $login_usr; ?>','<?php echo $menu; ?>')"><font size="2" face="Arial, Helvetica, sans-serif" color="#0000FF">&nbsp;<u><?php echo $nosolu;?></u></font></div></td>
        ...
        <tr> 
          ...
          <td width="97"> <div align="center" style="cursor:hand" onClick="procesos('conconformidad','<?php echo $login_usr; ?>','<?php echo $menu; ?>')"><font size="2" face="Arial, Helvetica, sans-serif" color="#0000FF">&nbsp;<u><?php echo $row5[conf];?></u></font></div></td>
        ...
        <tr> 
          <td width="237"> <div align="left"><font size="2" face="Arial, Helvetica, sans-serif">&nbsp;&nbsp;Sin 
              Conformidad</font></div></td>
          <td width="97"> <div align="center" style="cursor:hand" onClick="procesos('sinconformidad','<?php echo $login_usr; ?>','<?php echo $menu; ?>')"><font size="2" face="Arial, Helvetica, sans-serif" color="#0000FF">&nbsp;<u><?php echo $noconf;?></u></font></div></td>
        ...
        <tr> 
          ...
          <td height="10" width="97" align="center"><div align="center" style="cursor:hand" onClick="procesos('conforme','<?php echo $login_usr; ?>','<?php echo $menu; ?>')"><font size="2" face="Arial, Helvetica, sans-serif" color="#0000FF">&nbsp;<u><?php echo $nroconformidad; ?></u></font></div></td>
          <td height="10" width="100" align="center"><font size="2" face="Arial, Helvetica, sans-serif">&nbsp;<?php echo $pconfc; ?>%</font></td>
        ...
        <tr> 
          ...
          <td height="10" width="97" align="center"><div align="center" style="cursor:hand" onClick="procesos('disconforme','<?php echo $login_usr; ?>','<?php echo $menu; ?>')"><font size="2" face="Arial, Helvetica, sans-serif" color="#0000FF">&nbsp;<u><?php echo $nrodisconformidad; ?></u></font></div></td>
          <td height="10" width="100" align="center"><font size="2" face="Arial, Helvetica, sans-serif">&nbsp;<?php echo $npconfd;?>%</font></td>
        ...
        <tr> 
          <td width="237"> <div align="left"><font size="2" face="Arial, Helvetica, sans-serif">&nbsp;&nbsp;Con 
              Costo</font></div></td>
          <td width="97"> <div align="center" style="cursor:hand" onClick="procesos('concosto','<?php echo $nombre; ?>','<?php echo $login_usr; ?>')"><font size="2" face="Arial, Helvetica, sans-serif" color="#0000FF">&nbsp;<u><?php echo $row6[cost];?></u></font></div></td>
        ...
        <tr> 
          <td width="237"> <div align="left"><font size="2" face="Arial, Helvetica, sans-serif">&nbsp;&nbsp;Sin 
              Costo</font></div></td>
          <td width="97"> <div align="center" style="cursor:hand" onClick="procesos('sincosto','<?php echo $login_usr; ?>','<?php echo $menu; ?>')"><font size="2" face="Arial, Helvetica, sans-serif" color="#0000FF">&nbsp;<u><?php echo $nocost;?></u></font></div></td>
        ...
        <tr> 
          ...
          <td width="97"> <div align="center" style="cursor:hand" onClick="procesos('anidadas','<?php echo $login_usr; ?>','<?php echo $menu; ?>')"><font size="2" face="Arial, Helvetica, sans-serif" color="#0000FF">&nbsp;<u><?php echo $rowa[anid];?></u></font></div></td>
        ...
        <tr> 
          <td width="237"> <div align="left"><font size="2" face="Arial, Helvetica, sans-serif">&nbsp;&nbsp;Sin 
              Anidar</font></div></td>
          <td width="97"> <div align="center" style="cursor:hand" onClick="procesos('sinanidar','<?php echo $login_usr; ?>','<?php echo $menu; ?>')"><font size="2" face="Arial, Helvetica, sans-serif" color="#0000FF">&nbsp;<u><?php echo $noanid;?></u></font></div></td>
        ...
        <tr> 
          <td> <div align="left"><font size="2" face="Arial, Helvetica, sans-serif">&nbsp;&nbsp;Complejidad 
              Alta</font></div></td>
          <td> <div align="center" style="cursor:hand" onClick="procesos('complejidadalta','<?php echo $login_usr; ?>','<?php echo $menu; ?>')"><font size="2" face="Arial, Helvetica, sans-serif" color="#0000FF">&nbsp;<u><?php echo $nivel[complejidad][3];?></u></font></div></td>
        ...
        <tr> 
          <td> <div align="left"><font size="2" face="Arial, Helvetica, sans-serif">&nbsp;&nbsp;Complejidad 
              Media</font></div></td>
          <td> <div align="center" style="cursor:hand" onClick="procesos('complejidadmedia','<?php echo $login_usr; ?>','<?php echo $menu; ?>')"><font size="2" face="Arial, Helvetica, sans-serif" color="#0000FF">&nbsp;<u><?php echo $nivel[complejidad][2];?></u></font></div></td>
        ...
        <tr> 
          <td> <div align="left"><font size="2" face="Arial, Helvetica, sans-serif">&nbsp;&nbsp;Complejidad 
              Baja </font></div></td>
          <td> <div align="center" style="cursor:hand" onClick="procesos('complejidadbaja','<?php echo $login_usr; ?>','<?php echo $menu; ?>')"><font size="2" face="Arial, Helvetica, sans-serif" color="#0000FF">&nbsp;<u><?php echo $nivel[complejidad][1];?></u></font></div></td>
        ...
        <tr> 
          <td> <div align="left"><font size="2" face="Arial, Helvetica, sans-serif">&nbsp;&nbsp;Criticidad 
              Alta</font></div></td>
          <td> <div align="center" style="cursor:hand" onClick="procesos('criticidadalta','<?php echo $login_usr; ?>','<?php echo $menu; ?>')"><font size="2" face="Arial, Helvetica, sans-serif" color="#0000FF">&nbsp;<u><?php echo $nivel[criticidad][1];?></u></font></div></td>
        ...
        <tr> 
          <td> <div align="left"><font size="2" face="Arial, Helvetica, sans-serif">&nbsp;&nbsp;Criticidad 
              Media</font></div></td>
          <td> <div align="center" style="cursor:hand" onClick="procesos('criticidadmedia','<?php echo $login_usr; ?>','<?php echo $menu; ?>')"><font size="2" face="Arial, Helvetica, sans-serif" color="#0000FF">&nbsp;<u><?php echo $nivel[criticidad][2];?></u></font></div></td>
        ...
        <tr> 
          <td> <div align="left"><font size="2" face="Arial, Helvetica, sans-serif">&nbsp;&nbsp;Criticidad 
              Baja</font></div></td>
          <td> <div align="center" style="cursor:hand" onClick="procesos('criticidadbaja','<?php echo $login_usr; ?>','<?php echo $menu; ?>')"><font size="2" face="Arial, Helvetica, sans-serif" color="#0000FF">&nbsp;<u><?php echo $nivel[criticidad][3]?></u></font></div></td>
        ...
        <tr> 
          <td> <div align="left"><font size="2" face="Arial, Helvetica, sans-serif">&nbsp;&nbsp;Prioridad 
              Alta</font></div></td>
          <td> <div align="center" style="cursor:hand" onClick="procesos('prioridadalta','<?php echo $login_usr; ?>','<?php echo $menu; ?>')"><font size="2" face="Arial, Helvetica, sans-serif" color="#0000FF">&nbsp;<u><?php echo $nivel[prioridad][1];?></u></font></div></td>
        ...
        <tr> 
          <td> <div align="left"><font size="2" face="Arial, Helvetica, sans-serif">&nbsp;&nbsp;Prioridad 
              Media</font></div></td>
          <td> <div align="center" style="cursor:hand" onClick="procesos('prioridadmedia','<?php echo $login_usr; ?>','<?php echo $menu; ?>')"><font size="2" face="Arial, Helvetica, sans-serif" color="#0000FF">&nbsp;<u><?php echo $nivel[prioridad][2];?></u></font></div></td>
        ...
        <tr> 
          <td> <div align="left"><font size="2" face="Arial, Helvetica, sans-serif">&nbsp;&nbsp;Prioridad 
              Baja </font></div></td>
          <td> <div align="center" style="cursor:hand" onClick="procesos('prioridadbaja','<?php echo $login_usr; ?>','<?php echo $menu; ?>')"><font size="2" face="Arial, Helvetica, sans-serif" color="#0000FF">&nbsp;<u><?php echo $nivel[prioridad][3];?></u></font></div></td>
...
{
	window.open("report_ordenes2_pro.php?tipo="+tipo+"&nom="+nombre+"&menu="+menu, "",
	/*window.open("report_ordenes2_pro.php?tipo="+tipo+"&nom=" + '.$login_usr.' + &menu="+menu, "", */
													
'width=900,height=500,status=no,resizable=yes,top=150,left=250,dependent=yes,alwaysRaised=yes,Scrollbars=yes');
}
</script>