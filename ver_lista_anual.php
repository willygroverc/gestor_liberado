<?php
include ("top_ver.php");
$sql="SELECT *,DATE_FORMAT(FechaDe,'%d / %m / %Y') as FechaDe, DATE_FORMAT(Dia,'%d / %m / %Y') as Dia  FROM progtareasanual ORDER BY Dia ASC";
...
<table width="100%" border="0">
  <tr>
    <td><div align="center"><font size="4" face="Arial, Helvetica, sans-serif"><strong><u>LISTA DE TAREAS ANUALES</u></strong></font></div></td>
  </tr>
</table>


<br>
<table width="96%" border="1" align="center" cellpadding="2" cellspacing="0">
  <tr bgcolor="#CCCCCC"> 
    ...
    <td width="20%" align="center"><strong><font size="2" face="Arial, Helvetica, sans-serif"> DIA DE REALIZACION </font></strong></td>
