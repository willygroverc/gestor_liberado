...
{   include("conexion.php");
	...
	header("location: soliccambios3.php?id_orden=$id_orden");
}
include("top.php");
...
<input name="id_orden" type="hidden" value="<?php echo $id_orden;?>">
        ...
        <table width="100%" border="1" align="center" cellpadding="1" cellspacing="2" background="images/fondo.jpg">
          <tr> 
            <th width="206" rowspan="2" nowrap bgcolor="#006699"><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">ACTIVIDADES</font></th>
            <th width="245" rowspan="2" nowrap bgcolor="#006699"><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">PLANIFICACION 
              </font></th>
            <th height="20" colspan="3" nowrap bgcolor="#006699"> <div align="center"><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">APROBACION</font></div></th>
            <th rowspan="2" nowrap bgcolor="#006699"><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">ENTRE 
              FECHAS</font></th>
          </tr>
          <tr> 
            <th width="39" height="20" nowrap bgcolor="#006699"><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">SI</font></th>
            <th width="50" nowrap bgcolor="#006699"><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">NO</font></th>
		...
		while($row=mysql_fetch_array($result)) 
		 ...
		 ?>
          ...
          <tr align="center"> 
            <td height="7" nowrap>
                <textarea name="Responsabilid" cols="25" rows="2" onKeyDown="textCounter(form2.Responsabilid,form2.remLen,110);" onKeyUp="textCounter(form2.Responsabilid,form2.remLen,110);"></textarea>
				<input name="remLen" type="hidden" value="110">
            </td>
            <td width="245" nowrap height="7"> 
                <textarea name="Actividades" cols="35" rows="2" onKeyDown="textCounter(form2.Actividades,form2.remLen2,490);" onKeyUp="textCounter(form2.Actividades,form2.remLen2,490);"></textarea>
            ...
            <td width="185" height="7" nowrap>
			    <textarea name="Observac" cols="25" rows="2" onKeyDown="textCounter(form2.Observac,form2.remLen3,240);" onKeyUp="textCounter(form2.Observac,form2.remLen3,240);"></textarea>
		    </td><input name="remLen3" type="hidden" value="240">
          ...
          <tr> 
            <td colspan="8" nowrap> <div align="center"><br>
                <input name="insertar" type="submit" id="GUARDAR" value="INSERTAR" <?php print $valid->onSubmit() ?>>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
